...
Alongside them, `docs/reports/` collects one hundred and four further research reports on
...
`docs/reports/` holds one hundred and four independent reports that belong to neither project
and are not formalized here: ordinals and well-quasi-orders, Hankel
