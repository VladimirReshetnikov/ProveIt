...
More generally, small real omnific modules are exactly abelian groups, with
one possible scalar action; small Gaussian omnific modules are exactly
ordinary `ℤ[i]`-modules. Restriction and inflation are inverse on module
