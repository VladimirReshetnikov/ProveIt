...
/-!
# Public house bounds for the Gelfond--Schneider development

This compatibility module reproduces the small public API added to Mathlib's number-field
`house` development by the Gelfond--Schneider formalization.  The duplicated declarations live
in the isolated namespace `NumberField.GelfondSchneiderHouse`, so the released Mathlib 4.32 API
remains untouched.
...
namespace NumberField.GelfondSchneiderHouse
...
end NumberField.GelfondSchneiderHouse

namespace NumberField.GelfondSchneiderHouse.house
...
end NumberField.GelfondSchneiderHouse.house
