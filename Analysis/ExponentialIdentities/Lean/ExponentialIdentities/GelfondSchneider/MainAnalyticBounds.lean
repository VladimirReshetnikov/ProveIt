...
public import ExponentialIdentities.GelfondSchneider.MainAnalytic
public import ExponentialIdentities.GelfondSchneider.MainPostAnalytic

/-!
# Gelfond-Schneider: analytic bounds on the auxiliary function

Upper bounds for `GelfondSchneiderHouse.house ρ` and the constants `c₆`, `c₇`, `c₈` entering them.
...
/-- A GelfondSchneiderHouse.house bound for the scaled coefficient `c₁ • (a + b • β')`. -/
@[nolint unusedArguments]
lemma house_add_mul_le :
    GelfondSchneiderHouse.house (c₁ α' β' γ' • ((a q t : K) + b q t • β')) ≤
      (|c₁ α' β' γ'| * |(q : ℤ)|) * (1 + GelfondSchneiderHouse.house β') := by
  calc _ ≤ GelfondSchneiderHouse.house (c₁ α' β' γ' • ((a q t : ℤ) : K)) +
             GelfondSchneiderHouse.house (c₁ α' β' γ' • ((b q t : ℤ) • β')) := ?_
       _ ≤ GelfondSchneiderHouse.house ((c₁ α' β' γ' : ℤ) : K) * GelfondSchneiderHouse.house ((a q t : ℤ) : K) +
             GelfondSchneiderHouse.house ((c₁ α' β' γ' : ℤ) : K) * GelfondSchneiderHouse.house ((b q t : ℤ) • β') := ?_
       _ ≤ GelfondSchneiderHouse.house ((c₁ α' β' γ' : ℤ) : K) * GelfondSchneiderHouse.house ((a q t : ℤ) : K) +
             GelfondSchneiderHouse.house ((c₁ α' β' γ' : ℤ) : K) *
               (GelfondSchneiderHouse.house ((b q t : ℤ) : K) * GelfondSchneiderHouse.house β') := ?_
       _ = |c₁ α' β' γ'| * |(a q t : ℤ)| +
             |c₁ α' β' γ'| * |(b q t : ℤ)| * GelfondSchneiderHouse.house β' := ?_
       _ ≤ |c₁ α' β' γ'| * |(q : ℤ)| + |c₁ α' β' γ'| * |(q : ℤ)| * GelfondSchneiderHouse.house β' := ?_
       _ = |c₁ α' β' γ'| * |(q : ℤ)| * (1 + GelfondSchneiderHouse.house β') := ?_
  · norm_cast; rw [smul_add]; apply GelfondSchneiderHouse.house_add_le
  · refine add_le_add (by grind [GelfondSchneiderHouse.house_mul_le]) (by grind [GelfondSchneiderHouse.house_mul_le])
  · refine add_le_add (by grind)
      (mul_le_mul (le_refl _) (by grind [GelfondSchneiderHouse.house_mul_le]) (GelfondSchneiderHouse.house_nonneg _) (GelfondSchneiderHouse.house_nonneg _))
  · rw [GelfondSchneiderHouse.house_intCast]; rw [GelfondSchneiderHouse.house_intCast]; rw [GelfondSchneiderHouse.house_intCast]; rw [mul_assoc]
  · refine add_le_add (mul_le_mul (le_refl _) (mod_cast ((finProdFinEquiv.symm.toFun t).1).isLt)
    ...
    · rw [mul_assoc, mul_assoc]
      apply mul_le_mul (by rfl) ?_ (mul_nonneg (by positivity) (GelfondSchneiderHouse.house_nonneg _)) (by simp)
      · apply mul_le_mul (mod_cast ((finProdFinEquiv.symm.toFun t).2).isLt) (le_refl _)
          (GelfondSchneiderHouse.house_nonneg _) (by simp)
  · rw [mul_add]; simp only [Int.cast_abs, mul_one]

/-! On the other hand `GelfondSchneiderHouse.house (ρ) ≤ t c₄ⁿ n⁽ⁿ⁻¹⁾⁄₂ (c₆q)ʳ c₇^q ≤ c₈ʳ r⁽ʳ⁺³⁾⁄₂`.
-/

include α β σ α' β' γ' hirr htriv habc in
@[nolint unusedArguments]
lemma one_le_c₄ : 1 ≤ c₄ α' β' γ' := one_le_mul_of_one_le_of_one_le
  (le_max_left 1 (GelfondSchneiderHouse.house.c₁ K * GelfondSchneiderHouse.house.c₁ K * 2 * ↑(m K))) (one_le_c₃ α' β' γ')

/-- The constant `|c₁| * (1 + GelfondSchneiderHouse.house β')`. -/
def c₆ : ℝ := (|↑(c₁ α' β' γ')| * (1 + GelfondSchneiderHouse.house β'))

include α β σ α' β' γ' hirr htriv habc in
@[nolint unusedArguments]
lemma c₆_nonneg : 0 ≤ c₆ α' β' γ' := by
  unfold c₆ GelfondSchneiderHouse.house; positivity
...
lemma one_le_c₆ : 1 ≤ c₆ α' β' γ' := by
  ...
  · simp only [le_add_iff_nonneg_right]
    exact GelfondSchneiderHouse.house_nonneg β'

/-- The constant `(|c₁| ^ 2 * (|c₁| * (GelfondSchneiderHouse.house α' * (|c₁| * GelfondSchneiderHouse.house γ')))) ^ m`. -/
def c₇ : ℝ := ((((|↑(c₁ α' β' γ')| * |↑(c₁ α' β' γ')| *
  (|↑(c₁ α' β' γ')| * (GelfondSchneiderHouse.house α' * (|↑(c₁ α' β' γ')| * GelfondSchneiderHouse.house γ'))))) ^ m K))
...
lemma one_le_c₇ : 1 ≤ c₇ α' β' γ' := by
  ...
  have house_num_mul_int (α : K) (c' : ℤ) (hc' : 0 ≤ c') :
      GelfondSchneiderHouse.house ((c' : K) * α) = |(c' : ℝ)| * GelfondSchneiderHouse.house α := by
    lift c' to ℕ using hc'
    simpa using GelfondSchneiderHouse.house_nat_mul α c'
  have hα : 1 ≤ |(c₁ α' β' γ' : ℝ)| * GelfondSchneiderHouse.house α' := by
    rw [← house_num_mul_int (α := α') (c' := c₁ α' β' γ') hc, ← smul_eq_mul]
    exact GelfondSchneiderHouse.one_le_house_of_isIntegral (mod_cast isIntegral_c₁α α' β' γ') (mod_cast c₁α_ne_zero α β σ
        α' β' γ' hirr htriv habc)
  have hγ : 1 ≤ |(c₁ α' β' γ' : ℝ)| * GelfondSchneiderHouse.house γ' := by
    rw [← house_num_mul_int (α := γ') (c' := c₁ α' β' γ') hc, ← smul_eq_mul]
    exact GelfondSchneiderHouse.one_le_house_of_isIntegral (mod_cast isIntegral_c₁γ α' β' γ') (mod_cast c₁γ_ne_zero α β σ
        α' β' γ' hirr htriv habc)
  have hbase :
      1 ≤ |(c₁ α' β' γ' : ℝ)| * |(c₁ α' β' γ' : ℝ)| *
        (|(c₁ α' β' γ' : ℝ)| * (GelfondSchneiderHouse.house α' * (|(c₁ α' β' γ' : ℝ)| * GelfondSchneiderHouse.house γ'))) := by
    calc
      1 ≤ (|(c₁ α' β' γ' : ℝ)| * |(c₁ α' β' γ' : ℝ)|) *
            ((|(c₁ α' β' γ' : ℝ)| * GelfondSchneiderHouse.house α') * (|(c₁ α' β' γ' : ℝ)| * GelfondSchneiderHouse.house γ')) := by
  ...
  calc
    (1 : ℝ) = 1 ^ m K := by simp
    _ ≤ (|(c₁ α' β' γ' : ℝ)| * |(c₁ α' β' γ' : ℝ)| *
          (|(c₁ α' β' γ' : ℝ)| * (GelfondSchneiderHouse.house α' * (|(c₁ α' β' γ' : ℝ)| * GelfondSchneiderHouse.house γ')))) ^ m K := by
...
include α β σ α' β' γ' hirr htriv habc in
lemma eq6a : GelfondSchneiderHouse.house (rho α β σ α' β' γ' hirr htriv habc q hq0 h2mq) ≤
  (q*q) *(c₄ α' β' γ' ^ (n K q : ℝ) * ((n K q : ℝ) ^ (((n K q : ℝ)+ 1)/2)) *
        (c₆ α' β' γ'* q) ^(r α β σ α' β' γ' hirr htriv habc q hq0 h2mq) * (c₇ α' β' γ')^(q :
            ℤ)) := by
  calc _ ≤ norm (cρ α β σ α' β' γ' hirr htriv habc q hq0 h2mq : ℝ) * GelfondSchneiderHouse.house (rho α β σ α' β' γ' hirr
      htriv habc q hq0 h2mq) := ?_
       _ ≤ (norm (cρ α β σ α' β' γ' hirr htriv habc q hq0 h2mq : ℝ))  *
          GelfondSchneiderHouse.house (∑ t, ( ((algebraMap (𝓞 K) K) ((η (K := K) α β σ α' β' γ' hirr htriv habc q hq0
              h2mq) t)) *
        ((systemCoeffsR α β σ α' β' γ' hirr htriv habc q hq0 t h2mq)))) := ?_
       _ ≤ (norm (cρ α β σ α' β' γ' hirr htriv habc q hq0 h2mq : ℝ)) *
         ∑ t, GelfondSchneiderHouse.house ( ((algebraMap (𝓞 K) K) ((η (K := K) α β σ α' β' γ' hirr htriv habc q hq0 h2mq)
             t)) *
       ((systemCoeffsR α β σ α' β' γ' hirr htriv habc q hq0 t h2mq))) := ?_
       _ = (∑ t, GelfondSchneiderHouse.house ((cρ α β σ α' β' γ' hirr htriv habc q hq0 h2mq) *
         (algebraMap (𝓞 K) K ((η (K := K) α β σ α' β' γ' hirr htriv habc q hq0 h2mq) t) *
          systemCoeffsR α β σ α' β' γ' hirr htriv habc q hq0 t h2mq))) := ?_
       _ = ∑ t, GelfondSchneiderHouse.house ((algebraMap (𝓞 K) K) (η (K := K) α β σ α' β' γ' hirr htriv habc q hq0 h2mq t)
           *
       ...
       _ ≤ ∑ t, GelfondSchneiderHouse.house ((algebraMap (𝓞 K) K) (η (K := K) α β σ α' β' γ' hirr htriv habc q hq0 h2mq
           t)) *
        (GelfondSchneiderHouse.house (((c₁ α' β' γ' : K) ^ (m K * q - a q t * (↑(l₀' α β σ α' β' γ' hirr htriv habc q hq0
            h2mq) + 1)))) *
          (GelfondSchneiderHouse.house (((c₁ α' β' γ' : K) ^
              (m K * q - b q t * (↑(l₀' α β σ α' β' γ' hirr htriv habc q hq0 h2mq) + 1)))) *
            (GelfondSchneiderHouse.house (((c₁ α' β' γ' : K) ^ r α β σ α' β' γ' hirr htriv habc q hq0 h2mq •
              (↑(a q t) + b q t • β') ^ r α β σ α' β' γ' hirr htriv habc q hq0 h2mq)) *
              (GelfondSchneiderHouse.house (((c₁ α' β' γ' : K) ^ (a q t * (↑(l₀' α β σ α' β' γ' hirr htriv habc q hq0
                  h2mq) + 1)) •
                  α' ^ (a q t * (↑(l₀' α β σ α' β' γ' hirr htriv habc q hq0 h2mq) + 1)))) *
                (GelfondSchneiderHouse.house ((c₁ α' β' γ' : K) ^ (b q t * (↑(l₀' α β σ α' β' γ' hirr htriv habc q hq0
                    h2mq) + 1)) •
       ...
       _ ≤ (∑ t, c₄ α' β' γ' ^ (n K q : ℝ) * ((n K q : ℝ) ^ (((n K q : ℝ)+ 1)/2)) *
        ...
        (↑|c₁ α' β' γ' ^ (m K * q - b q t * (↑(l₀' α β σ α' β' γ' hirr htriv habc q hq0 h2mq) + 1))|
            *
          (((|c₁ α' β' γ'| * (|(q : ℤ)| * (1 + GelfondSchneiderHouse.house (β')))) ^ (r α β σ α' β' γ' hirr htriv habc q
              hq0 h2mq)) *
             GelfondSchneiderHouse.house ((c₁ α' β' γ' • α')) ^ (m K * q) *
             GelfondSchneiderHouse.house ((c₁ α' β' γ' • γ')) ^ (m K * q))))) := ?_
       _ ≤ ∑ (t : Fin (q * q)), c₄ α' β' γ' ^ (n K q : ℝ) * ((n K q : ℝ) ^ (((n K q : ℝ)+ 1)/2)) *
          (↑|c₁ α' β' γ'| ^ (m K * q) *
          (↑|c₁ α' β' γ'| ^ (m K * q) *
          ((|c₁ α' β' γ'|^ (r α β σ α' β' γ' hirr htriv habc q hq0 h2mq) *
            (|(q : ℤ)|^ (r α β σ α' β' γ' hirr htriv habc q hq0 h2mq) * (1 + GelfondSchneiderHouse.house (β')) ^ (r α β σ
                α' β' γ' hirr htriv habc q hq0 h2mq)) *
             ((|c₁ α' β' γ'|^ (m K * q) * GelfondSchneiderHouse.house (α') ^ (m K * q)) *
             (|c₁ α' β' γ'|^ (m K * q)  * GelfondSchneiderHouse.house γ' ^ (m K * q))))))) := ?_
       _ ≤  (q*q) *(c₄ α' β' γ' ^ (n K q : ℝ) * ((n K q : ℝ) ^ (((n K q : ℝ)+ 1)/2)) *
        (c₆ α' β' γ'* q) ^(r α β σ α' β' γ' hirr htriv habc q hq0 h2mq) * (c₇ α' β' γ')^(q :
            ℤ)) := ?_
  · rw [← one_mul (GelfondSchneiderHouse.house (rho α β σ α' β' γ' hirr htriv habc q hq0 h2mq))]
    apply mul_le_mul
    · exact one_le_norm_c1rho α β σ α' β' γ' hirr htriv habc q hq0 h2mq
    · simp only [one_mul, le_refl]
    · exact GelfondSchneiderHouse.house_nonneg (rho α β σ α' β' γ' hirr htriv habc q hq0 h2mq)
    · simp only [norm_nonneg]
  · unfold rho
    simp only [le_refl]
  · apply mul_le_mul (le_refl _)
    · exact
      GelfondSchneiderHouse.house_sum_le_sum_house Finset.univ fun i ↦
        (algebraMap (𝓞 K) K) (η (K := K) α β σ α' β' γ' hirr htriv habc q hq0 h2mq i)
        * systemCoeffsR α β σ α' β' γ' hirr htriv habc q hq0 i h2mq
    · exact
      GelfondSchneiderHouse.house_nonneg (∑ t, (algebraMap (𝓞 K) K)
  ...
  · refine Finset.sum_le_sum ?_
    intro t ht
    trans
    · exact GelfondSchneiderHouse.house_mul_le _ _
    refine mul_le_mul_of_nonneg (le_refl _) ?_ (GelfondSchneiderHouse.house_nonneg _) (by positivity)
    ...
    trans
    · exact GelfondSchneiderHouse.house_mul_le _ _
    refine mul_le_mul_of_nonneg ?_ ?_ (GelfondSchneiderHouse.house_nonneg _) (by positivity)
    · simp [nsmul_eq_mul, zsmul_eq_mul, smul_eq_mul, Int.cast_pow]
    · trans
      · exact GelfondSchneiderHouse.house_mul_le _ _
      ·
        refine mul_le_mul_of_nonneg ?_ ?_ (by positivity) (by positivity) <;>
          simp [GelfondSchneiderHouse.house]
  · apply Finset.sum_le_sum
    ...
    · simp only [mul_assoc]
      apply mul_le_mul
      · norm_cast
        rw [GelfondSchneiderHouse.house_intCast]
      · apply mul_le_mul
        · norm_cast
          rw [GelfondSchneiderHouse.house_intCast]
        · apply mul_le_mul
          · simp only [nsmul_eq_mul, smul_eq_mul]
            rw [← mul_pow]
            rw [mul_add]
            calc _ ≤  GelfondSchneiderHouse.house ((↑(c₁ α' β' γ') * ↑(a q t) + ↑(c₁ α' β' γ') *
                  (↑(b q t) * β'))) ^ r α β σ α' β' γ' hirr htriv habc q hq0 h2mq :=?_
                 _ ≤  (↑|c₁ α' β' γ'| * (↑|↑q| * (1 + GelfondSchneiderHouse.house
                     β'))) ^ r α β σ α' β' γ' hirr htriv habc q hq0 h2mq := ?_
            · apply GelfondSchneiderHouse.house_pow_le _ _
            · rw [← mul_add]
              ...
              · have := house_add_mul_le α' β' γ' q t
                ...
                exact this
              · apply GelfondSchneiderHouse.house_nonneg
              · unfold GelfondSchneiderHouse.house
                positivity
          ...
          · apply mul_le_mul
            · simp only [smul_eq_mul, zsmul_eq_mul]
              ...
              apply Bound.pow_le_pow_right_of_le_one_or_one_le
                (Or.inl ⟨GelfondSchneiderHouse.one_le_house_of_isIntegral ?_ ?_, ?_⟩)
              · rw [← smul_eq_mul]
            ...
            · simp only [smul_eq_mul, zsmul_eq_mul]
              ...
              · rw [mul_comm (m K) q]
                ...
                · exact (l₀' α β σ α' β' γ' hirr htriv habc q hq0 h2mq).isLt
            · apply GelfondSchneiderHouse.house_nonneg
            · unfold GelfondSchneiderHouse.house; positivity
          · unfold GelfondSchneiderHouse.house; positivity
          · unfold GelfondSchneiderHouse.house; positivity
        · unfold GelfondSchneiderHouse.house; positivity
        · positivity
        ...
        · nth_rw 1 [mul_assoc]
          ...
          · apply mul_le_mul
            · simp only [zsmul_eq_mul, Int.cast_abs]
              ...
              · apply GelfondSchneiderHouse.house_nonneg
              · trans
                · apply GelfondSchneiderHouse.house_mul_le
                · simp only [GelfondSchneiderHouse.house_intCast, Int.cast_abs, le_refl]
            · simp only [zsmul_eq_mul, Int.cast_abs]
              rw [← mul_pow]
              refine pow_le_pow_left₀ ?_ ?_ (m K * q)
              · apply GelfondSchneiderHouse.house_nonneg
  ...
  · simp only [ sum_const, card_univ, Fintype.card_fin]
    ...
    · nth_rw 4 [mul_assoc]
      ...
      · simp only [← mul_assoc]
        ...
        rw [mul_comm ((1 + GelfondSchneiderHouse.house β') ^ r α β σ α' β' γ' hirr htriv habc q hq0 h2mq)
          ((|↑(c₁ α' β' γ')| * (GelfondSchneiderHouse.house α' * (|↑(c₁ α' β' γ')| * GelfondSchneiderHouse.house γ'))) ^ (m K * q))]
        nth_rw 3 [← mul_assoc]
        rw [mul_comm ((q:ℝ) ^ r α β σ α' β' γ' hirr htriv habc q hq0 h2mq)
         ((|↑(c₁ α' β' γ')| * (GelfondSchneiderHouse.house α' * (|↑(c₁ α' β' γ')| * GelfondSchneiderHouse.house γ'))) ^ (m K * q))]
        nth_rw 2 [← mul_assoc]
        rw [mul_comm  (|(c₁ α' β' γ' : ℝ)| ^ r α β σ α' β' γ' hirr htriv habc q hq0 h2mq)
          ((|(c₁ α' β' γ' : ℝ)| * (GelfondSchneiderHouse.house α' * (|(c₁ α' β' γ' : ℝ)| *
           GelfondSchneiderHouse.house γ'))) ^ (m K * q) * (q : ℝ) ^ r α β σ α' β' γ' hirr htriv habc q hq0 h2mq)]
        nth_rw 1 [← mul_assoc]
...
/-- The constant combining `c₆`, `√(2m)` and `c₇`, bounding `GelfondSchneiderHouse.house ρ`. -/
def c₈ : ℝ := (c₆ α' β' γ' * √(2 * ↑(m K)) * c₇ α' β' γ' ^ (2 * m K) * c₄ α' β' γ' * (2 * ↑(m K)))

include α β σ α' β' γ' hirr htriv habc in
@[nolint unusedArguments]
lemma c7_nonneg : 0 ≤ c₇ α' β' γ' := by
  unfold c₇ GelfondSchneiderHouse.house
  positivity
...
lemma eq6b : (q*q) * ((((c₄ α' β' γ' ^ (n K q : ℝ) *
  ...
  · -- keep your existing first block unchanged
    ...
    · simp only [mul_assoc]
      ...
      · apply mul_le_mul
        ...
        · apply mul_le_mul
          ...
          · unfold c₇ GelfondSchneiderHouse.house; positivity
          · unfold c₆ GelfondSchneiderHouse.house; positivity
        · unfold c₇ c₆ GelfondSchneiderHouse.house; positivity
        · positivity
      · unfold c₆ c₇ GelfondSchneiderHouse.house; positivity
      · simp only [Real.rpow_natCast]
        unfold c₄
    ...
    · unfold c₆ c₇ GelfondSchneiderHouse.house
      · apply mul_nonneg
        · apply mul_nonneg
          · simp only [Real.rpow_natCast]
            · apply mul_nonneg
...
include α β σ α' β' γ' hirr htriv habc in
lemma eq6 : GelfondSchneiderHouse.house (rho α β σ α' β' γ' hirr htriv habc q hq0 h2mq) ≤ c₈ α' β' γ'^(r α β σ α' β' γ'
