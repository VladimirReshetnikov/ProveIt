...
include α β σ α' β' γ' hirr htriv habc in
lemma house_geq_1 : 1 ≤ GelfondSchneiderHouse.house (c1ρ α β σ α' β' γ' hirr htriv habc q hq0 h2mq : K) := by
  apply GelfondSchneiderHouse.one_le_house_of_isIntegral (RingOfIntegers.isIntegral_coe (c1ρ α β σ α' β' γ' hirr htriv
      habc q hq0 h2mq))
