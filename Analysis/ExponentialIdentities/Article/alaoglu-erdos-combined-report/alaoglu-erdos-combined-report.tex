...
classification, and the equivalence with both fractional-part gaps and a localized-radical
...
normalizations of its two outputs, a denominator-controlled rational-third-base extension,
...
exact radical degree, and the uniform finite-difference API now have kernel-verified forms;
...
The current feature wave adds directly kernel-checked modules
...
\lean{OutputNormalization}, and \lean{RationalThirdBase}.
The radical modules are \lean{RadicalReformulation}, \lean{PrimitiveRadical}, and
\lean{RadicalDegree}; the progression modules are \lean{SharperProgressions},
...
and its quadratic asymptotic, finite-Fourier block averages, denominator-controlled rational
third-base outputs, primitive localized-radical reduction and exact radical degree, and uniform
higher finite differences. \\
\bottomrule
\end{longtable}
...
fixed Fourier mode and finite trigonometric polynomial.  The remaining work in this priority
...
Proposition~\ref{prop:radical-degree}, including the exact minimal polynomial.  The next
target is a genuinely new number-field argument using this explicit extension; the radical
exclusion itself remains equivalent to, and exactly as open as, the original conjecture.
...
be undertaken with a specific downstream lemma in mind.  \lean{RationalThirdBase} already
handles a rational third output when its reduced denominator divides a product of powers of
the two integral outputs, and proves a determinant lower bound and an explicit denominator
...
primitive localized-radical reduction, exact radical degree, and uniform higher-difference
obstruction are kernel-verified.  Full blockwise equidistribution for arbitrary continuous
tests and intervals remains a paper theorem, as does any unrestricted rational-third-output
determinant grid.
