...
identity is formalized as well.  \statuslean
...
\lean{RadicalReformulation}.  The equivalence is kernel-verified; the localized-radical
exclusion on its right-hand side remains the open conjecture.  The allowance of $3$-power
denominators is exactly the freedom created by shifting the exponent by an integer.}
\end{statusbox}
...
contradiction with the exact conditional monoid.
