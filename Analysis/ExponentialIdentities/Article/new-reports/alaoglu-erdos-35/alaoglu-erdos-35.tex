...
\section{Minimal inherited framework}
...
\end{equation}
with $UV=RS=m$, distinctness follows from the irrationality of $\beta$ and of $\log 3/\log2$.  Thus $|D_{\Omega,
...
\section{Short congruence relations and weighted divisors}
...
\begin{equation}
 \beta<576\frac{\log3}{\log2}=912.96\ldots.
...
\begin{align}
 ...
 R&\sim\sqrt{m\log3/\log2},&
 S&\sim\sqrt{m\log2/\log3}.\label{eq:col-opt}
\end{align}
...
\item the exact image size $|(\Z/(p-1)\Z)^2B_p|$ from the determinantal formula~\eqref{eq:image-size};
...
The exact files generated during the run have the following SHA--256 hashes:
\begin{center}
\small
\begin{tabular}{@{}ll@{}}
\toprule
file & SHA--256\\
\midrule
\texttt{finite\_field\_scout.py}
&\texttt{41dd55fae41016da5c514965fb51d33446084d1ce56f40ca0cc39fe52b7ba29f}\\
\texttt{finite\_field\_scout.csv}
&\texttt{892e61ff7d234d84614acfe3453599e22ba157ffde520a5792ef5c9568ddc9c4}\\
\texttt{finite\_field\_scout\_summary.json}
&\texttt{8b9eaed9713cdbe2dfb94c5a2cf564f05ee8acb3f1aaf1af0a81ea97af686082}\\
\bottomrule
\end{tabular}
\end{center}
The complete Python source is embedded in Appendix~\ref{app:code}; it uses only the Python standard library.
...
\end{enumerate}
For this application, strict ordering follows from irrationality of $\beta$ and irrationality of $\log2/\log3$.  Irrationality of $\beta$ is elementary from the integrality assumptions: a rational exponent producing an integer power of $2$ must be integral.
