...
\]
are uniformly distributed on $\operatorname{im}M_{\mathfrak p}$.  More precisely, each
$w\in\operatorname{im}M_{\mathfrak p}$ occurs with absolute natural density
\[
 \frac{|I|}{|\operatorname{im}M_{\mathfrak p}|}.
\]
Its conditional density among the indices with $\theta_j\in I$ is therefore
$1/|\operatorname{im}M_{\mathfrak p}|$.
Consequently:
\begin{enumerate}
...
numbers $A$ and $B$ cannot annihilate it.  By \cref{prop:alpha-transcendental}, $\alpha$ is
transcendental over $\Q$ and therefore over $\overline\Q$; it does not vanish at
$T=\alpha$.  Hence the
...
$\alpha=\log_2 3$.  For algebraic coefficients of $P$, the transcendence
...
\cref{prop:gcd-localization} lies over the exact compatible Chebotarev set.  The ambient set
of prime ideals of $K_\ell$ containing these possible divisors has relative density
\[
 \frac1\ell-\frac1{\ell^2}+\frac1{\ell^3}
\]
in rank three and
...
$x=\log_2 m$ (without requiring $3^x$ integral), compare the empirical
...
$\log_2 3$ is transcendental.  Until Gelfond--Schneider is available in the
...
$\log_2 m$ and $\log_3 n$ agree to unusually high precision but are
...
$\alpha=\log_2 3$ is transcendental & proved & Gelfond--Schneider\\
