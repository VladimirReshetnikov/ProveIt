...
well-defined.  Since $x\ne0$, the map $t\mapsto t^x$ is injective on the
...
$p_j/q_j$ are continued-fraction convergents to $\log_2 3$, then one may take
...
By continued fractions for $\log_2 3$, there are infinitely many coprime positive pairs
$(p,q)$ with
\begin{equation}
...
Because $x=\log_2 M$, lower bounds for nonzero linear forms in two logarithms give an
...
Suppose the spectrum of $A$ is positive, or more generally that a holomorphic branch of
$z^x$ is fixed on a neighborhood of the spectrum.  If $A$ is invertible and $N$ is nilpotent,
commutes with $A$, and satisfies $N^{r+1}=0$, then one has the terminating
formula
\begin{equation}
 (A+N)^x
...
\newblock unified working manuscript, August 2026.
