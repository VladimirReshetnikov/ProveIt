...
\[
  N=\left\lfloor\frac{\log(cR)}{\log q}\right\rfloor,
\]
...
\]
because the factorwise upper bound is attained at \(z=-R\).  Splitting the logarithmic sum at \(n=\lfloor\log(cR)/\log q\rfloor\) gives
\[
...
\[
  ...
  \le\left(1+\frac{\log X}{\log2}\right)
      \left(1+\frac{\log X}{\log3}\right).
\]
