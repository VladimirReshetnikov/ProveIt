...
\item \statusprior{} Because $\beta=\log M/\log2$ is a ratio of logarithms of fixed algebraic
...
\begin{equation}
 \frac{\log\operatorname{lc}(F_{3,A,N})}{\log3}
 =\frac{\log\operatorname{lc}(F_{2,M,N})}{\log2}=R_N,
 \label{eq:lc-match}
\end{equation}
\begin{equation}
 \frac{\log|F_{3,A,N}(0)|}{\log3}
 =\frac{\log|F_{2,M,N}(0)|}{\log2}
 =\beta\binom N2.
 \label{eq:ct-match}
\end{equation}
...
$\thetaq=\log3/\log2$ gives \eqref{eq:pointwise-gap}.
\end{proof}
...
\begin{align}
 \mathcal G_N
 &=\frac{\log P_{3,A}(N)}{\log3}
   -\frac{\log P_{2,M}(N)}{\log2},
 \label{eq:G-P}\\
 &=\frac{\log\Delta_{3,N}}{\log3}
   -\frac{\log\Delta_{2,N}}{\log2},
 \label{eq:G-Delta}\\
...
because
\[
 \frac{\log A}{\log3}=\frac{\log M}{\log2}=\beta.
\]
...
\begin{equation}
 \frac{\log|\operatorname{Disc}F_{3,A,N}|}{\log3}
 -\frac{\log|\operatorname{Disc}F_{2,M,N}|}{\log2}
 =2\mathcal G_N
 >2\binom N2\log_3 2,
...
\begin{align*}
 ...
 +\frac{\log Y_N}{\log3}-\frac{\log X_N}{\log2}\\
 &\le\frac{\log Y_N}{\log3}.
\end{align*}
