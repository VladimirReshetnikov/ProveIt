...
\pagenumbering{roman}
\begin{abstract}
Put $\thetaq=\log_2 3$.  The \AEname{} conjecture asserts that
...
The complete source used to generate the table appears in \cref{app:code}.
...
Finite tables & \statusD & Exact Python integer arithmetic; complete source included. \\
