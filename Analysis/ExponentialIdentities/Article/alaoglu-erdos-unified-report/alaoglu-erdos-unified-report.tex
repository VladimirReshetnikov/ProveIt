...
finite positive-scale filters cannot remove the canonical alternating tail and finite
power-substitution node defects are strongly supercritical.  Reciprocal
...
into reduced denominators, in the direction opposite to closure.  A shifted higher
...
four-value closure theorem.  Infinite nonlinear corrections remain outside this no-go.
...
\[
 F_T=\{2^a3^b:a\alpha+b\gamma\le T\},\qquad
...
dichotomy.  The direction must remain fixed: the cited theorem supplies no uniformity as
$(u,v)$ varies~\cite{CorvajaZannier2005}.
...
Stieltjes transfer family, finite positive-dilation and power-substitution corrections,
sparse-spike aggregation,
...
denominator target, and universal rank-one fixed-divisor ceiling & \statusnew & Sections~\ref{crit:critical-interpolant} and
...
canonical alternating tail, finite Euler--dilation and nonlinear node-defect no-gos,
...
norm, one-factor partial-norm deficit, and private-prime resultant criterion &
