...
In particular, proving the single independence statement for $S=\{2,3\}$ would exclude every
$3$-smooth counterexample --- equivalently, would show $3^{\thetaq}\notin\Zthree$, the case
singled out in Section~\ref{sec:radical}.  This is a concrete, finite, and apparently
approachable target whose resolution would remove the smallest and most stubborn family of
