...
matrix audit.  Reports 14--15 add, independently, a structural-prime boundary-resultant
package and an information-theoretic audit of the synchronized semigroup, including an exact
ordinary/power-sum decoder and algebraic-decoder degree growth.  Each sharpens a finite interface while leaving the same
...
in all fifteen reports under \lean{Article/new-reports/}.  The reports share this unified
