...
| Equations (8)–(9), continuous stationary point and Lambert `W_{-1}` | **Not advertised as proved.** The draft silently changes the integer index to a real variable, omits necessary domains, and this project defines no Lambert-W branch. | No Lambert-W declaration. |
