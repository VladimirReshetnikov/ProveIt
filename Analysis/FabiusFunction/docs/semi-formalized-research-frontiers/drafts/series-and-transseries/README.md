...
The live Lean inventory after the current integration is 1,001 modules and
12,447 public declarations, with no documentation gaps.  The 979/12,142
...
exact as well. The wider
Wright-omega, differential-closure, harmonic,
...
The current corpus contains 1,001 documented Lean modules and 12,447 explicit
public declarations, with no documentation or module-header gaps. Thirty-five
