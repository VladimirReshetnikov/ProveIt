...
The live Lean inventory after the current integration is 977 modules and
12,133 public declarations, with no documentation gaps.  The 970/12,056
...
The current corpus contains 977 documented Lean modules and 12,133 explicit
