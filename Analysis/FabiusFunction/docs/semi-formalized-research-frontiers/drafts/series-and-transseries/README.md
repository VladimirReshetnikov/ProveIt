...
The live Lean inventory after the current integration is 979 modules and
12,142 public declarations, with no documentation gaps.  The 977/12,133
checkpoint preceded the two coefficient-certificate leaves.  The 970/12,056
...
The current corpus contains 979 documented Lean modules and 12,142 explicit
