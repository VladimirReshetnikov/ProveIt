...
> source is 55,015 lines / 2,732,554 bytes, with 16 parts, 58 chapters, and
> 3,111 unique labels. Its three-pass 704-page render establishes current
> source/PDF parity and is recorded in the [authoritative receipt
> register](../MANIFEST.md#current-post-merge-publication-receipts), with 114
> overfull boxes and 11 duplicate Hyperref targets disclosed as layout debt.
> The retained incoming 702-page A4 PDF is a historical pre-merge checkpoint.
