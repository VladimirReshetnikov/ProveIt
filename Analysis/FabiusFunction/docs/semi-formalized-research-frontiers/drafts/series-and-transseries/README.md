...
> 55,005-line, 3,111-label source; the canonical TeX has since grown to 55,319
> lines with 3,118 distinct labels, and no current TeX/PDF parity is claimed.
...
The current corpus contains 952 documented Lean modules and 11,884 explicit
public declarations, with no documentation or module-header gaps. Eighteen
focused modules contain 169 explicit public commands; two named declarations
generated by `to_additive` bring that inventory to 171 named entries.
