...
The live Lean inventory after the current integration is 985 modules and
12,199 public declarations, with no documentation gaps.  The 979/12,142
...
The current corpus contains 985 documented Lean modules and 12,199 explicit
