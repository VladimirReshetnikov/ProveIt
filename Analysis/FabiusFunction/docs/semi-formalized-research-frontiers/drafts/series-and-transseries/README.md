...
The live Lean inventory after the current integration is 987 modules and
12,207 public declarations, with no documentation gaps.  The 970/12,056,
976/12,116, and incoming-branch 977/12,133 inventories are historical
checkpoints, not additive counts.
...
The current corpus contains 987 documented Lean modules and 12,207 explicit
public declarations, with no documentation or module-header gaps. Thirty-six
focused modules contain 316 explicit public commands; two named declarations
generated by `to_additive` bring that inventory to 318 named entries. The
earlier 35/304/306 focused inventory is a historical checkpoint. Fourteen
