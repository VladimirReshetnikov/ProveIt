...
**Canonical consolidation of eighteen filed articles**, made on 3 September 2026.
`sequence_inversion_transseries.tex` is 15,093 lines / 702,309 bytes (SHA-256
`ca8036ea1ad995f37155d20aaf4e5f65f85a3dc3700b8ccce252f5cd87855d53`);
the synchronized PDF is 183 A4 pages / 2,735,461 bytes (SHA-256
`bbe95ae95a135615f9d18390e4b5c37946f0ddc89c7379605b8077c034a59bff`).

## What it is

Four combinatorial sequences and two special-function families are developed
to all orders and then inverted:
...
| 5 | Gamma and Barnes `G` | power–logarithmic Stirling cores | branch-resolved inverse normal forms |
| 6 | hyperfactorial `K` | quadratic power–logarithmic core | Bernoulli–Bell correction calculus |
...
certificate, remainder transport, and optimal truncation.  The six subject
chapters cite that common apparatus rather than restating it; the synthesis
chapter compares the subjects and records what the common frame does not
explain.

## Why one volume

The six subject analyses span Pólya-tree singularities, several gamma-ratio
families, and Rademacher's convergent root-of-unity series.  Their *inversions*
are one computation: after a
...
Bell recurrence.  Eighteen articles carried overlapping copies of that apparatus.
...
* **A proof that does not apply, in five of the eighteen articles.**  The
...
Every printed coefficient, table and decimal in all eighteen sources was
...
212 named results, 207 with proofs in the text; of the five without a `proof`
...
input.  1,189 labels, no duplicates, no dangling references, no LaTeX errors.
...
The eighteen sources are listed in Appendix A with their line and page counts.
