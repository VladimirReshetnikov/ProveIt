...
% ed.: the notation migration glued \DefinitionEquals to the following "x",
% producing the undefined control sequence \DefinitionEqualsx.
 \Gnear\DefinitionEquals x+\PL
