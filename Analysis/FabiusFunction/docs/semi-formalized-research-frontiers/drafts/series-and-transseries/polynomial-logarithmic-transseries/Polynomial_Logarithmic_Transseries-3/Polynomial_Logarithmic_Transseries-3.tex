...
\begin{align}\label{eq:multworked}
 ...
 &+(3\ell^3-\ell^2-3\ell+3)t^3+\FormalBigOAt{t^4}{t}.
\end{align}
...
\[
 U=(\ell+1)t+\ell^2t^2.
\]
Since \(U^4=\FormalBigOAt{t^4}{t}\),
\begin{align*}
 \log(1+U)
 & =U-\frac{U^2}{2}+\frac{U^3}{3}+\FormalBigOAt{t^4}{t}\\
 & =(\ell+1)t
...
\end{equation}
Thus, if \(BV=1+\FormalBigOAt{t^m}{t}\), then
\(BV_{\mathrm{new}}=1+\FormalBigOAt{t^{2m}}{t}\).  Each step is performed only to the
...
\begin{align*}
 t\compose G
 &=t-\ell t^2+\ell^2t^3+\FormalBigOAt{t^4}{t},\\
 \ell\compose G
 &=\ell+\ell t-\frac{\ell^2}{2}t^2
   +\frac{\ell^3}{3}t^3+\FormalBigOAt{t^4}{t}.
\end{align*}
...
\end{enumerate}
Then \(F\compose H=X+\FormalBigOAt{t^N}{t}\).
\end{algorithm}
...
\(F\compose H-X=\FormalBigOAt{t^N}{t}\).
\end{algorithm}
...
\begin{align}
 ...
 H\compose F-X&=\FormalBigOAt{t^N}{t}.
...
\[
 \bigl(1+(\ell-1)t+\ell t^2\bigr)C=1+\FormalBigOAt{t^4}{t}.
\]
...
Hence
\[
 AB=1+3t+(2\ell+1)t^2+\FormalBigOAt{t^3}{t}.
\]

\subsection*{Solution 2}
Write \(C=1+c_1t+c_2t^2+c_3t^3+\FormalBigOAt{t^4}{t}\).  Triangular coefficient
comparison gives
\begin{align*}
 c_1&=1-\ell,\\
...
\[
 ...
 +(-\ell^3+5\ell^2-5\ell+1)t^3+\FormalBigOAt{t^4}{t}.
\]
...
\begin{align*}
 ...
 =t-at^2+a^2t^3+\FormalBigOAt{t^4}{t},\\
...
\[
 F\rev=X-P+Q_1t+Q_2t^2+\FormalBigOAt{t^3}{t},
\]
where
\[
 Q_1=\frac12D(P^2)=PP'
