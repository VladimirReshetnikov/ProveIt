...
\begin{equation}
  \ThueMorseSign{k}=(-1)^{\BinaryDigitSum(k)},
  \label{eq:tm}
\end{equation}
where $\BinaryDigitSum(k)$ is the sum of the binary digits of $k$.
...
We use
\begin{equation}
  \FourierTwoPi{f}(\xi)=\int_{\RealNumbers}f(t)e^{-2\pi i\xi t}\Differential t.
  \label{eq:fourier-convention}
\end{equation}
For $\Phi=\FourierTwoPi{\RvachevUp}$, the repository's product formula is
\begin{equation}
...
$\Probability(S=1)=\Probability(S=-1)=1/2$.  Define the probability measure
\begin{equation}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{figures/carleman_lattice_phase.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{figures/fourier_optimal_gain_peak_ray.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\textwidth]{figures/lambert_saddle_error.png}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/bell_edge_residual.png}
    \caption{Unscaled residual.}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/bell_edge_scaled_residual.png}
...
PNG figures are generated.  The live package includes the script, requirements
file, all CSV tables, figures, and a numerical summary.  Its former package-wide
checksum ledger is retired and remains recoverable from Git history.
