...
\begin{equation}
 K_\sigma(t;q)=\log\mathbb E\EulerE^{tX_\sigma(q)}
...
Let
\begin{equation}
 K_\sigma(t)=\log\mathbb E\EulerE^{tX_\sigma}
...
$\mathbb E\EulerE^{tX_A}=\EulerE^{R_At}\mathbb E\EulerE^{-tD_A}$, the second formula follows.
\end{proof}
...
\[
 ...
 \le\EulerE^{t\eps}\mathbb E\EulerE^{-tD_A}.
\]
...
\begin{align}
 ...
 \log\mathbb E\EulerE^{-t(R_{A,b}-X_{A,b})}
