...
\begin{equation}
 F(x)=\int_{-1}^{2x-1}\RvachevUp(t)\Differential t,
 \qquad 0\le x\le1,
 \label{eq:F-up-cdf}
\end{equation}
...
For any set $A\subseteq\NaturalNumbers_{\ge1}$, let
\begin{equation}
...
For every $A\subseteq\NaturalNumbers_{\ge1}$,
\begin{equation}
...
\)
unless $A=\varnothing$.  If $A^c=\NaturalNumbers_{\ge1}\setminus A$, then
\begin{equation}
 \mu_A*\mu_{A^c}=\mu_{\NaturalNumbers_{\ge1}},
 \qquad
...
Let $A\subseteq\NaturalNumbers_{\ge1}$ and suppose $A(N)=\delta N+\BigO(1)$.  Write
\begin{equation}
 D_A=R_A-X_A\ge0,
 \qquad
