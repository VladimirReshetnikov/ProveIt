...
universal trace \eqref{p1:eq:universal-trace} is within reach of the inverse transform
\path{Fabius.gridSample_eq_sum_foldedCoefficient} at \(j=0\) together with
\path{Fabius.foldedCoefficient_zero} and the even-mode vanishing, but is not stated
separately.
