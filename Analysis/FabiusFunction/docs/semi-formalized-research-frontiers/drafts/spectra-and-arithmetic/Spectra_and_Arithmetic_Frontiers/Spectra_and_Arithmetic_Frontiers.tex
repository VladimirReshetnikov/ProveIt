...
combined with the symmetry \path{Fabius.foldedCoefficient_neg}.  Restricting the left side
to odd \(r<N\) (the even modes vanish, \path{Fabius.foldedCoefficient_two_mul_eq_zero}, and
\(A_{N,0}=1\)) and folding the right side with \(P(0)=1\), \(P(1)=0\) produces the displayed
\eqref{p1:eq:discrete-energy}; that bookkeeping is not separately formalized.
