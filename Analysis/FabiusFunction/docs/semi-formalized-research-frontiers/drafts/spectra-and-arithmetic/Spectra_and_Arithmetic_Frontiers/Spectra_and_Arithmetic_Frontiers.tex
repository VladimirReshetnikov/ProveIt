...
(\path{Fabius.rvachevUp_dyadic_eq_qBinomial}).  So the whole of \eqref{p1:eq:q-approximant}
except its convergence, which is analytic, is now formal: the folded alias class of the
infinite sinc product equals a finite cosine sum of \(q\)-binomial expressions.
