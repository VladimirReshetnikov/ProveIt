...
\nolinkurl{Fabius.rvachevFourierProduct_ofReal_ne_zero}); concretely on \(\abs{x}\le2/3\)
...
itself: \(\varphi_{\Up}(t)=\Phi(t/2\pi)\) is real and strictly positive --- in particular nonzero ---
