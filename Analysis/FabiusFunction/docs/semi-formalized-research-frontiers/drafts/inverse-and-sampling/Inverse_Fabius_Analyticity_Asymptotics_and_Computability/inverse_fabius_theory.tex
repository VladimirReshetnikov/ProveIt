...
\input{chapters/00_scope_and_platform}
\input{chapters/01_analyticity_and_elementarity}
\input{chapters/02_inverse_iterates}
\input{chapters/03_inverse_germs_and_deconvolution}
\input{chapters/04_endpoint_all_orders}
\input{chapters/05_dyadic_self_sampling}
\input{chapters/06_computability}
\input{chapters/07_certification_and_provenance}
