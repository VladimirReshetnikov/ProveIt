...
The classical probability model may be written as follows\ \cite{co:Fabius1966,co:Arias05442,co:ProveIt}.  Let $U_1,U_2,\ldots$ be independent uniform random variables on $[0,1]$ and
put
...
stronger paper-level inverse expansions\ \cite{co:ProveIt}.
Let
