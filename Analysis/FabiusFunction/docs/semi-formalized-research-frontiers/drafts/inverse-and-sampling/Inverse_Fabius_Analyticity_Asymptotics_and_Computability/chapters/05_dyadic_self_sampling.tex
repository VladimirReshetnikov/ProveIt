...
rule.  Finally, weights $c_a$ annihilate every nonzero residue precisely when
their $b^s$-point discrete Fourier transform is $(1,0,\ldots,0)$.  Fourier
