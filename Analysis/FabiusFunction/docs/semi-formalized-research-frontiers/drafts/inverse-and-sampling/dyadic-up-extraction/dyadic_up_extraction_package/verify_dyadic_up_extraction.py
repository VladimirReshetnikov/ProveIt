#!/usr/bin/env python3
"""Exact experiments for dyadic extraction of Rvachev's up-function.
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="directory for generated CSV/TXT/figure files",
    )
    parser.add_argument(
        "--max-depth",
        type=int,
    ...
    parser.add_argument(
        "--skip-plots",
        action="store_true",
        help="run exact checks and tables without importing matplotlib",
    )
