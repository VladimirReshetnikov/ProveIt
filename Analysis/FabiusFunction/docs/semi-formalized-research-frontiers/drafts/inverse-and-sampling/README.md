...
| `inverse-asymptotics-and-computability/Inverse_Fabius_Computability_Report` | 2,992 | `359ac1239788d1d7af25214a6be26e421f716db6d1c254692469bddd2d25833a` | retained 42 pages; rebuild pending | all six current payload rows pass without asserting synchronization |
...
- [`Inverse_Fabius_Computability_Report/`](inverse-asymptotics-and-computability/Inverse_Fabius_Computability_Report/),
  *Computability of the Inverse Fabius Function* (retained historical
  ...
  source now carries the 631/8,556 census and requires a fresh render. The immutable
...
631 Lean modules and 8,556 public declarations with zero documentation/header
gaps.
