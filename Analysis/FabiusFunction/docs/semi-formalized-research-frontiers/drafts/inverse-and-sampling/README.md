...
| `inverse-asymptotics-and-computability/Inverse_Fabius_Computability_Report` | 2,937 | `174050673174fee0bea4b0434411b0e2e1e2b9eb011f759845bb9578d6c452ee` | retained 42 pages; rebuild pending | all six current payload rows pass without asserting synchronization |
...
- [`Inverse_Fabius_Computability_Report/`](inverse-asymptotics-and-computability/Inverse_Fabius_Computability_Report/),
  *Computability of the Inverse Fabius Function* (current synchronized
  ...
  source now carries the 629/8,546 census and requires a fresh render. The immutable
...
629 Lean modules and 8,546 public declarations with zero documentation/header
gaps.
