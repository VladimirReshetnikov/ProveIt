...
\]
 ...
 sharp endpoint witness.  The exact modulus of continuity of the inverse is
 the inverse itself, with the natural saturation at unit input distance:
\[
...
\path{Analysis/FabiusFunction/Lean/FabiusFunction/InverseModulus.lean}.  It
 ...
 effective-injectivity threshold.  The declaration-level crosswalk is given in
...
current post-publication development, \path{InverseModulus.lean} formally
 ...
 attainment.  The second inequality, its recursive
