...
inverse_fabius_computability.tex
    Complete 2744-line LaTeX source of the report.  Its latest synchronized
    update adds the logarithmic reciprocal-modulus crosswalk described below.

inverse_fabius_computability.pdf
    Current 39-page A4 report, produced from the 2744-line source in exactly
...
------------------------
The 2744-line source and 39-page A4 PDF are synchronized after exactly three
