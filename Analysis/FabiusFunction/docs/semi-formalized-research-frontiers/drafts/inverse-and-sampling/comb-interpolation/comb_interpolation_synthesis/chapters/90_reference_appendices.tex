...
& Paper proof
& Generic scalar decoder synthesis formalized by
...
& Paper proof
& Elementary-symmetric expression and Gaussian prefactor not formalized
& \Cref{gq:thm:gaussian-Appell-decoder}\\
...
& Directly formalized componentwise by
  ...
  \path{sum_lagrangeRvachevDecoder_eq_one}; no Matrix wrapper
& \Cref{gq:thm:gaussian-Appell-biorthogonality}\\
Stochastic encoder and Matrix right inverse
& Paper proof
& No typed Matrix or row-stochastic encoder package found
& \Cref{gq:thm:gaussian-Appell-biorthogonality}\\
