...
\subsection{Partial fractions for the \texorpdfstring{$q$}{q}-exponential perpetuity}
...
& \Cref{gq:thm:gaussian-Appell-decoder,gq:thm:gaussian-Appell-biorthogonality}\\
