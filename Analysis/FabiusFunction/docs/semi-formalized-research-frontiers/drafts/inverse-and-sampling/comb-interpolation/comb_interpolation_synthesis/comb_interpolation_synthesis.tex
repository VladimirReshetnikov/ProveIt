...
\newcommand{\FabiusGeometricNewtonCoefficient}[2]{%
  \mathsf{c}^{\mathrm{F,Newt}}_{#1}\!\left(#2\right)}
...
\begin{document}
\maketitle
\input{chapters/00_scope_status}
\clearpage
\tableofcontents
\clearpage
\input{chapters/01_geometric_core}
\input{chapters/02_geometric_extensions}
\input{chapters/03_additive_dyadic}
\appendix
\input{chapters/90_reference_appendices}
\input{chapters/98_provenance}
