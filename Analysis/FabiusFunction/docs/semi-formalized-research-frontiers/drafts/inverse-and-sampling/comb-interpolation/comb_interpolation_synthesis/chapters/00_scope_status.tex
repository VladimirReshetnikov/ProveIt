\begin{abstract}
This volume gives one coherent theory of two sampling geometries naturally
attached to the Fabius--Rvachev system.  On the additive dyadic comb it proves
exact row-generating functions, Bell--Prouhet compression, terminating
...
comb $cq^{\mathbb N_0}$ it develops Gaussian-Pascal and Jackson--Newton
