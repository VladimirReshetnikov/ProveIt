...
The related assertion for the interior weights $\binom{M-2}{j-1}$ of
\cref{sec:endpoint-flat} is separate from that exact Lean counterpart and
remains unformalized: for $1\le j\le M-1$, Lucas's theorem gives oddness
exactly for odd $j$, with higher valuations determined by the binary carries
of $j-1$ against $M-2$.
