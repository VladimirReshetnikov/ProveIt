...
\[
 ...
 \qquad
 b-z_{n,r}=\frac{db}{n}+o(n^{-1}),
\]
and uniform convergence also gives
\[
 \max_{r\le z\le b}A_n(z)
 \sim Q_\infty D_b b^{n+d}n^{-d}d^d\e^{-d}.
\]
