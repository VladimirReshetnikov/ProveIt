...
\[
 ...
 \qquad N=2^{\,n-1},
\]
for every complex $w$ and with no hypothesis at all, both sides being entire; dividing by the
two factors on the left, which is legitimate exactly on the range $0<z<N$ of the lemma, gives
the displayed quotient form.  It is the composite of two facts already in the corpus: the local
