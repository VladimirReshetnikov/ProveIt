...
Integer-ratio prefix factorization
\(\GeometricSincProduct{b}(y)=\prod_{j<N}\SincRad(\pi b^{-j}y)\,\GeometricSincProduct{b}(b^{-N}y)\)
and the all-orders zeta expansion of the tail on \(|b^{-N}y|<1\)
