...
\lean{OnePeakPerLobe} assembles them.  The central-lobe specializations of the
closed derivative formulas \eqref{eq:lobe-derivatives} are now stated, for
$|x|<1$, in
...
The two central-lobe sum identities are instances.  Summability of the two
