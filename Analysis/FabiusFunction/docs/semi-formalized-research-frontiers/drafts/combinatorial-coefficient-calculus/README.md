...
The merged register contains 207 rows: 63 marked Lean, 36 partial, and 108
...
a fresh compilation of the whole corpus. At the upstream checkpoint the final
structural/provenance validator passed with 207 adjacent proofs, 27 disposition
records, and six original-source inventory rows; the combined register was
regenerated by a matching dry run. PDF building remains deferred for this
