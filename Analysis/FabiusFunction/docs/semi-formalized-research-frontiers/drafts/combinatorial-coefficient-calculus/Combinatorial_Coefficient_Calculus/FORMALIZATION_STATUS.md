...
The merged manuscript contains 210 theorem-like entries: **84 `Lean`,
51 `partial`, and 75 `none`** after the current claim audit. The audit corrected
...
The six campaign leaves contain **25 new public theorems, all compiled**. The
thirteen generalized existing Lagrange helpers
...
| `StirlingSymmetricFunctions` | 4 | Direct sequential compilation passed. The two second-kind evaluation formulas were deduplicated into upstream `StirlingCompleteHomogeneous`. |
| `LagrangeInversionUniqueness` | 6 | Direct sequential compilation passed after the explicit unit-witness correction. |
| `StirlingSecondReverseRowIdentity` | 2 | Direct sequential compilation passed, including the factorial-proof simplification. |
| `ExponentialRiordanInverse` | 4 | Direct sequential compilation passed. |
| `LagrangeExistence` | 4 | Direct sequential compilation passed. |
