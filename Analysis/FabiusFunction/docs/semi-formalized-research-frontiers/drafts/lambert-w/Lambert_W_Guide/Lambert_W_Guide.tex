...
\begin{remark}[Formalized closed principal restriction]
...
\path{PrincipalLambertW.lean}.  This endpoint-inclusive restriction is the
range theorem used by the formal two-branch power--exponential inverse
package below.
\end{remark}
...
with the phase-locked Richardson layer formalized in
\path{LambertPhaseLockedRichardson.lean}.  The two-term inversion
