...
The retained PDF is a historical 66-page A4 artifact of 1,107,064 bytes.
The current source contains later crosswalk edits, so no source/PDF render
parity is claimed.
\begin{itemize}
...
remains restricted to real \(\lvert q\rvert<1\).  The canonical q-monograph
compound \nolinkurl{thm:qF-moment-polynomial} remains Partial because neither
the global \texttt{RatFunc} identification nor its pole-clearing polynomial
continuation at roots is formalized.  The complex leaf raised the next
historical checkpoint to 906/11,461.  The subsequent exhaustive \(1+2\)
...
or global rational-function claim is made.  The later merged-main checkpoint
is 919/11,569.  Its final increment is the exhaustive zero-definition/
one-theorem \path{HalfQBinomialRootSimplicity.lean} leaf, whose
...
\nolinkurl{cor:qbinom-inversion-law} remains Partial.  The exterior leaf then
raises the census to 920/11,572.
...
\nolinkurl{prop:qF-P-degree-sharp} Exact, while the global
\nolinkurl{thm:qF-moment-polynomial} remains Partial for the separate
\texttt{RatFunc}/root-continuation gap.  The sharp leaf raises the live census
to 921/11,575.
