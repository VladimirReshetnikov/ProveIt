...
The preceding Gaussian second-moment checkpoint had the live census
902/11,443.  The Lambert--Bernoulli branch begins with three theorems at
903/11,446, adds its exact-radius fourth theorem at 903/11,447, and reaches
903/11,448 with the complex value-completion theorem.  The local five-theorem
fixed-column \(q\)-binomial extension then reaches 903/11,453.  Independently,
the upstream-only \path{GeometricUniformMomentPolynomial.lean} branch has
\(1+8\) public definitions/theorems and reaches 904/11,457 from the Lambert
checkpoint; merging it with the local fixed-column branch gives the live
904/11,462 union.  The moment-polynomial module supplies only the recursive
polynomial algebra; the analytic normalization and leading/odd-degree clause
of the external label \nolinkurl{p7:thm:Pn} remain Partial.
