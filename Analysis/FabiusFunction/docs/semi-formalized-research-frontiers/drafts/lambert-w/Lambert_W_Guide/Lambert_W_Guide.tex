...
The focused branch-pair tranche is exhaustive at this checkpoint:
\lean{LambertWBranchPairing} has \(0+7\) public definitions/theorems,
\lean{LambertWGapBijection} has \(4+16\), and
\lean{LambertWBranchSymmetry} has \(0+9\).  Their union is therefore four
definitions and 32 theorems, 36 public declarations in all.
...
\Cref{sec:integrals}, the local Taylor
