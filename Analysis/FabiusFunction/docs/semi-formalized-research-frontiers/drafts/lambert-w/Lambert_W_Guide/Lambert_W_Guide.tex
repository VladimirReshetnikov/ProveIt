...
in \path{PowerExponentialLambertCalculus.lean}.  The second-derivative
formulas \eqref{eq:secondder-exp}--\eqref{eq:secondder}, their endpoint
limits, and the full curvature classification below are not yet packaged as
Lean declarations.
\end{remark}
...
\(t2^{-t}\), its peak is \(\ee^{-1}/\log2\), and
