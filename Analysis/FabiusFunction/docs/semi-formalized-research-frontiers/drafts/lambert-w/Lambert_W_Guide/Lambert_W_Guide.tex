...
The preceding exact-radius checkpoint had the historical census 903/11,447; the
...
definitions/theorems and raises origin's inventory to 904/11,457.  Retaining
the unconditional public
\lean{complexQPochhammerInf_eq_qPochhammerInfIn} bridge gives the merged live
union 904/11,458, with both documentation-gap counts zero.  The moment-polynomial
module supplies only the recursive polynomial algebra; the analytic
normalization and leading/odd-degree clause of the external label
