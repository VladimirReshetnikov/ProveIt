...
The lexical documentation baseline is 1,001 modules / 12,447 declarations, with
...
The broader `audit_all.sh` passes, including register consistency and all 37
exact-identity checks. The canonical CCC validators and documentation audit also
pass. No forbidden `SHA256SUMS` or `SHA256SUMS.*` file was restored.
...
**Current artifact checkpoint (2026-09-04).** The live Lean audit scans 1,001
source modules and 12,447 explicit public declarations, with no missing module headers or
...
979/12,142 checkpoint. The subsequent 985/12,199 and 986/12,233 inventories
are historical; the current merged inventory is 1,001/12,447. No new aggregate-build or PDF-parity
claim is made.
...
1,001/12,447; the local 961/11,974, 960/11,966, 944/11,806, and 943/11,791
...
merged 1,001/12,447 corpus; the module interfaces below retain their stated
