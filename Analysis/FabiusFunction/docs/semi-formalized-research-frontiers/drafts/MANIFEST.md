...
source modules and 11,462 public declarations, with no missing module headers
or declaration comments. The local publication line is 902/11,440 after
...
five fixed-column q-binomial declarations at `581bf`. Independently, the
one-definition/eight-theorem `GeometricUniformMomentPolynomial` leaf gives the
parallel upstream-only `3b6396` checkpoint 904/11,457; merging those two
increments gives the live 904/11,462 union.

Five publications had exact source/PDF-parity receipts at the pre-upstream
commit `581bf`: the primary exposition (187 pages), Lean walkthrough (150),
canonical frontier (260), Lambert Guide (70), and canonical forward/inverse
q-series synthesis (391). Merging the parallel upstream-only revision
`3b6396` changes those five TeX sources and the independently published
standalone geometric-q root. Final-source rendering of all six roots is now
accepted. Their current receipts are:
...
- primary exposition: 13,748-line / 686,081-byte source, SHA-256
  ...
  passes 185/187/187; 187-page / 1,581,617-byte A4 PDF, SHA-256
...
- Lean walkthrough: 6,638-line / 460,643-byte source, SHA-256
  ...
  passes 146/151/151; 151-page / 1,188,993-byte A4 PDF, SHA-256
...
- canonical frontier: 17,983-line / 806,798-byte source, SHA-256
  ...
  passes 252/260/260; 260-page / 1,877,420-byte A4 PDF, SHA-256
...
- Lambert Guide: 4,873-line / 177,465-byte source, SHA-256
  ...
  passes 67/69/69; 69-page / 958,516-byte A4 PDF, SHA-256
...
- q-series synthesis: 16,448-line / 816,185-byte master, SHA-256
  `a463abef7bb3c70e12a568a46fc192aac88a8ce240f8f781fff2b018a4aa086d`;
  26,114-line / 1,168,039-byte full graph, aggregate SHA-256
  ...
  0 rejected, 0 warnings); 391-page / 2,464,712-byte A4 PDF, SHA-256
...
- standalone geometric-q root: 27,520-line / 1,266,515-byte source, SHA-256
  `8292f10862334cb809139259eeb4906bb14f517d41b9600c9b7ad53bb21525b1`;
  passes 385/402/402; 402-page / 8,332,886-byte A4 PDF, SHA-256
...
All six passed the documented log, A4 page, font, Type-3, extraction, and
visual gates. The Lambert clipping defect and canonical page-176 running-head
collision were repaired before acceptance. The old five `581bf` pairs and the
older standalone geometric-q PDF remain historical receipts. At `581bf`, the
canonical-frontier source had 17,947 lines and 804,625 bytes, with SHA-256
`ac6b28fb8a98d97ed4b7a0fe7a5ba2cdfab852fb6de1ee2ecfda4aed75804371`;
its matching 1,875,190-byte PDF has SHA-256
`fee3b5af21b01b16c41cf8291ba0508d1e6c613bfd098cdef457cde44ea693c2`.
The superseded post-merge source-only canonical-frontier pin has 17,982
lines and 806,760 bytes, with SHA-256
`6edfc099f275f74d6e3ae5b74e60a2fcf4aeca313089967dafbae4b2585bf2d4`;
it predates the accepted page-176 repair.
The preceding 183-page primary, 130-page walkthrough, 257-page canonical-
frontier, 66-page Guide, and 389-page q-series artifacts remain earlier
historical receipts.

Several other PDFs below likewise remain readable publication checkpoints
rather than renders of the final merged TeX. These include the 377-page
Integration-and-Transform master, 88-page notation catalogue, 301-page
Representation master, 41-page New Frontiers-2 artifact, 42-page inverse-
computability report, 134-page canonical inverse-theory synthesis, 158-page
comb synthesis, and 238-page Exponents artifact. The published inverse-theory
PDF is historical; no replacement rendering of its current source has yet
been published. Package-local notices give the exact status of each artifact.
...
The two canonical syntheses have source/artifact receipts. At the pre-upstream
commit `581bf`, the q-series source had 16,433 lines and 815,194 bytes, with
SHA-256
`f2aae6ddc3d7a399f9ed47806a0abe6458cbcab37bf2aac9f55ad3913b5a0e2d`.
Its matching 391-page, 2,464,122-byte A4 PDF has SHA-256
`c0a00720685f40e0684b4858e7ce18ce134701529898fd4574d09b6c090e0e91`.
The post-merge source has 16,448 lines and 816,185 bytes, with SHA-256
`a463abef7bb3c70e12a568a46fc192aac88a8ce240f8f781fff2b018a4aa086d`;
...
`fb74b0c4cbd75d9022c78c1df5c1d567120bd67728d5b418697ddc5a2aa8f450`;
all documented gates passed. The `581bf` PDF above is retained as a historical
pre-upstream receipt rather than the current publication.
...
was synchronized to the 16,339-line, 810,779-byte source checkpoint with
SHA-256
`14c444feb14c435bc300becd9c8cd2765c1e96f608dd79da462becc41b28ed22`;
it remains a historical receipt rather than the current publication.  The
...
results: 167 Exact / 90 Partial / 17 None / 8 N/A interface rows. The
...
generated at the time of that source-only merge; those changes are included in
the exact `581bf` q-series receipt, which is now historical after merging the
parallel `3b6396` revision. They remain included in the accepted current
q-series render.
The preceding 389-page receipt remains historical. The comb synthesis also has
later chapter-03 notation and
...
union TeX. The containing standalone geometric-q root now has an accepted
current whole-root receipt recorded above and below. Cyclotomic has a
...
proof route, and the Puiseux claims remain open. In the local source
chronology, Gaussian checkpoint `71c908e` is 902/11,443; the four-theorem
Lambert leaf gives 903/11,447, and its fifth theorem gives completed Lambert
checkpoint `217a6b9` at 903/11,448. The five fixed-column q-binomial
declarations then give commit `581bf` at 903/11,453. At that pre-upstream commit,
the Guide source had 4,864 lines and 176,796 bytes, with SHA-256
`3f3552983a73db2dab94f3625d10d054b747ee03fc2758e257af86f6216deab5`;
its matching 70-page, 958,713-byte A4 PDF has SHA-256
...
the accepted Guide source has 4,873 lines and 177,465 bytes, with SHA-256
`90413f46373415edef411e9ea3b2d94006f7342bd2fa3ea931ca975d7f64b97e`.
...
`5c81cd6b8dc2cf070c4b1995c98c0d046c54d28f0e682b78b5ad9e16c0a8caa7`.
All documented gates passed, including the corrected visual-clipping check.
The superseded 4,872-line, 177,384-byte source-only pin, SHA-256
`4200ac6ccd23e950bcbd0cba61aca256cd9e1a647667436120cc82e8e7876b11`,
and the `581bf` 70-page pair above remain historical receipts. The preceding
66-page, 1,107,064-byte artifact remains an earlier historical receipt.
...
None to Partial, not Exact, while `prop:qF-P-degree-sharp` remains None. On its
parallel upstream branch, this one-definition/eight-theorem addition gives
checkpoint `3b6396` at 904/11,457; merging it with the independent
five-declaration fixed-column checkpoint `581bf` gives the live census
904/11,462 and the q forward totals 167 Exact / 90 Partial / 17 None / 8 N/A. The source
...
encode partial Lean coverage. The exact `581bf` 391-page q-series PDF is now a
historical pre-upstream checkpoint and does not render this source-only
crosswalk. The accepted current 391-page q-series render does include it.
...
is claimed. The retained 134-page, 2,027,726-byte A4 PDF
has SHA-256
