...
Several other PDFs below remain readable historical checkpoints rather than
renders of final merged TeX.  The Integration-and-Transform master, notation
catalogue, Representation master, New Frontiers-2, inverse-computability
report, canonical inverse-theory synthesis, and comb synthesis retain 377-,
88-, 301-, 41-, 42-, 134-, and 158-page artifacts and still require their own
final-source rebuilds where their package records say so.  Earlier 167-page
...
results: 165 Exact / 91 Partial / 18 None / 8 interface rows. The
...
provenance theorem retains two auxiliary nonvanishing assumptions. The latest
...
The consolidated geometric q-frontier's latest pre-`9135bd7e` parity receipt
names a
17,954-line, 813,297-byte TeX source has SHA-256
`bcd9eefce2ead08e2cbb283e091a859aa31f36c67416543e994e10e8f9db3075`;
an exact guarded 254 -> 262 -> 262-page cycle produced the 262-page,
1,885,642-byte A4
PDF with SHA-256
`7f7e1279e38c766a465e640638ea7e0079a942de0bc84a5c22be497af27c7bab`;
its recorded publication gates are clean apart from expected underfull-box
diagnostics.  The preceding 808,185-byte source and 260-page PDF, the earlier
238-page PDF, and the 16,274- and 16,369-line source checkpoints remain
historical provenance only.  The current source additionally includes the
q-Chu/Richardson crosswalk and therefore requires a fresh build; its exact
identifiability and outer q-Pochhammer normal-convergence crosswalks and named
remaining Partial claims are unchanged.  No
`SHA256SUMS*` file exists or participates in validation; direct SHA-256 values
