...
chapter-01 Richardson and Matrix crosswalk edits. Its 232-row concordance now
records 5 Lean-proved, 161 human-proved frontier, 20 conjecture, 30 open-problem,
...
`gq:thm:gaussian-Appell-biorthogonality` Matrix crosswalk, postdate the retained
three-pass 158-page,
...
distinct payloads; no PDF was generated for the Richardson or Matrix
