...
**Current artifact checkpoint (2026-09-04).** The live Lean audit scans 988
source modules and 12,257 explicit public declarations, with no missing module headers or
...
census. The local branch's subsequent transseries-algebra integration gives the historical
...
The preceding checked local checkpoint was 976/12,116. Ten incoming leaves
contribute 80 declarations; existing-module changes contribute a net eight:
six Bernoulli rational-algebra base-change theorems and two stronger monomial
uniqueness theorems. Other changed existing modules are count-neutral relative
to that local checkpoint. The merged census
before the local Raney extension was therefore 986/12,204. The new
zero-definition/three-theorem `RaneyNumbersUniqueness.lean` supplies the
remaining module and three declarations.

The elementary Lagrange identities and canonical solution construction now
work over every commutative ring. The coefficient-calculus sections retain
their rational-algebra assumptions. The Raney extension transports the
existing coefficient formulas to arbitrary solutions; its scope includes
degree zero and exponent parameter zero, while retaining a positive power
parameter in the divided formula.
...
988/12,257; the local 961/11,974, 960/11,966, 944/11,806, and 943/11,791
...
merged 988/12,257 corpus; the module interfaces below retain their stated
