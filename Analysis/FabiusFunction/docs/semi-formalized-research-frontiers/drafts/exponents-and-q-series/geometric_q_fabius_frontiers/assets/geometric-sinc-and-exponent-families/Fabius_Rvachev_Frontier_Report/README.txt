...
> **Part VIII** of `geometric_q_fabius_frontiers.tex`, two levels up. The
...
> the volume includes them from `assets/geometric-sinc-and-exponent-families/Fabius_Rvachev_Frontier_Report/`. Any build or path
...
Type-3 font. At that checkpoint, a 13-entry checksum ledger verified in full;
it has since been retired and remains recoverable from Git history.
