...
> **Part~I** of `geometric_q_fabius_frontiers.tex`, two levels up. The
...
> the volume includes them from `assets/Fabius_Newton_Rvachev_Frontier_Report/`. Any build or path
