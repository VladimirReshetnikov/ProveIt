...
tranche: the inverse product germ, the general-$q$ and outside-disk Euler
rearrangements (the fixed inside $q=1/2$ rearrangement is now formalized in
\path{RvachevPochhammerFactorization.lean}), the $L^2$ Laplace
