...
\lean{Fabius.lowerLambertW_unique}.  What the generalized module does \emph{not} supply is the
range of $x$ for which the argument lands in $(-\e^{-1},0)$: that depends on $C_P$, $p$ and $q$,
and is carried as a hypothesis rather than derived, exactly as it is settled here by context.
