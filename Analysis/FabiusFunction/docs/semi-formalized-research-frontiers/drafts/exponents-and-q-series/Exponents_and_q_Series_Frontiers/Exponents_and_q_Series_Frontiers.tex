...
\begin{statusbox}{Lean crosswalk: general contracting Pochhammer factorization}
...
\]
They include $q=0$ and all individual zero factors.  The final two spectral
theorems specialize this result to the dyadic scale and nome $1/4$; the
Fourier-transform form additionally assumes a bounded Fabius witness
