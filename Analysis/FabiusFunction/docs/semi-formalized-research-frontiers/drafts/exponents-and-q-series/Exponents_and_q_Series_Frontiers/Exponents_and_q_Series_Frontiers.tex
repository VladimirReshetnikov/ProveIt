...
\lean{Fabius.gaussianBinomial_two_mul_sub_shifted_central_Icc}.
All seven are denominator-free commutative-semiring identities; the positive
shift is total in natural \(k\), while the two negative-shift forms assume
exactly \(k\le N\).
