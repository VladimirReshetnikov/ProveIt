...
second derivatives, and the complete classical Fabius curvature split have
Lean counterparts.  The endpoint theory still does not include a
branch-point derivative limit, vertical-tangent theorem, or Puiseux law.
The generic curvature module does not yet export its square-root thresholds
or strict-shape corollaries, and the generic asymptotic result does not yet
