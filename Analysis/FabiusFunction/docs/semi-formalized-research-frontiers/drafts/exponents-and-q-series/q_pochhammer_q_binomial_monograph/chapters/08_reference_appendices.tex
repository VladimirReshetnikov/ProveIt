...
\item the complex infinite \(q\)-Pochhammer product at every strict complex
  contraction: locally uniform convergence in the symbol variable, entireness,
  the exact factor-zero locus, and simplicity of every zero;
...
named Bell and quadratic support.  Beyond the fixed-\(q\) \(q\)-Pochhammer
theorem named above, no Lean status is claimed for the uniform-in-\(q\) product
and logarithmic tail bounds, joint holomorphy, or differentiated kernels of
