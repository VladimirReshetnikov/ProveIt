...
distinction.  (Reading the vanishing off the product instead would require a case split: the
offending factor sits in $(q^{-6n};q^6)_\infty$ when $n\ge0$, but in $(q^{6n+6};q^6)_\infty$ when
$n\le-1$.)
