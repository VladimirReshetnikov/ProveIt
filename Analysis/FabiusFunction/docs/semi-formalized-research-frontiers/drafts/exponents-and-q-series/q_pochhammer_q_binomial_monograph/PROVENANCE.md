...
live facade audit contains 924 modules and 11,614 public declarations with no
...
tranche gives the historical 923/11,610 checkpoint.  The live census after
the subsequent source tranches is 924/11,614.
...
is 924/11,614.  The existing `ProbabilityLaplaceMoments.lean` module now also
...
Dyadic Gaussian--Thue--Morse chapter is 11/44/1/0, and the 191-result pre-Fabius core is
36 / 29 / 123 / 3.
The five-publication concordance
has 93 Lean-proved, 385 human-proved frontier, 60 not-applicable, and 9
