...
Its current formalization ledger has 247 labelled results: 36 exact, 76
partial, 132 with no counterpart, and 3 interface-only. The finite
...
`SymmetricFunctionGenerating.lean` (two definitions and six theorems). The
