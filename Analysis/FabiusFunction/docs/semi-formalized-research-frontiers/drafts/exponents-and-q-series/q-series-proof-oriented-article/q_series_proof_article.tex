...
\begin{equation}\label{eq:poisson}
 \sum_{n\in\IntegerNumbers}f(n)=\sum_{k\in\IntegerNumbers}\widehat f(k).
\end{equation}
\end{lemma}
...
$P(x)=\sum_k\widehat f(k)\EulerE^{2\pi\ImaginaryUnit kx}$ at $x=0$ gives
\eqref{eq:poisson}.
\end{proof}
...
\[
 \widehat f(k)=(-\ImaginaryUnit\tau)^{-1/2}
