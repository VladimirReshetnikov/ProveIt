...
\path{Fabius.gaussianBinomial_neg_one_even_odd},
...
\path{Fabius.finiteQPochhammerIn_neg_one_odd}.  All six live in
\path{FabiusFunction.GaussianBinomialAtNegOne} and use only $q$-Pascal,
parity, ordinary Pascal, and factor pairing.
