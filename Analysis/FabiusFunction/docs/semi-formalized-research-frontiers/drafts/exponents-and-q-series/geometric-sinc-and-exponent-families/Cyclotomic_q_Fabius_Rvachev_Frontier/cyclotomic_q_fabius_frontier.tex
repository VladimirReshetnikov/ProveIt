...
\hypersetup{
  ...
  pdfsubject={Cyclotomic boundary asymptotics, q-Fabius--Rvachev sinc products, Bell condensation, and inverse branches},
  pdfkeywords={Fabius function, Rvachev up-function, q-Pochhammer, cyclotomic blow-up, sinc product, dilogarithm, Bell polynomial, inverse series}
}
...
\begin{equation}
 ...
 \CoefficientExtraction{\eps}{n-k}\mathcal R_k(\eps).}
 \label{eq:Ln}
\end{equation}
Consequently,
\begin{equation}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.91\textwidth]{radial_action_convergence.png}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.91\textwidth]{cyclotomic_blowup_errors.png}
...
\begin{figure}[H]
 ...
 \begin{subfigure}{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{bell_moment_collapse.png}
  \caption{Surviving cumulant error.}
  \label{fig:bell}
 \end{subfigure}\hfill
 \begin{subfigure}{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{inverse_branch_errors.png}
