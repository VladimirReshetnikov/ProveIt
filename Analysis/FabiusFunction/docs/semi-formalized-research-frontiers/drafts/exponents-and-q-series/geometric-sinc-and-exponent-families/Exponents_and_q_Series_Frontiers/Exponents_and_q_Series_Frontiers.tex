...
\path{QPochhammerInfinite.lean}, with definition \path{qPochhammerInfIn},
proves finite-prefix convergence, finite-shift and factor-removal identities,
infinite dissection, and the exact zero locus for a fixed contracting nome.
...
The zero-definition companion \path{QPochhammerEntire.lean} adds exactly five
theorems
...
For each fixed complex strict contraction $q$, they prove locally uniform
