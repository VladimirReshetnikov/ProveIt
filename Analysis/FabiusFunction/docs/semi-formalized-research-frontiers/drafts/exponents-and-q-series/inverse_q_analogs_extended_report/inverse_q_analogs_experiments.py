...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path(__file__).resolve().parent,
                        help="report directory (default: script directory)")
    ...
    write_tex_summary(root / "numerical_results.tex", minus_rows, gaussian_rows,
                      radial_rows, fabius_rows)
    write_human_summary(root / "numerical_summary.txt", groups)
