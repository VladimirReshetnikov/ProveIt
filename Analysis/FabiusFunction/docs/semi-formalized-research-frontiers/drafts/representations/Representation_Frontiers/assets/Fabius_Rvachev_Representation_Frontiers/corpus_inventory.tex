...
\begin{itemize}
\item \path{semi-formalized-research-frontiers/drafts/Fabius_Dyadic_Self_Sampling_Frontier_Package/Fabius_Dyadic_Self_Sampling_Frontier_Report.tex}
\item \path{semi-formalized-research-frontiers/drafts/Fabius_Inverse_Frontier_Report_Source_and_PDF/Fabius_Inverse_Frontier_Report.tex}
\item \path{semi-formalized-research-frontiers/drafts/Fabius_Newton_Rvachev_Frontier_Report/Exponent_Sequence_Newton_Rvachev_Frontiers.tex}
\item \path{semi-formalized-research-frontiers/drafts/fabius_frontier_dyadic_inverse_barnes_report/} (report source and auxiliaries)
\end{itemize}
\endgroup
