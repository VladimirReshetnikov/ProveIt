...
Legendre Gram determinant and Jacobi cross-ratio
...
polynomials, continued-fraction/Pad\'e identification, finite Gaunt/Wigner entry
formula, or Szeg\H{o}/Nevai/Rakhmanov asymptotics.

The generic determinant leaf \path{PolynomialMomentGramDeterminant.lean} has
two definitions, \path{polynomialCoefficientMatrix} and
\path{polynomialMomentGramMatrix}, and seven theorems:
...
It is finite change-of-basis algebra over commutative semirings, rings, and
fields, without measure or positivity hypotheses.

The specialization \path{FabiusLegendreHankelDeterminant.lean} has two
definitions, \path{upLegendreGramMatrix} and \path{upLegendreGramDet}, and
seven theorems: \path{upLegendreGramMatrix_apply_eq_integral},
...
\path{rvachevJacobiSubdiagonalRat_cast_eq_upLegendreGramDet_ratio}. These give
exact Lean counterparts to
\cref{eq:legendre-gram,eq:legendre-hankel,eq:beta-gaunt-determinants}, but not
to the finite Gaunt/Wigner entry formula \cref{eq:finite-gaunt-matrix}.
\end{remark}
...
and the generic/Legendre Gram determinant change-of-basis layers
...
\item \textbf{Finite algebra:} the determinant change-of-basis and
      ...
      \path{FabiusLegendreHankelDeterminant.lean}. Formalize the remaining
...
eq:orthonormal-center-product,eq:harmonic-mean,eq:finite-gaunt-matrix}.
      These need finite linear algebra and the existing positivity and
      rational-native APIs; the finite Gaunt/Wigner entry expansion remains
      paper-only.
