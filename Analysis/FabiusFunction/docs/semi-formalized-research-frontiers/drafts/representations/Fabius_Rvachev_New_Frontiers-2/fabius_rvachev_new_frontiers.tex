...
zero public definitions and exactly eleven public theorems, exhaustively.  Together
with the positive determinant-ratio identities above, it gives an exact evaluator
route to \(H_4\) and \(\beta_4\):
\path{moment_four},
...
over both \(\RealNumbers\) and \(\RationalNumbers\); symmetry,
odd-total-degree vanishing, and every
