...
These are noncomputable adjugate-based finite definitions, not a rational
evaluator.  In particular, they do not name or evaluate the explicit \(H_4\) and
\(\beta_4\) fractions displayed below; the later finite-values module now supplies
those named certificates.  These two earlier modules by themselves also prove no
...
independently verified by the archive's Python program, and now have the named
Lean certificates just cited.  Numerically,
\begin{equation}
