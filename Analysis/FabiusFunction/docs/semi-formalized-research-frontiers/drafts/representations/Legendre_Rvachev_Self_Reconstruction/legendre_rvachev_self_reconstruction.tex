...
\begin{enumerate}
 ...
 \item \textbf{Orthogonal block layer.}  Combine the finite identity with
 formal Legendre orthogonality to prove \eqref{eq:block-orthogonality}, the
 exact tail, and the atom-Gram formula.
 \item \textbf{Energy layer.}  Relate $u$ and $F$, invoke Parseval for the
 Fourier product, and prove the three-way identity
 \eqref{eq:A2-legendre}--\eqref{eq:A2-sinc}.
