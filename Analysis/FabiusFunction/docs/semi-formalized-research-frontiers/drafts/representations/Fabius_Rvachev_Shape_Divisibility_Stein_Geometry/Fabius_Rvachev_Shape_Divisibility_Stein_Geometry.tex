...
support, so
\[
 p(x)=\int_{2x-1}^{1}p(t)\,dt=\Prob(Z\ge2x-1)=\Prob(X\ge x).
\]
...
The centered CDF $H(x)=\Prob(Z\le x)$ and survival $1-H(x)$ are strictly
...
\begin{equation}\label{eq:bernoulli-triangle}
 ...
 \qquad \Prob(\varepsilon_{m,j}=\pm1)=\frac12.
\end{equation}
