...
This archive contains the complete source and rendered form of a 50-page research report prepared on 2026-08-30. The report audits the LaTeX research corpus under `Analysis/FabiusFunction/docs` in the `VladimirReshetnikov/ProveIt` repository, removes directions already developed there, and presents a repository-distinct probability/shape program for the Fabius-Rvachev law.
...
- `fabius_rvachev_frontier_report.pdf` — compiled 50-page report.
