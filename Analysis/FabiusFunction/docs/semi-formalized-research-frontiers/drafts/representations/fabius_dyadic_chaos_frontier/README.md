...
Package-local `SHA256SUMS` ledgers, including the former arrival copy, were
retired repository-wide on 2026-09-01. The verified intake facts below,
purpose-specific audit records, explicit artifact fingerprints, and Git
history preserve the provenance boundary; none assert that the retained PDF
...
ledger verified 30/30 against the arrival bytes. Its repository copy had
SHA-256
`85c42740d869c520d5264049f945e52b3c9cfc1bc837a19aaf05c886c55aa6ea`
and is recoverable from Git history after the repository-wide ledger removal.
