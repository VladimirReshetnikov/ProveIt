...
\begin{equation}
 \Expectation X^n=\Bell_n(\kappa_1,\ldots,\kappa_n),
...
\begin{equation}
 \boxed{
 A_k(t)=\frac1{k!}\Bell_k\bigl(\InteractionPowerSum{1}(t),-1!\InteractionPowerSum{2}(t),
...
& $A_k(2t)=A_k(t)+r(t)A_{k-1}(t)$ \\
Power-sum Bell form
& $A_k=k!^{-1}\Bell_k(\InteractionPowerSum{1},-1!\InteractionPowerSum{2},\ldots,(-1)^{k-1}(k-1)!\InteractionPowerSum{k})$ \\
