...
\newcommand{\DyadicSigmaField}{\mathcal{A}}
...
With the convention
\begin{equation}
 Q(\theta)=\sum_{n\in\IntegerNumbers}\widehat Q(n)\EulerE^{2\pi\ImaginaryUnit n\theta},
...
\end{align*}
Since $\widehat{Q'}(n)=2\pi\ImaginaryUnit n\widehat Q(n)$, the nonzero formula follows
...
& $\widehat Q(n)=\Mcal_p^{\mathrm{cont}}(-2\pi\ImaginaryUnit n/\log2)/\log2$ \\
Phase coupling
& $\TotalVariationDistance(K_t-\lfloor\log_2t\rfloor,K_\theta)\le2/t$ \\
Laplace transfer
