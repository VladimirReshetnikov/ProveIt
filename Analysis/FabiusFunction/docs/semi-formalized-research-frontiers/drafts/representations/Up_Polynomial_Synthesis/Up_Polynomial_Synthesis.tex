...
repository-normalized main source bytes at the consolidation baseline.

\begin{center}
\scriptsize
\begin{longtable}{@{}p{0.43\textwidth}p{0.52\textwidth}@{}}
\toprule
Source directory, main-source SHA-256 & Distinct contribution retained here\\
\midrule
\endfirsthead
\toprule
Source directory, main-source SHA-256 & Distinct contribution retained here\\
...
The historical hashes of the three earlier absorbed \texttt{.tex} sources
remain in \nolinkurl{assets/SHA256SUMS-absorbed.txt}.  The ten hashes above,
