...
The canonical \nolinkurl{assets/} directory retains the historical hashes of
the three earlier absorbed \texttt{.tex} sources in its
\nolinkurl{SHA256SUMS-absorbed.txt} ledger.  After the ten later
reports were completely absorbed, their individual prose/PDF directories were
retired.  Their 113 selected evidence payloads now have one-to-one canonical
destinations and live hashes under \nolinkurl{assets/companion-evidence/},
\nolinkurl{assets/evidence/}, and
