...
| theorem `thm:leg-biorthogonality` — Legendre--up dyadic biorthogonality | G1 `thm:biorthogonality` | Direct finite analysis/synthesis biorthogonality identity. | Exact/Complete: `Fabius.rvachevLegendreAnalysisKernel` and `Fabius.rvachevLegendreBiorthogonality` in `RvachevLegendreBiorthogonality.lean`. |
