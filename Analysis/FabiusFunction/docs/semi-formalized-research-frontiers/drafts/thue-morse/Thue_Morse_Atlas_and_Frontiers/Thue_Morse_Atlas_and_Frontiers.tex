...
\lean{Fabius.nestedDyadicIntegral\_const\_mul}.  The two applications
\eqref{p1:eq:reciprocal-power-positive} and \eqref{p1:eq:log-product-sign}, which need the
explicit derivatives of \((a+y)^{-s}\) and \(\log(a+y)\) and \emph{strict} positivity of
the nested integral, are not formalized.
