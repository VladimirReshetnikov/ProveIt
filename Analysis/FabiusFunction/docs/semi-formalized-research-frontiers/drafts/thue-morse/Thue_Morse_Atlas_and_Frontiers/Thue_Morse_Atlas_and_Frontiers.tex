...
The current inventory in \cref{p1:sec:formalized-modules} consists of one hundred and one compiled
...
The first tranches of the formalization now exist as one hundred and one
