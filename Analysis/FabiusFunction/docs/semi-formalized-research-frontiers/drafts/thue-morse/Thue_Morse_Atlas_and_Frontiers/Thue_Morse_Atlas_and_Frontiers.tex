...
The current inventory in \cref{p1:sec:formalized-modules} consists of one hundred and two compiled
...
\lean{Fabius.thueMorseSign\_two\_mul\_add\_one}, and the bit form
\eqref{p1:eq:tau-recursion} is \lean{Fabius.thueMorseBit\_two\_mul} and
\lean{Fabius.thueMorseBit\_two\_mul\_add\_one} in
\path{ThueMorseEnumerators.lean}; the signed pair is in
...
The first tranches of the formalization now exist as one hundred and two
