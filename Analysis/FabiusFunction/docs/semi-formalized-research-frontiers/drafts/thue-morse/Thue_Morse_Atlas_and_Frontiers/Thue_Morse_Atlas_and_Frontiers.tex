...
\(a=-c_mt\) and \(z=t\).  The subsequent complex half-angle rewrite
\(1-\EulerE^u=-2\EulerE^{u/2}\sinh(u/2)\), and hence the centered sinh product
\eqref{p1:eq:centered-sinh} as a named complex theorem, is not yet packaged in
Lean.  At the moment level, the reflection functional equation is
