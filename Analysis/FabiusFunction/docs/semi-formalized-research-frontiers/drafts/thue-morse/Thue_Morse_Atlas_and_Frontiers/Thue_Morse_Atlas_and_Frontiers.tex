...
\path{QBinomialVandermonde.lean} & Both zero-extended \(q\)-Vandermonde orientations, the full-range and exact-\(\min\)-support central identities, the total positive shifted-central form, and two negative-shift forms under exactly \(k\leq N\), all denominator-free over arbitrary commutative semirings. \\
