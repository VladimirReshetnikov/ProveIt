...
is derived; no convergence enters.  The two readings the theorem also offers --- the
\(\RationalNumbers\)-logarithm itself, and the analytic identity for \(|z|<1\) --- are not formalized:
the first is a coefficientwise integration of the display above, the second its evaluation.
