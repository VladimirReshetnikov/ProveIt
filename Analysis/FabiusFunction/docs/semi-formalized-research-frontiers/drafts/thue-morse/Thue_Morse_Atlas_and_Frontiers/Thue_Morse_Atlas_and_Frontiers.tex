...
This algebraic module does not prove the next multiple-integral corollary.
More precisely, it closes the Boolean-cube, arbitrary-step polynomial
extraction/cancellation/top-value, and exact affine-grid clauses of the
continuous-chaos report's Thue--Morse corner theorem, but not that theorem's
repeated-integral identity under its \(C^N\) hypotheses.  The report theorem
therefore remains near-complete rather than fully formalized; a final
analytic bridge and report-shaped wrapper remain.  Its following Walsh
conditional-expectation corollary also still lacks the sign--magnitude
probability construction, conditioning, and \(2^{-N}\) normalization.
...
\path{ThueMorseSymmetricDifference.lean} & Exhaustive two-definition/eleven-theorem centered companion: arbitrary half-steps and the symmetric Boolean cube, sharp commutative-ring polynomial extraction/cancellation/top value, the centered dyadic block, and both characteristic-zero increasing-grid forms.  It does not supply the repeated-integral clause of the continuous-chaos report. \\
