...
STATUS = {
 ...
 'alg:merged-exp-log-power': ('partial',
   r"after clearing the factor $n$, \cref{eq:merged-alg-exp} is "
   r"\lean{Fabius.coeff_exp_subst_recurrence} (\lean{UnitSeriesBellCoefficients}) over every "
   r"commutative $\mathbb Q$-algebra; the logarithm and general-power recurrences "
   r"\cref{eq:merged-alg-log,eq:merged-alg-power} are not formalized"),
