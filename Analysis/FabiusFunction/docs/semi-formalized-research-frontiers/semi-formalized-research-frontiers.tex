...
realization module, and the two-definition/one-theorem regular central
q-binomial sum leaf.  The live source census is 908 facade-reachable modules
and 11,498 public declarations.  The retained
...
\path{RegularCentralQBinomialSum.lean} (2+1) leaves bring the live source
census to 908/11,498.  The Lambert companion crosswalks only
