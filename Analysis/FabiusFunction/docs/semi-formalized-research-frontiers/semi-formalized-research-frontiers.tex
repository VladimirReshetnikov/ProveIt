...
definitions and 37 theorems, 41 declarations; and the
three-definition/seven-theorem geometric Richardson generating-function
module, and the three-theorem second-moment
strengthening of the existing Gaussian-binomial cumulant module, followed by
the one-definition/eight-theorem geometric-uniform moment-polynomial algebra
module, its zero-definition/one-theorem real-MGF bridge, and the subsequent
one-definition/two-theorem complex moment-product leaf and
one-definition/two-theorem exterior reciprocal-germ leaf.  The live source
census is 907 facade-reachable modules and 11,464 public declarations; the
immediately preceding inner complex-product checkpoint was 906/11,461, the
preceding real-MGF bridge checkpoint was 905/11,458, the preceding
algebraic moment-polynomial checkpoint was 904/11,457, the preceding complex
value-completion checkpoint was 903/11,448, and the preceding exact-radius
four-theorem checkpoint was 903/11,447.
The retained
...
\path{GeometricRichardsonGenerating.lean} leaf brought that source checkpoint
to 902/11,440.  Three later theorems in the existing
\path{GaussianBinomialCumulants.lean} module brought that source census to
902/11,443: the characteristic-zero second-derivative formula and the two
division-free raw-second-moment and variance-numerator identities over every
commutative semiring.  The subsequent zero-definition/four-theorem
\path{LambertWBranchGapBernoulli.lean} leaf first brought the exact-radius
checkpoint to 903/11,447.  Its fifth theorem brought the next historical
checkpoint to 903/11,448 and added the complex \(\operatorname{HasSum}\) value
\(\lean{complexExpm1Div}(z)^{-1}\) exactly on the open disk.  Thus it crosswalks
\nolinkurl{eq:pair-Bernoulli-general} and, under the explicit standard
...
\path{GeometricUniformMomentPolynomialBridge.lean} raised the next historical
census to 905/11,458.  Its exhaustive public surface is
...
extension of \nolinkurl{p7:eq:Pn-def}.  The subsequent
...
leading-coefficient formula and consequent strict odd-degree drop also remain
absent, so the compound \nolinkurl{p7:thm:Pn} remains Partial rather than
Exact.  The inner complex \(1+2\) leaf produced the historical 906/11,461
checkpoint, and the exterior \(1+2\) leaf raises the live census to
907/11,464.  These
additions are source-only, and the retained 257-page PDF remains explicitly
historical; no PDF was built for this update.
...
at zero, and calculate \(P_0,\ldots,P_4\).  The exhaustive public surface of
the companion \path{GeometricUniformMomentPolynomialBridge.lean} is no
...
Neither module proves the leading-coefficient formula and strict degree drop
for odd \(n>1\).  Therefore the compound frontier label
