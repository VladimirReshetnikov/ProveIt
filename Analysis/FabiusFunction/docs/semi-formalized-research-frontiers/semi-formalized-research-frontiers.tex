...
\path{LegendrePolynomialRational.lean}, \path{FabiusLegendreRationalGram.lean},
\path{FabiusLegendreRationalGramValues.lean} &
The downstream executable tranche adds, respectively, exactly two public definitions and
six public theorems, three definitions and eleven theorems, and eleven theorems.  Together
with the preceding four finite-algebra modules, the complete seven-module inventory is
thirteen definitions and sixty-one theorems, hence seventy-four public declarations.
The first module gives executable rational Legendre coefficients and their polynomial
wrapper.  The second gives executable rational Legendre Gram entries, matrices, and
determinants, with unconditional rational determinant identity, $D_0=1$, strict
positivity, norm quotient, and zero-based Jacobi ratio; only its entry, matrix, and
determinant cast bridges require $F:\lean{BoundedFabius}$ and
$h_F:\lean{IsFabius}\,F$.  The third proves unconditionally that
\lean{moment_four} is $132809/32531625$, together with
\[
 \begin{aligned}
 ...
 \end{aligned}
\]
It also proves $H_4=26727424/55791736875$; the declaration
\lean{rvachevJacobiSubdiagonalRat_three} gives the zero-based value
\(\beta_4=835232/4640643\).
Only its three real/integral consequences require
