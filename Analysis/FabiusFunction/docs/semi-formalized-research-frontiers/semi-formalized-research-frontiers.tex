...
zero-parameter density interpretation remains open.  Write
...
and negative ratios.  What remains here is the density interpretation at \(q=0\) and at
negative \(q\), a named compact-uniform theorem for the full phase-bearing characteristic
prefixes, rapid decay and Fourier inversion, named centered/MGF packaging, a closed
...
zero and negative ratios.  The zero/negative parameter density interpretation, a named
compact-uniform theorem for the full phase-bearing characteristic prefixes, general-\(q\)
rapid decay and Fourier inversion, centered/MGF package, closed higher-derivative and
endpoint-flatness wrappers, shape, further transforms, and explicit
