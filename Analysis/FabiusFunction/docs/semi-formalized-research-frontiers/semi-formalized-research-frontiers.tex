...
census of exactly 903 modules and 11,449 unique public declarations, with no
...
leaf 0+5 and raises the origin-side live census to 903/11,448.  It crosswalks
\nolinkurl{eq:pair-Bernoulli-general} and, under the canonical removable-origin
...
higher Puiseux claims remain open.  Retaining the unconditional
public \lean{complexQPochhammerInf_eq_qPochhammerInfIn} bridge yields the final
merged live union 903/11,449 with both documentation-gap counts zero.  The
