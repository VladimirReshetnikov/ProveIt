...
\nolinkurl{eq:pair-Bernoulli-general}, and the three-definition/seven-theorem geometric
Richardson generating-function module, and the three-theorem second-moment
strengthening of the existing Gaussian-binomial cumulant module.  The live
source census is 903 facade-reachable modules and 11,446 public declarations.
The retained
...
commutative semiring.  The subsequent zero-definition/three-theorem
\path{LambertWBranchGapBernoulli.lean} leaf brings the live source census to
903/11,446 and crosswalks only \nolinkurl{eq:pair-Bernoulli-general}; exact
radius and Puiseux claims remain open.  These additions are source-only, and the retained
257-page PDF
