...
Sequence-indexed scale and Poincar\'e coefficients (one structure, one
definition, three theorems).  The sequence forms of
\nolinkurl{q0:def:scale}, \nolinkurl{q0:def:poincare}, and
\nolinkurl{q0:prop:uniqueness} are Exact.  Uniqueness requires
\nolinkurl{[l.NeBot]}; the first-omitted-term remainder convention carries no
convergence, flat-remainder recovery, unordered-set, or maximal-scale claim. &
...
Abstract differential-block bridge (0+9).  It transports the polynomial
calculation through a derivation satisfying (d(t)=-t^{2}), (d(L)=t), for
natural exponents and, when \(t\) is a unit, for every integer exponent.
...
Flatness and invisible remainders (4+16).  \nolinkurl{q0:def:flat} and all
three clauses of \nolinkurl{q0:prop:invisible} are Exact, with the
same-coefficient statement strengthened to an equivalence.  This asserts no
convergence or recovery beyond flat remainders. &
