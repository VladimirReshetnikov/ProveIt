...
\path{GeometricResidualMoments.lean} module.  The live source census is
914 facade-reachable modules and 11,555 public declarations; the moment-
polynomial row remains Partial because its analytic normalization is absent.
The retained
...
count unchanged and brings the live source census to 914/11,555.  The
nodes-only leaf makes
...
rationality holds at rational evaluation points, the Bell identity is formal
coefficient algebra rather than analytic reciprocal-MGF convergence, and
neither \nolinkurl{thm:lag-cardinal} nor the still-Partial
\nolinkurl{thm:lag-right-inverse} is promoted.
...
\path{GeometricUniformMomentPolynomial.lean} leaf supplies the recursively defined rational polynomial,
...
Exact.  The existing \path{GeometricResidualMoments.lean} module now has zero
definitions and nine public theorems.  Its
...
No larger interpolation or node-collision claim is made.  The q forward
ledger is 175 Exact / 83 Partial / 16 None / 8 interface rows.  These
