...
\path{ThueMorseNewmanSelfSimilarity.lean}.  This gave the historical source
census 934/11,709.  Subsequent source tranches add eighteen facade-reachable
modules and 172 public declarations, reaching the upstream-tip 952/11,881
census; fixed-column reconciliation adds three net declarations and gives the
authoritative live source census of 952 facade-reachable modules and 11,884
public declarations, with zero missing module headers and zero missing
declaration comments.  The
...
added to \path{ThueMorseNewmanSelfSimilarity.lean}.  This gave the historical
934/11,709 union.  Merged reconciliation retains all five local fixed-column
declarations in the 1+27 \path{QBinomialTheoremInfinite.lean} surface and
removes the two shared declarations from the incoming rate leaf, leaving
\path{GaussianBinomialFixedColumnRate.lean} at 0+8.  Subsequent source
tranches reach the upstream-tip 952/11,881 census; the three net fixed-column
declarations give the authoritative live 952/11,884 union with zero
documentation gaps.  The incoming-branch
...
predates these overlays and the expanded ledger.  Its receipt is retained
solely as historical provenance and is not the render receipt for this merged
edition.
\end{boxedremark}
...
compound spectral clauses.  Both current source surfaces and their exact
boundaries are recorded in this crosswalk.
...
282-result forward q ledger is therefore 182 Exact, 78 Partial, 14 None, and
8 N/A.
...
\lean{hasSum_rogersSzego_generating}.
...
one theorem added to \path{DyadicBoundaryIdentity.lean}, and seven theorems
added to \path{ThueMorseNewmanSelfSimilarity.lean}.  This gave the historical
934/11,709 union.  Merged reconciliation keeps the five local fixed-column
declarations in the 1+27 \path{QBinomialTheoremInfinite.lean} surface and
deduplicates the generalized product bound and arbitrary-shift convergence
from the incoming rate leaf, leaving
\path{GaussianBinomialFixedColumnRate.lean} at 0+8.  Subsequent source
tranches reach the upstream-tip 952/11,881 census; the three net fixed-column
declarations give the authoritative live 952/11,884 union, with zero missing
...
one theorem added to \path{DyadicBoundaryIdentity.lean}, and seven theorems
added to \path{ThueMorseNewmanSelfSimilarity.lean}.  This gave the historical
934/11,709 census.  Subsequent source tranches reach the upstream-tip
952/11,881 census; fixed-column reconciliation adds three net declarations,
giving the authoritative live 952/11,884 census with zero documentation gaps.
The existing
...
The exhaustive one-definition, twenty-seven-theorem dominated-limit and
infinite q-binomial interface, including the effective fixed-column limits
and geometric error rates, Euler's product, and reciprocal sums.\\
