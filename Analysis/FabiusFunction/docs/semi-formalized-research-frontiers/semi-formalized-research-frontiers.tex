...
Wright omega theorem then add three declarations without adding a module.  The
live source census is therefore 952 modules and 11,884 explicit public
...
wrappers and the real-analytic Wright omega theorem give the live 952/11,884
...
\path{TransseriesDifferentialBlock.lean}, giving the historical 952/11,881
checkpoint.  Two written OrderDual Neumann wrappers and the real-analytic
Wright omega theorem then give the live 952/11,884 union, with zero missing
...
live 952/11,884 census, with zero documentation gaps.
The existing
