...
factorial formula, or nonnegativity-by-Wigner result.\\
...
supplies the finite Gaunt entry formulas.  Wigner/$3j$, Christoffel reconstruction,
roots or quadrature, infinite Jacobi products/continued fractions, and asymptotics remain
open.\\
...
Gram-entry expansion.  They prove no Wigner/$3j$ identification or factorial formula,
no nonnegativity by that route, no infinite Legendre-series/integral interchange, no
Christoffel reconstruction, and no named values for the displayed \(G_3\) entries.\\
...
Together with the preceding seven finite-algebra modules, these two modules complete a
nine-module inventory of eighteen public definitions and eighty-one public theorems,
hence ninety-nine public declarations.  The finite Gaunt entry expansion is part of that
inventory, but the values leaf gives no named theorem for the displayed \(G_3\) entries.
Wigner/$3j$, Christoffel reconstruction, roots or quadrature, infinite Jacobi
