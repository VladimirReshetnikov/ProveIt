...
\path{GeometricUniformMomentPolynomialBridge.lean}.  The live source census
is 915 facade-reachable modules and 11,556 public declarations.  The compound
...
\path{GeometricUniformMomentPolynomialBridge.lean} leaf brings the live source
census to 915/11,556.  The nodes-only leaf makes
...
contraction regime, including signed \(q\) and \(q=0\).  The bridge constructs
no complex-q infinite product, and the leading-coefficient formula and
consequent strict odd-degree drop remain absent.  Thus the compound
\nolinkurl{p7:thm:Pn} remains Partial rather than Exact.  The existing
