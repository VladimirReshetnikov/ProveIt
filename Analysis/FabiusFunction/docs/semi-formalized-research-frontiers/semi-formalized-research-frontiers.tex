...
their commutative-semiring, commutative-ring, and field boundaries.  The third module has
...
the conventional $\beta_{n+1}$.  The rational definitions are noncomputable finite
objects.  The two additional determinant modules contribute two definitions and seven
theorems each: the generic coherent-basis congruence
$G_n=C_n^{\mathsf T}H_nC_n$, its leading-coefficient determinant formula and Jacobi
cross-ratio transport, followed by the up-law Legendre Gram integral, determinant,
positivity, consecutive-leading-coefficient quotient, and real/rational
$\beta_{n+1}$ cross-ratios.  The generic coefficient matrix and entry formula are
semiring-level, its Gram matrix and congruence are commutative-semiring-level, its
determinant formulas are commutative-ring-level, and its quotient is field-level.
For \(F\) of Lean type \lean{BoundedFabius}, the Legendre determinant identity, empty value,
leading-coefficient quotient, and real Gram cross-ratio are unconditional; the
entry-integral, strict-positivity, and rational-cast bridge theorems require
\lean{IsFabius F}.  This closes the finite determinant component of the
Legendre bridge.  No finite Gaunt/Wigner entry expansion or rationality by that route,
explicit $H_4$ or $\beta_4$ evaluator, root, Christoffel, quadrature,
continued-fraction, Pad\'e, asymptotic, or infinite-product theorem is asserted.\\
