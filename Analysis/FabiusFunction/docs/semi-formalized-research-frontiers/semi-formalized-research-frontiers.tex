...
seventeen-theorem \path{FinitePrefixAppellRecovery.lean} leaf; the two latest
theorems in the existing \path{ProbabilityLaplaceMoments.lean} module; and
the one-definition/one-theorem
\path{RvachevLegendreBiorthogonality.lean} leaf.  The live
source census is 924 facade-reachable modules and 11,614 public declarations.
The sharp
...
the finite-prefix leaf gave the historical 923/11,610 checkpoint.  The two
new declarations in the existing \path{ProbabilityLaplaceMoments.lean}
module then gave 923/11,612, and the one-definition/one-theorem
\path{RvachevLegendreBiorthogonality.lean} leaf gives the live 924/11,614
union.  The incoming-branch
...
\path{FinitePrefixAppellRecovery.lean} (11+17) gave the historical
923/11,610 checkpoint.  The two-theorem probability extension and the
\path{RvachevLegendreBiorthogonality.lean} (1+1) leaf give the live
924/11,614 union.
...
ledger is 180 Exact / 79 Partial / 15 None / 8 interface rows; its source
concordance is 93 Lean-proved / 385 human-proved frontier /
...
923/11,610 checkpoint.  The two probability declarations and the 1+1
Legendre--Rvachev leaf give the live 924/11,614 census.  The existing
...
The q forward ledger is 180 Exact / 79 Partial / 15 None / 8 interface rows:
the closed-tail and positive-moment rows supply the two latest Exact
promotions after the sharp-degree moves, while
...
identifications, zero-tilt normalization, and positivity.  Its two newest
theorems are
\lean{weightedSumDistribution_real_Ici_eq_rvachevUp_of_nonneg} and
\lean{integral_pow_weightedSumDistribution_eq_mul_intervalIntegral_rvachevUp}:
the atomless closed tail and the positive-natural-degree full-law moment
identity, making \nolinkurl{prop:up-tail} and \nolinkurl{cor:up-moments}
Exact.  The dyadic almost-sure
