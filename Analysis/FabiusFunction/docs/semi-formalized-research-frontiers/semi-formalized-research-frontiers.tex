...
three-theorem Thue--Morse GammaLog differential leaf.  The live source census is
914 facade-reachable modules and 11,554 public declarations; the moment-
...
source census to 914/11,554.  The nodes-only leaf makes
...
Exact.  The q forward ledger is 174 Exact / 84 Partial / 16 None / 8
interface rows.  These additions are source-only, and the retained 257-page PDF
