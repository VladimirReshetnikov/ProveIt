...
described in the audit map below.  The live source census is 653 facade-reachable
modules and 8,735 public declarations.  The retained
...
of the outer product in \eqref{integration:eq:geometric-sinc-pochhammer}, or
centered characteristic-function/MGF package.  This is a source-only overlay:
the retained 237-page canonical PDF predates these five theorems and remains a
historical render until a three-pass Libertinus rebuild is performed.
...
theorem of \path{QPochhammerEntire.lean}; conversely the five-theorem wrapper
...
that the retained 237-page PDF has been rebuilt from the merged source.
...
six-declaration overlay raises the live census from 629/8,546 to 630/8,552.
It is source-only, and the retained 237-page PDF remains explicitly
historical.
...
The exhaustive zero-definition, twelve-theorem generic reflection, degree,
boundary coefficient, palindromicity, exact-degree/monicity, and mean interface.\\
\path{QuantumBinomial.lean} &
...
local-uniform/normal convergence of the outer spectral Pochhammer product,
