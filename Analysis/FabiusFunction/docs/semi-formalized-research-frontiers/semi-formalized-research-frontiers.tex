...
\begin{boxedremark}
\textbf{Artifact status (4 September 2026).}
The live source contains the 31 August 2026 Legendre
Gaunt--Wigner-square closed-form overlay, the 1 September 2026
...
historical.
This source-only integration touches the primary exposition, Lean walkthrough,
canonical frontier, geometric-q and canonical q-series syntheses,
inverse-theory and comb syntheses, Lambert Guide, Up Polynomial Synthesis, and
Thue--Morse Atlas.  Their retained PDFs are historical and rebuild-pending;
no render parity is claimed.  Exact source and PDF receipts remain external in
the repository documentation so that this artifact embeds no mutable
self-receipt.  No \nolinkurl{SHA256SUMS*} ledger exists or participates in
validation.
\end{boxedremark}
...
282-result forward q ledger is therefore 181 Exact, 78 Partial, 15 None, and
8 N/A.
...
The one-definition, twenty-seven-theorem Euler/Cauchy interface: a Banach-valued
...
\texttt{EffectiveMonotone}\\\texttt{Inverse.lean} &
...
\texttt{FabiusInverse}\\\texttt{Computable.lean} &
