...
geometric-uniform moment-polynomial algebra leaf.  The live source census is
913 facade-reachable modules and 11,551 public declarations; the moment-
...
\path{GeometricUniformMomentPolynomial.lean} (1+8) leaves bring the current
source census to 913/11,551.  The nodes-only leaf makes
...
Exact.  The q forward ledger is 173 Exact / 85 Partial / 16 None / 8
