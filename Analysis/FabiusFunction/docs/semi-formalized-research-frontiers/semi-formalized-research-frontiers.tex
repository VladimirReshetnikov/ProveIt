...
Starting from compiled source checkpoint \texttt{1f9ce6fd9} and including the focused-build
extension at compiled checkpoint \texttt{e2c310e7c}, the Rvachev moment--Appell concordance is
...
and $X^n$ to the correspondingly scaled and unscaled Rvachev--Appell polynomial; its degree
does not increase and Rvachev smoothing recovers the original polynomial.  This reciprocal-moment
...
At the same checkpoint, \path{FabiusLegendreTranslateBlocks.lean} exports six public
...
\lean{rvachevTranslateGram}.  Its five public theorems are
...
\lean{sum_rvachevLegendreAtomCoefficient_mul_gram}.  They specialize the exact finite
...
At compiled source checkpoint \texttt{e2c310e7c}, the focused-build
...
\lean{rvachevLegendrePartialSumTranslateBlockOnInterval}.  Its twenty-three public theorems are
...
$C_N=\mathcal D_{\Up}S_N$ with the finite sum of deconvolved modes, expand its common-mesh
...
These APIs still do not prove minimality or sharpness of the displayed mesh, an analytic
...
equality of the fixed-scale and separately scaled coefficient vectors, exact degree for every
