...
objects; the separate executable values leaf below supplies the explicit $H_4$ and
$\beta_4$ evaluations.  Root, Christoffel, quadrature, continued-fraction, Pad\'e, and
asymptotic theorems remain open.\\
