...
\path{TransseriesDifferentialBlock.lean}.  The live source census is therefore
...
give the live 952/11,881 union with zero documentation gaps.
The incoming-branch
...
Dickson/Neumann well-basedness (0+5 written, two generated).
\nolinkurl{q0:lem:dickson} and \nolinkurl{q0:lem:neumann} are Exact after
translating the manuscript's reverse-well-order/strict-growth convention to
\nolinkurl{Set.IsPWO}, equivalently using the order dual.  This is the
ordered-cancel-monoid mechanism, not a Hahn-series construction. &
...
\nolinkurl{Fabius.neumann_finite_factorizations}; generated
...
Wright omega basics (1+12).  The equation, inverse, positivity, strict
monotonicity, Lambert bridge, envelope, and divergence clauses of
\nolinkurl{plt:prop:mot-omega-basic} are Exact.  The proposition as a whole
remains Partial because real analyticity is not formalized. &
...
\path{TransseriesDifferentialBlock.lean}, giving the live 952/11,881 union,
...
block theorems give the live 952/11,881 census, with zero documentation gaps.
The existing
