...
twenty-seven-module q-series/q-calculus union.  The live source census is 671
facade-reachable modules and 8,858 public declarations.  The retained
...
normal-convergence leaf, two-module effective-inverse closure, and twenty-seven-module
q-series/q-calculus union and the parity-selected Rvachev synthesis leaf, the
live source census is 671/8,858.  These additions
...
\path{GaussianBinomialBounds.lean} evaluates field reciprocity, proves the
constant-term lower bound and infinite-q-Pochhammer upper bound for
...
nonzero, order, and strict-contraction premises remain explicit.
