...
the conventional $\beta_{n+1}$.  These rational definitions are noncomputable finite
objects and by themselves supply no native evaluator, root, Christoffel, quadrature,
continued-fraction, Pad\'e, or asymptotic theorem; the separate finite values module below
now supplies named $H_4$ and $\beta_4$ certificates.\\
...
give the fourth nontrivial even-moment value (the raw eighth moment), rational Legendre
Gram determinants through order five.  Under \lean{IsFabius},
\(H_4=26727424/55791736875\) is also the real Hankel ratio and squared integral,
whereas \(\beta_4=835232/4640643\) is the quotient of the fourth and third real
Hankel ratios.  This is not a general native evaluator and supplies
no Gaunt/Wigner/\(3j\), Christoffel, infinite-product, or asymptotic theorem.\\
