...
\path{GeometricUniformComplexMomentProduct.lean}.  The live source census is
918 facade-reachable modules and 11,568 public declarations.  The compound
...
the complex product leaf forms the live 918/11,568 union.  Its incoming-branch
906/11,461 census is historical.
The retained
...
gives the live 918/11,568 union.  The nodes-only leaf makes
...
the merged live census is 918/11,568.  The existing
...
The q forward ledger is 176 Exact / 82 Partial / 16 None / 8 interface rows.
These
