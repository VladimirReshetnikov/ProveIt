...
Richardson generating-function module.  The live source census is 902
facade-reachable modules and 11,440 public declarations.  The retained
...
\path{GeometricRichardsonGenerating.lean} leaf brings the live source census
to 902/11,440.  These additions are source-only, and the retained 257-page PDF
