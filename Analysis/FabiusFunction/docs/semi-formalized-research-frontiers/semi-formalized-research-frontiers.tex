...
barycenter pair, and the three-definition/seven-theorem geometric Richardson
generating-function module.  The live source census is 905 facade-reachable
modules and 11,471 public declarations.  The retained
...
\path{GeometricRichardsonGenerating.lean} leaf.  It brings the live source
census to 905/11,471.  These additions are source-only, and the retained
257-page PDF remains explicitly historical; no PDF was built for this update.
