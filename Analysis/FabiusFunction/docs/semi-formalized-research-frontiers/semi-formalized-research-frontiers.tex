...
source census is 903 facade-reachable modules and 11,448 public declarations;
the preceding exact-radius four-theorem checkpoint was 903/11,447.
The retained
...
checkpoint to 903/11,447.  Its fifth theorem brings the live source census to
903/11,448 and adds the complex \(\operatorname{HasSum}\) value
...
nearest-zero proof route; Puiseux claims remain open.  These additions are
