...
five-theorem effective fixed-column q-binomial closure, and the subsequent
zero-definition/five-theorem Bernoulli branch-gap companion.  Its earlier four
...
definitions and 37 theorems, 41 declarations.  The live source census is 903
facade-reachable modules and 11,453 public declarations, with no missing
...
over every commutative semiring.  The five-theorem effective fixed-column
q-binomial closure enlarges \path{QBinomialTheoremInfinite.lean} to 1+27 and
brings the next source census to 902/11,448.  The initial
zero-definition/four-theorem \path{LambertWBranchGapBernoulli.lean} tranche
then brings the exact-radius checkpoint to 903/11,452.  Its fifth theorem,
\nolinkurl{hasSum_bernoulli_mul_pow_div_factorial_complex_iff}, brings the live
source census to 903/11,453 and gives the complex \(\operatorname{HasSum}\)
...
nearest-zero proof route; Puiseux claims remain open.
