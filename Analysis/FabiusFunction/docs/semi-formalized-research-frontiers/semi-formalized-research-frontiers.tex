...
twenty-seven-module q-series/q-calculus union.  The live source census is 672
facade-reachable modules and 8,868 public declarations.  The retained
...
\lean{newtonInterpolant}; theorems \lean{newtonCoeff_eq},
...
\lean{eq_newtonPoly_of_eval_eq}, \lean{coeff_newtonPoly_self},
...
live source census is 672/8,868.  These additions
...
\path{NewtonInterpolation.lean} & Exactly two definitions and thirteen theorems: \lean{newtonCoeff}, \lean{newtonInterpolant}; \lean{newtonCoeff_eq}, \lean{newtonCoeff_zero}, \lean{newtonCoeff_mul_prod}, \lean{newtonPoly_succ}, \lean{eval_newtonPoly}, \lean{degree_newtonPoly_lt}, \lean{newtonPoly_eq_interpolate}, \lean{eq_newtonPoly_of_eval_eq}, \lean{coeff_newtonPoly_self}, \lean{newtonCoeff_eq_sum}, \lean{nodal_range_pow}, \lean{prod_erase_pow_sub_pow}, and \lean{newtonCoeff_pow_eq_sum}. \\
