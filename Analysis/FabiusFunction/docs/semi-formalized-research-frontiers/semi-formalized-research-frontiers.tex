...
superconvergence leaf.  The live source census is 672 facade-reachable modules
and 8,875 public declarations.  The retained
...
live source census is 672/8,875.  These additions
...
\path{GeneralQConditionNumber.lean}, and proves inversion reciprocity and
dimension-dominant upper and lower bounds under the displayed order,
nonzero-nome, and contraction hypotheses.  The
parity-selected synthesis module
\path{RvachevSuperconvergentSynthesis.lean} is 1+7: it characterizes the two
dyadic superconvergent phases and proves the corresponding monomial,
polynomial, deconvolution, and Appell sampling identities without asserting
optimality beyond that classified phase set.
