...
identity, and least-squares approximation; and the computational API.  Their use as input above
is always signposted.
...
Legendre series for $A_2=\int_0^1F(t)^2\dd t$.  It does not formalize the blocks' finite
up-translate realization or atom-Gram identity, the Fourier-product or infinite-sinc formulas
for $A_2$, or rationality of the energy partial sums.
