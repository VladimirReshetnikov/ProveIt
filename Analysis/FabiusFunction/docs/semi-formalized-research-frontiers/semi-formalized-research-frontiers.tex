...
\path{ThueMorseNewmanSelfSimilarity.lean}.  Thus 934/11,709 is the historical
pre-series checkpoint.  The subsequent nine series/transseries modules carry
72 explicit public declarations; two more Neumann names are generated by
\texttt{to\_additive}, outside the lexical count.  Six concurrent declarations
...
checkpoint.  Two written OrderDual Neumann wrappers and the real-analytic
Wright omega theorem then add three declarations without adding a module,
...
967/12,001 checkpoint.  Two modules and 47 declarations then give the
historical 969/12,048 checkpoint; the final zero-definition/three-theorem
power-recurrence leaf gives the historical 970-module, 12,051-declaration census,
...
934/11,709 union.  The nine series/transseries modules and six concurrent
declarations then give the historical 943/11,787 checkpoint.  The subsequent
nine-module, 90-declaration tranche and four-theorem integer-exponent extension
give the historical 952/11,881 checkpoint.  The two written OrderDual Neumann
wrappers and the real-analytic Wright omega theorem give the historical
952/11,884 checkpoint.  The subsequently merged 15-module tranche adds 117
explicit public declarations and gives the historical 967/12,001 union.  The
next two modules and 47 declarations give the historical 969/12,048
checkpoint; \path{UnitSeriesPowerRecurrence.lean} adds one module and three
theorems, giving the historical 970/12,051 union with zero documentation gaps.
The incoming-branch
...
one theorem added to \path{DyadicBoundaryIdentity.lean}, and seven theorems
added to \path{ThueMorseNewmanSelfSimilarity.lean}.  This gives the historical
934/11,709 union.  The nine series/transseries modules carry 72 explicit
declarations, two additional Neumann names are generated by
\texttt{to\_additive}, and six concurrent declarations elsewhere give the
historical 943/11,787 checkpoint.  The incoming nine modules add 90 explicit
public declarations, and four integer-exponent theorems extend
\path{TransseriesDifferentialBlock.lean}, giving the historical 952/11,881
checkpoint.  Two written OrderDual Neumann wrappers and the real-analytic
...
and gives the historical 967/12,001 union.  The next two modules and 47
declarations give the historical 969/12,048 checkpoint;
\path{UnitSeriesPowerRecurrence.lean} adds one module and three theorems,
giving the historical 970/12,051 union, with zero missing module headers and zero
...
one theorem added to \path{DyadicBoundaryIdentity.lean}, and seven theorems
added to \path{ThueMorseNewmanSelfSimilarity.lean}.  This gives the historical
934/11,709 census.  The following nine series/transseries modules and six
concurrent declarations give the historical 943/11,787 checkpoint.  The next
nine facade modules (90 declarations) and four integer-exponent differential-
block theorems give the historical 952/11,881 checkpoint.  The two written
OrderDual Neumann wrappers and the real-analytic Wright omega theorem give the
historical 952/11,884 checkpoint.  The subsequently merged 15-module tranche
adds 117 explicit public declarations and gives the historical 967/12,001
checkpoint.  The next two modules and 47 declarations give the historical
969/12,048 checkpoint; the final power-recurrence leaf adds one module and
three theorems, giving the historical 970/12,051 census with zero documentation
gaps.
The existing
...
These additions entered at a source-only checkpoint, when the retained
257-page PDF remained explicitly historical and no PDF was built for that
update.  They are included in this rendered canonical publication; its current
source/PDF publication receipt is kept externally in the repository
documentation.
