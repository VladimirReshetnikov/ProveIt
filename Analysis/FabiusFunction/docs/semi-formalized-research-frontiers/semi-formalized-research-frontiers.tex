...
\path{GeometricUniformComplexMomentProduct.lean}; followed by the
one-definition/six-theorem \path{RvachevLaurentLeading.lean} leaf, the
eleven-definition/seventeen-theorem \path{FinitePrefixAppellRecovery.lean} leaf, and
the zero-definition/one-theorem \path{HalfQBinomialRootSimplicity.lean} leaf.
The live source census is 921 facade-reachable modules and 11,604 public
declarations.  The compound
moment-polynomial row remains Partial only because its leading-coefficient
and strict odd-degree clauses are absent; its actual-MGF normalization is
Exact for real \(\lvert q\rvert<1\).  The incoming bridge branch recorded the
successive historical checkpoints 903/11,447, 903/11,448, 904/11,457, and
905/11,458.  In the merged chronology the real-MGF bridge first reached
...
the complex product leaf forms the historical 918/11,568 union.  Its
incoming-branch 906/11,461 census is historical.  The Laurent, finite-prefix,
and half-base root leaves then give the live 921/11,604 union.
The retained
...
checkpoints to 916/11,562 and 917/11,565; the complex moment-product leaf
gives the historical 918/11,568 union.  The subsequent
\path{RvachevLaurentLeading.lean} (1+6),
\path{FinitePrefixAppellRecovery.lean} (11+17), and
\path{HalfQBinomialRootSimplicity.lean} (0+1) leaves give the live
921/11,604 union.
...
\(\lean{Polynomial}\,(\lean{Polynomial}\,\mathbb Q)\); a fixed-inner-\(x\)
...
ledger is 177 Exact / 81 Partial / 16 None / 8 interface rows; its source
concordance is 90 Lean-proved / 388 human-proved frontier /
...
Exact.  The complex \(1+2\) leaf formed the historical 906/11,461 checkpoint;
the merged complex-product checkpoint is 918/11,568, and the subsequent three
leaves give the live 921/11,604 census.  The existing
...
The q forward ledger is 177 Exact / 81 Partial / 16 None / 8 interface rows.
These
