...
definitions and 36 theorems, 40 declarations; and the
three-definition/seven-theorem geometric Richardson generating-function
module, and the three-theorem second-moment
strengthening of the existing Gaussian-binomial cumulant module.  The live
source census is 903 facade-reachable modules and 11,447 public declarations.
The retained
...
\path{LambertWBranchGapBernoulli.lean} leaf brings the live source census to
903/11,447 and crosswalks only \nolinkurl{eq:pair-Bernoulli-general}.  It also
proves the exact complex convergence radius and boundary divergence; the full
complex value identity and Puiseux claims remain open.  These additions are
source-only, and the retained 257-page PDF
