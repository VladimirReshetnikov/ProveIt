...
zero-parameter density interpretation, standalone product and compact-uniform packaging
beyond the formal pointwise sinc-prefix limit, general-\(q\) rapid decay and Fourier
...
prefixes are formal, with exact dyadic wrappers.  What remains here is the density
interpretation at \(q=0\) and at negative \(q\), standalone \texttt{HasProd}/\texttt{tprod}
packaging and compact-uniform convergence for this product, rapid decay and Fourier
...
\texttt{Tendsto} theorem, not yet a standalone \texttt{HasProd}/\texttt{tprod} equality or
uniform convergence on compact frequency sets.
...
\begin{itemize}
\item standalone product packaging and compact-uniform convergence beyond the formal
      pointwise phase-bearing sinc-prefix limit, quantitative rapid decay, and the
...
parameter density interpretation, standalone product and compact-uniform packaging,
