...
one-definition/two-theorem complex moment-product leaf.  The live source
census is 906 facade-reachable modules and 11,461 public declarations; the
immediately preceding real-MGF bridge checkpoint was 905/11,458, the preceding
...
extension of \nolinkurl{p7:eq:Pn-def}.  The canonical q-monograph compound
\nolinkurl{thm:qF-moment-polynomial} remains Partial because the exterior
reciprocal-germ coefficient, its global rational \(a_n=d_n/n!\), and the
pole-cleared removable continuation at roots are not identified in Lean.  The
...
Exact.  The complex \(1+2\) leaf raises the live census to 906/11,461.  These
...
analytic analogue rather than a complex probability-moment identity, and it
does not identify the exterior reciprocal germ or the global rational/removable
continuation at roots required by the canonical q-monograph
