...
The generic finite-measure affine Cauchy calculus; the exact-support geometric-
\(q\) transform DDE and adjacent-power hierarchy for every nonzero \(|q|<1\), including
...
\(\alpha>1\), real and complex exterior all-moment Laurent expansions, finite-height
...
At compiled source checkpoint \texttt{1f9ce6fd9}, the Rvachev moment--Appell concordance is
\path{RvachevMomentAppell.lean}.  Its five public definitions are
...
polynomial deconvolution whose degree does not increase and whose Rvachev smoothing recovers
the original polynomial.  This reciprocal-moment Appell family is not the dyadic
...
These APIs do not prove minimality or sharpness of the displayed mesh, an analytic
...
a named outer translate-block \texttt{HasSum},
the fixed-scale partial-sum identity, or the later refinement, projector, and asymptotic
layers.
