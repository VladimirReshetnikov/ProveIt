...
with no missing module headers or declaration documentation.  The most recent
pre-\nolinkurl{d8b} receipt names an 808,185-byte TeX source (SHA-256
\nolinkurl{7dd140370a0ac68522364a83a3c6423df93570741eafaef2ee8c1fac17670e2f})
and its validated 260-page, 1,877,159-byte A4 PDF (SHA-256
\nolinkurl{9d38ab9d43befd6e26fd06ab9680b4a761365fb9d8a9f0de18489c243bd62d3e}).
The present semantic union postdates both fingerprints; the PDF is therefore
a historical render and remains rebuild-pending.  No live checksum ledger is
maintained or should be regenerated.
\end{boxedremark}
...
260-page pre-\nolinkurl{d8b} canonical PDF remains a historical render and
does not certify parity with the merged source; a fresh strict rebuild is
pending.  The generic-name analytic-order theorem is owned by
...
are source-only, and the retained 260-page pre-\nolinkurl{d8b} PDF remains
explicitly historical and rebuild-pending; no PDF was built for this update.
