...
0+7, 4+16, and 0+9), its subsequent zero-definition/three-theorem real
Bernoulli branch-gap companion crosswalking only
\nolinkurl{eq:pair-Bernoulli-general}, and the completed
zero-definition/six-theorem dyadic derivative filtration.  The first three
Lambert surfaces contain 36 declarations, 13 of them supplied by the earlier
upstream delta; the filtration delta is exactly
...
census of exactly 903 modules and 11,447 unique public declarations, with no
...
The real Bernoulli branch-gap series (zero definitions and three theorems),
crosswalking exactly \nolinkurl{eq:pair-Bernoulli-general} and no other label
in its surrounding Guide corollary.  The Bernoulli exponential generating
series is absolutely summable for \(\lvert z\rvert<2\pi\) and has its actual
...
boundary \(\lvert z\rvert=2\pi\), exact maximality of the radius, and all
higher or convergent Puiseux claims remain open. \\
...
census to 903/11,446 and crosswalks only
\nolinkurl{eq:pair-Bernoulli-general}; exact radius and Puiseux claims remain
open.  Retaining the unconditional public
\lean{complexQPochhammerInf_eq_qPochhammerInfIn} bridge yields the final merged
live union 903/11,447 with both documentation-gap counts zero.  The retained
PDF remains explicitly historical until rebuild and does not claim parity with
the current TeX.  Exact source and PDF receipts are kept externally in the
