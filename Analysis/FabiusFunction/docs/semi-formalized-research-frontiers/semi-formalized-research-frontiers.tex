...
seventeen-theorem \path{FinitePrefixAppellRecovery.lean} leaf.  The live
source census is 923 facade-reachable modules and 11,610 public declarations.
The sharp
...
the finite-prefix leaf gives the live 923/11,610 union.  The incoming-branch
...
\path{FinitePrefixAppellRecovery.lean} (11+17) gives the live 923/11,610 union.
...
ledger is 178 Exact / 81 Partial / 15 None / 8 interface rows; its source
concordance is 91 Lean-proved / 387 human-proved frontier /
...
then gave 922/11,582, and the finite-prefix leaf gives the live 923/11,610
census.  The existing
...
The q forward ledger is 178 Exact / 81 Partial / 15 None / 8 interface rows:
