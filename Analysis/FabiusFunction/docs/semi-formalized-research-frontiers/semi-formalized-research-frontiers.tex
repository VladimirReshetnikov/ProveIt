...
\path{GeometricUniformMomentRatFunc.lean} leaf.  The live source census is
924 facade-reachable modules and 11,615 public declarations.
The sharp
...
leaf gives the live 924/11,615 union.  The incoming-branch
...
ledger is 179 Exact / 80 Partial / 15 None / 8 interface rows; its source
concordance is 92 Lean-proved / 386 human-proved frontier /
...
923/11,610 checkpoint.  The RatFunc leaf gives the live 924/11,615 census.
The existing
...
The q forward ledger is 179 Exact / 80 Partial / 15 None / 8 interface rows:
\nolinkurl{p7:thm:Pn} moves Partial-to-Exact and
\nolinkurl{prop:qF-P-degree-sharp} moves None-to-Exact, while the RatFunc
assembly moves \nolinkurl{thm:qF-moment-polynomial} Partial-to-Exact.
These
