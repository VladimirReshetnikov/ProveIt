...
seventeen-theorem \path{FinitePrefixAppellRecovery.lean} leaf.  The
origin-side source census is 923 facade-reachable modules and 11,610 public
declarations; retaining the unconditional public
\lean{complexQPochhammerInf_eq_qPochhammerInfIn} bridge gives the live
zero-gap census of 923 modules and 11,611 public declarations.
\end{boxedremark}
...
\nolinkurl{p7:thm:Pn} is Exact.  The canonical q-monograph row remains Partial
because it still lacks a single global \texttt{RatFunc} coefficient and its
pole-cleared root-of-unity continuation.  The actual-MGF normalization is
Exact for real \(\lvert q\rvert<1\).  The incoming bridge branch recorded the
...
the finite-prefix leaf gives the origin-side 923/11,610 checkpoint; the
retained public q-Pochhammer bridge gives the live 923/11,611 union.  The incoming-branch
...
the preceding algebra it makes \nolinkurl{thm:TM-corner} Complete exactly by
...
\path{RvachevAppellHasse.lean} (1+14) leaves bring the live source census to
...
\path{FinitePrefixAppellRecovery.lean} (11+17) gives the origin-side
923/11,610 checkpoint; the retained public
\lean{complexQPochhammerInf_eq_qPochhammerInfIn} bridge gives the live
923/11,611 zero-gap union.
...
random-variable, \lean{HasLaw}, or analytic-MGF realization.  The inverse
package therefore has 54 Lean-proved and 91 human-proved frontier rows.
...
forward ledger is 177 Exact / 82 Partial / 15 None / 8 interface rows;
q-Lucas remains Partial.  Its source concordance is 99 Lean-proved / 379
...
\nolinkurl{thm:TM-corner} Complete.  The analytic theorem assumes nonnegative
...
coefficient.  The canonical q-monograph compound
\nolinkurl{thm:qF-moment-polynomial} remains Partial because no global
\texttt{RatFunc} declaration identifies one rational \(a_n=d_n/n!\) across
the two regimes or proves its pole-clearing identity and resulting polynomial
continuation at roots.  No boundary statement at \(\lVert q\rVert=1\) is made.  The
...
\nolinkurl{p7:thm:Pn} are Exact.  This algebraic leaf does not alter the
canonical monograph theorem's Partial status at the global \texttt{RatFunc}
boundary.  The inner complex \(1+2\) leaf produced the historical 906/11,461
...
then gave 922/11,582, and the finite-prefix leaf gives the origin-side
923/11,610 checkpoint; the retained public q-Pochhammer bridge gives the live
923/11,611 census.  The existing
...
The rigorous q forward ledger is 177 Exact / 82 Partial / 15 None / 8
interface rows: q-Lucas remains Partial;
\nolinkurl{p7:thm:Pn} moves Partial-to-Exact and
\nolinkurl{prop:qF-P-degree-sharp} moves None-to-Exact, while
...
inventories $6/33$, $0/5$, $1/8$, $2/7$, $4/6$, $1/7$, $6/7$, and $5/25$,
respectively, for exactly $123$ public declarations.  Universal
...
\(1<\lVert q\rVert\).  Neither analytic leaf supplies the global
\texttt{RatFunc} identification or pole-clearing continuation at roots
required by the canonical q-monograph
\nolinkurl{thm:qF-moment-polynomial}; that compound label remains Partial.
The sharp algebraic leaf changes neither that RatFunc boundary nor the absence
of a unit-circle continuation theorem.
