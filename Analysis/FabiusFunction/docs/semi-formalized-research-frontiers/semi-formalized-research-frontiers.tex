...
theorems in \path{TransseriesDifferentialBlock.lean} give the live source
census of 944 facade-reachable modules and 11,806 public declarations, with
...
\path{TransseriesDifferentialBlock.lean} give the live 944/11,806 union with
zero documentation gaps.  The incoming-branch
...
historical 943/11,791 checkpoint; \path{TransseriesFlat.lean} (1+11) and the
three new integer-Laurent theorems in
\path{TransseriesDifferentialBlock.lean} give the live 944/11,806 census, with
