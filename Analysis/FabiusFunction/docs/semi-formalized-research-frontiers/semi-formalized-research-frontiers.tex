...
factorization closures.  The live facade contains exactly 659 source modules
and 8,769 public declarations, with no
documentation gaps.  The retained 243-page A4 PDF, SHA-256
\nolinkurl{45552dfbaa48ecd3183830b403cd651a979a57b50d2da6c3ff58af2ac1f02549},
is a historical validation receipt and is rebuild-pending; its page count and
digest do not certify source/PDF parity for the present TeX file.
\end{boxedremark}
...
243-page canonical PDF remains a historical render and does not certify
...
six-declaration overlay is part of the live 659-module, 8,769-declaration
source union.  The retained 243-page PDF is explicitly historical and does
...
theorems, \lean{gaussianBinomial_eq_eval₂_universal} and
...
\begin{equation}
 K(t)=\Expectation\pos{U-t}-\Expectation\pos{X-t}.
...
For $0\le t\le1$,
\[
 \Expectation\pos{U-t}=\frac{(1-t)^2}{4}.
\]
...
For $y\in[-1,1]$,
\[
 h(y)=h(-1)+h'(-1)(y+1)+\int_{-1}^{1}\pos{y-t}h''(t)\Differential t.
\]
