...
extension, the Rvachev moment--Appell concordance is
...
multiplication, finite sums, and constant-polynomial multiplication; its degree does not
increase and Rvachev smoothing recovers the original polynomial.  This reciprocal-moment
...
The focused-build \path{FabiusLegendreTranslateSeries.lean} exports four public definitions:
...
\lean{tsum_rvachevLegendreTranslateBlock_uniform}.  They close the literal outer
