...
925 facade-reachable modules and 11,619 public declarations.
The sharp
...
give 924/11,617, and the Legendre biorthogonality leaf gives the live
925/11,619 union.  The incoming-branch
...
the \path{RvachevLegendreBiorthogonality.lean} (1+1) leaf gives the live
925/11,619 union.
...
biorthogonality leaf gives the live 925/11,619 census.
The existing
...
\lean{weightedSumDistribution_real_Ici_eq_rvachevUp_of_nonneg} and
\lean{integral_pow_weightedSumDistribution_eq_mul_intervalIntegral_rvachevUp},
which make \nolinkurl{prop:up-tail} and \nolinkurl{cor:up-moments} Exact for
the closed tail on \(t\geq0\) and natural moments \(n\geq1\), respectively;
the dyadic almost-sure
