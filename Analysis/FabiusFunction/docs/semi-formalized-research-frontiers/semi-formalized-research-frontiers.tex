...
telescoping-certificate leaves.  That earlier source census was 675 facade-reachable
modules and 8,909 public declarations.  A fresh post-merge source audit
reports 902 facade-reachable modules and 11,424 public declarations.  The retained
...
\nolinkurl{QChuVandermonde.lean} 0+5; the latter owns public
\nolinkurl{two_mul_choose_two}; rational-extension removal of auxiliary
nonvanishing hypotheses is not separately formalized \\
...
bring the live source census to 675/8,909.  These additions
...
The exhaustive one-definition, six-theorem reflected finite-product and terminating two-phi-one reversal interface.\\
\path{QChuVandermonde.lean} &
The exhaustive zero-definition, five-theorem q-Chu--Vandermonde interface, including the public \path{two_mul_choose_two}, denominator-cleared first sum, two quotient evaluations, and reversal proof of the second.\\
...
\path{TwoPhiOneReversal.lean} & Exactly one public definition and six theorems: the finite normalization, reflected finite-product identity and nonvanishing transfer, terminating reversal, and bridge to the analytic two-phi-one term convention. \\
\path{QChuVandermonde.lean} & Exactly five public theorems and no definitions: \lean{two_mul_choose_two}, \lean{mul_sub_one_eq_mul_sub_add}, \lean{finiteQPochhammerIn_div_eq_sum_chu}, \lean{q_chu_vandermonde_first}, and \lean{q_chu_vandermonde_second}.  All nonvanishing hypotheses remain explicit; rational-extension removal is not a separate theorem. \\
