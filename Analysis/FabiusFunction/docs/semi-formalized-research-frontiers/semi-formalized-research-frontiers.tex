...
\nolinkurl{GaussianBinomialFixedColumnRate.lean}; zero definitions and eight
theorems, inventoried below.  The generalized product bound and
...
the 203-row coefficient-calculus concordance is 59 Lean, 33 Partial, and
111 None. &
...
8 N/A.
The subsequent zero-definition/eight-theorem
...
The exhaustive zero-definition, eight-theorem effective fixed-column interface:
a finite-product defect bound, a denominator-free relative Gaussian bound,
fixed and shifted nonasymptotic additive estimates, and four relative/additive
geometric \texttt{IsBigO} results.  The generalized product bound and
