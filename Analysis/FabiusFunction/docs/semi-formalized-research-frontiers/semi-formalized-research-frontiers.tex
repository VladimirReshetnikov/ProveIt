...
convention, \nolinkurl{eq:bernoulli-gen}.  The four Lambert modules total four
definitions and 37 theorems, 41 declarations.  Their completed checkpoint is
903/11,448; the local fixed-column extension reaches 903/11,453.  Independently,
the upstream-only one-definition/eight-theorem geometric-uniform
moment-polynomial branch reaches 904/11,457 from the Lambert checkpoint.
Merging those parallel extensions gives a live source census of 904
facade-reachable modules and 11,462 public declarations, with no missing
...
union, including the exact 36-declaration Lambert branch-coordinate tranche
and the subsequent twelve-declaration terminating-basic-hypergeometric
closure, brings the preceding source checkpoint to 901/11,430.  The later
three-definition/seven-theorem
\path{GeometricRichardsonGenerating.lean} leaf brings the next source checkpoint
to 902/11,440.  Three later theorems enlarge the existing
\path{GaussianBinomialCumulants.lean} module from 2+21 to 2+24 and bring that
source census to 902/11,443: the characteristic-zero second-derivative formula
and the two division-free raw-second-moment and variance-numerator identities
over every commutative semiring.  The subsequent Lambert--Bernoulli branch
begins with three theorems at 903/11,446, adds its exact-radius fourth theorem
at 903/11,447, and reaches 903/11,448 with its fifth theorem,
\nolinkurl{hasSum_bernoulli_mul_pow_div_factorial_complex_iff}, which gives the
complex \(\operatorname{HasSum}\)
value given by the inverse of \nolinkurl{complexExpm1Div} at \(z\), exactly when
\(\lVert z\rVert<2\pi\).  Thus the exhaustive 0+5 leaf crosswalks
\nolinkurl{eq:pair-Bernoulli-general} and, under the explicit standard
...
nearest-zero proof route; Puiseux claims remain open.  The local five-theorem
effective fixed-column q-binomial closure then enlarges
\path{QBinomialTheoremInfinite.lean} to 1+27 and reaches 903/11,453.
Independently, the upstream-only one-definition/eight-theorem
\path{GeometricUniformMomentPolynomial.lean} branch reaches 904/11,457 from
the Lambert checkpoint; merging it with the local fixed-column branch gives
the live 904/11,462 union.  It supplies the recursively defined
rational polynomial, its residual-product recurrence, triangular degree bound,
reciprocal-factorial value at zero, and the cases \(P_0,\ldots,P_4\).  It does not prove the
analytic normalization identifying that family with the source moment
coefficients, nor the leading-coefficient formula and consequent strict
odd-degree drop.  Hence \nolinkurl{p7:thm:Pn} remains Partial rather than
Exact.
