...
the new-module count.  Thus the live source census is 960 facade-reachable
...
960/11,966 union with zero documentation gaps.  The incoming-branch
...
three new integer-Laurent theorems in
\path{TransseriesDifferentialBlock.lean} give the historical 944/11,806
union.  The overlay inventoried above gives the current live 960/11,966 union,
...
three new integer-Laurent theorems in
\path{TransseriesDifferentialBlock.lean} give the historical 944/11,806
census.  The overlay inventoried above gives the current live 960/11,966
