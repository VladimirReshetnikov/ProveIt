...
module and its zero-definition/one-theorem real-MGF bridge.  The live source
census is 905 facade-reachable modules and 11,458 public declarations; the
immediately preceding algebraic moment-polynomial checkpoint was 904/11,457,
the preceding complex value-completion checkpoint was 903/11,448, and the
preceding exact-radius four-theorem checkpoint was 903/11,447.
The retained
...
\path{GeometricUniformMomentPolynomialBridge.lean} raises the live census to
905/11,458.  Its exhaustive public surface is
...
contraction regime.  The bridge constructs no complex-q infinite product, and
the leading-coefficient formula and consequent strict odd-degree drop remain
absent.  Thus the compound \nolinkurl{p7:thm:Pn} remains Partial rather than
Exact.  These additions are source-only, and the retained 257-page PDF
...
\nolinkurl{p7:eq:Pn-def} is Exact in this real contraction regime.  It proves
neither a complex-q infinite-product realization nor the leading-coefficient
formula and strict degree drop for odd \(n>1\).  Therefore the compound
