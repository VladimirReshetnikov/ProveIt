...
reports 901 facade-reachable modules and 11,418 public declarations.  The retained
...
Sharp exact dyadic inverse modulus (two definitions and eight theorems).
...
assert a modulus at the convention-only zero input, or export a named
primitive-recursiveness/computability theorem. &
