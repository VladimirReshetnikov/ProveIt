...
package reversed endpoints, a variable-upper-endpoint area identity, improper
singular-endpoint extensions, complex-valued arbitrary-AC primitives, higher or fractional
inverse primitives, or complex Mellin continuation.  In particular, accepting complex
weights does not by itself export the report's named Fourier or Mellin transform corollaries.
\end{remark}
