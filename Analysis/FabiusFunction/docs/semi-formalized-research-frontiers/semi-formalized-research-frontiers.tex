...
0+7, 4+16, and 0+9), the exact inverse-recursion certificates, and the Jacobi
two-square counting leaf.  The live source census is 903 facade-reachable
modules and 11,437 public declarations.  The retained
...
brings the live source census to 903/11,437.  These additions are source-only,
and the retained 257-page PDF remains explicitly historical; no PDF was built
for this update.
