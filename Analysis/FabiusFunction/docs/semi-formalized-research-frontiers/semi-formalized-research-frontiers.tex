...
0+7, 4+16, and 0+9), and the three-definition/seven-theorem geometric
...
source census is 902 facade-reachable modules and 11,443 public declarations.
The retained
...
\path{GaussianBinomialCumulants.lean} module bring the live source census to
...
commutative semiring.  These additions are source-only, and the retained
257-page PDF
