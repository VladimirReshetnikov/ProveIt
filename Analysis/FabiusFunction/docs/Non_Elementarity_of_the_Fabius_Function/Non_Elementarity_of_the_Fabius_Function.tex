...
Generators (\Cref{lem:generators})
  & \texttt{analyticAt\_log\_of\_ne\_zero}, \texttt{analyticAt\_rpow\_const}, \texttt{analyticAt\_sqrt\_of\_ne\_zero}, \texttt{analyticAt\_arctan}, \texttt{analyticAt\_arcsin}
  & \texttt{ElementaryFunction} \\
