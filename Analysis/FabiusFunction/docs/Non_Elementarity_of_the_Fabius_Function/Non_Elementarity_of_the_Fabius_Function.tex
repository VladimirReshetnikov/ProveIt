...
the algebraic functions that are not expressible by radicals, and it rests on
a degree induction that avoids the discriminant, of which \texttt{Mathlib} has
no usable theory, in favour of the analytic implicit function theorem, of
which it does.
\end{abstract}
