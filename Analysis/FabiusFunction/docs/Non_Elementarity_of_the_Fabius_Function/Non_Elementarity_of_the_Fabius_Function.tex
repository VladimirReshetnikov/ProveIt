...
The same conclusion is then proved for a class the inductive definition does
not reach: any continuous branch of a polynomial equation whose coefficients
are elementary and whose leading coefficient vanishes nowhere.  This covers
continuous algebraic branches, including examples not expressible by radicals,
and it rests on a degree induction that avoids the discriminant, of which
