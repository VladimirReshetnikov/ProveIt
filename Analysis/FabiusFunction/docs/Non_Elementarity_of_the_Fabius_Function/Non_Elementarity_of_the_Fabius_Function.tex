...
Lambert $W$ belongs to $\Elem^{-1}$
  ...
  & \texttt{InverseBranch} \\
$F^{-1}$ is differentiable on $(0,1)$ with $(F^{-1})'=1/F'$, hence has no critical point, and is nowhere analytic (\Cref{thm:invnowhere})
  & \texttt{hasDerivAt\_fabiusInv}, \texttt{deriv\_fabiusInv\_ne\_zero}, \texttt{fabiusInv\_not\_analyticAt}, \texttt{fabiusInv\_analyticAt\_iff}
