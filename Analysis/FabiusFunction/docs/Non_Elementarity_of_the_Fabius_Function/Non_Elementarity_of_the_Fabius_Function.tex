...
Interior calculus and smoothness of $F^{-1}$
  & \path{fabiusInv_hasDerivAt}, \path{hasDerivAt_fabiusInv}, \path{deriv_fabiusInv}, \path{deriv_fabiusInv_eq_inv_two_mul_rvachevUp}, \path{deriv_fabiusInv_pos}, \path{fabiusInv_contDiffOn_Ioo}
  & \path{FabiusInverse} \\
