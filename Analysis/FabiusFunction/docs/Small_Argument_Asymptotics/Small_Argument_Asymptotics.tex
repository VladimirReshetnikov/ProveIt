...
\item The mean of $A_j$ is its ``$\Psi$-free part'' plus the mean of the
  terms of degree two and higher in the derivatives of $\Psi$.  That
  correction is small but it is \emph{not} uniformly tiny, and it grows with
  $j$ for the same reason the oscillation does: 
  $\langle P_aP_b\rangle=2\sum_{k\ge1}(2\pi\ii k)^a(-2\pi\ii k)^b|\Psihat(k)|^2$
  carries the amplification $(2\pi k)^{a+b}$ of \cref{sec:fourier}.  Measured
  over a period, $\langle A_j\rangle$ minus the $\Psi$-free part is
  $-9.3\times10^{-11}$, $-3.9\times10^{-9}$ and $-1.14\times10^{-7}$ at
  $j=1,2,3$ --- about a factor $40$ per order.  What justifies calling the
  $\Psi$-free part the mean is not an absolute bound but a ratio: at each
  order it is four to five orders below the oscillation of $A_j$ itself,
  which is $8.7\times10^{-5}$, $3.9\times10^{-3}$ and $6.7\times10^{-2}$.
\end{itemize}
