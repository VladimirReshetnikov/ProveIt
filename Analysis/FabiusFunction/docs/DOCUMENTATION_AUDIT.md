...
The post-merge 2026-08-31 inventory contains 615 modules and 8,385 lexically
...
union adds five modules and 67 declarations.  The branch-point geometry and
...
current inventory and those zeroes, so every future source addition must preserve the
