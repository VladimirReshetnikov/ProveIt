...
Mathlib's stronger analytic order; the analytic locus is a separate question.
\end{remark}
...
inversion, transported flatness, effective steepness, and endpoint
quotient divergence. & \Formalized\\
...
\begin{itemize}
\item $C^\infty$ interior regularity of $\InvF$ and the formulas for
$\InvF'$ and $\InvF''$;
\item strict concavity on $(0,1/2)$, strict convexity on $(1/2,1)$,
and the exact smooth and analytic loci;
