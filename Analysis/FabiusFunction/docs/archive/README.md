...
- **`Thue_Morse_Formula_Atlas-1/`** — Parallel consolidation of the four deleted `Further_Formulae` drafts into a Thue--Morse formula atlas; distinctive for its self-contained natural-boundary proof, the supertile argument for the linear factor-complexity bound, and the literature panorama of arithmetic subsequences (primes, squares, cubes, level of distribution).  Fully merged into the living primary Atlas draft on 2026-08-26 and moved here rather than deleted.
  Files: `Thue_Morse_Formula_Atlas.pdf`, `Thue_Morse_Formula_Atlas.tex`.  Source commit: `bc4c91a1e` (2026-08-26).  Original location: `Analysis/FabiusFunction/docs/non-formalized-research-frontiers/drafts/Thue_Morse_Formula_Atlas-1/`.

- **`Thue_Morse_Formula_Atlas-2/`** — The largest of the three parallel atlas consolidations; distinctive for Gelfond's sharp uniform exponent, the odd-modulus matrix recursion for rarefied sums, the autocorrelation Mahler equation, the subtraction/borrow cocycle, the weighted digit enumerator, and the Hankel--Padé framing of irrationality measure.  Fully merged into the living primary Atlas draft on 2026-08-26 and moved here rather than deleted.
  Files: `Consolidated_Formula_Atlas_for_the_Thue_Morse_Sequence.pdf`, `Consolidated_Formula_Atlas_for_the_Thue_Morse_Sequence.tex`.  Source commit: `bc4c91a1e` (2026-08-26).  Original location: `Analysis/FabiusFunction/docs/non-formalized-research-frontiers/drafts/Thue_Morse_Formula_Atlas-2/`.
