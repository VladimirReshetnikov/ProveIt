...
The measured amplitudes are $8.7\times10^{-5}$ for $A_1$ and
$1.94\times10^{-3}$ for $A_2$, the latter slightly above the leading-term
estimate because the $w^3$ term of $c_2$ adds in phase; \cref{sec:numerics}
measures a spread of about $6\times10^{-2}$ for $A_3$.  So the periodic parts of
