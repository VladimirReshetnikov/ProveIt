...
\hypersetup{
  ...
  pdfsubject={Inverse theory, non-elementarity, probability--Laplace bridges, discrete limit engines, and all-orders saddle machinery},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Fabius--Rvachev supplement}
\fancyhead[R]{\small\nouppercase{\leftmark}}
\fancyfoot[C]{\thepage}
...
\large Inversion, non-elementarity, probability--Laplace bridges,\\
and the algebra behind the saddle expansion}
\author{A companion to \emph{The Fabius Function and Rvachev's Up-Function}\\
...
ordinary analysis}.  This distinction matters most for the interior derivative of the
inverse and for the transfer of the highest-jet coefficient from mass coefficients to
...
\end{equation}
This is the mathematical content of \lean{fabiusOrderIso} and \lean{fabiusInv}; Lean uses
\lean{Set.IccExtend} rather than spelling out \eqref{eq:clamp}.
...
The current inverse module deliberately avoids differentiability assumptions and builds the
inverse using order topology alone.  Once the positivity theorem for $F'$ in the open unit
interval is imported, the classical inverse function theorem supplies a sharper interior
picture.
...
\begin{remark}
\Cref{cor:inverse-derivative,cor:inverse-curvature} are straightforward consequences in
ordinary real analysis.  The named Lean declarations in \path{FabiusInverse.lean} stop at
continuity, monotonicity, exact inversion, and endpoint steepness; they do not presently
package the interior inverse-function theorem.
\end{remark}
...
\lean{fabiusInv\_fabiusDyadicUnit}, the transported root-free bounds,
