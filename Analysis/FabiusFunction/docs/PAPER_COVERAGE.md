...
| --- | --- |
| Theorem 1 | `Fabius.IsOriginalFabius`, `Fabius.IsFabius.isOriginalFabius_rvachevUp`, `Fabius.isOriginalFabius_iff_eq_canonical`, `Fabius.rvachevUp_eq_iff_eqOn_Iic_one`, `Fabius.isFabius_iff_isOriginalFabius_rvachevUp_and_rightTail`, `Fabius.isOriginalFabius_iff_existsUnique_isFabius`, `Fabius.existsUnique_originalFabius`, `Fabius.originalFabius_eq_canonical` |
