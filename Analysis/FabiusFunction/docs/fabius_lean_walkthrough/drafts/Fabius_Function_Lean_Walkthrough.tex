...
\]
A half-interval version similarly identifies \decl{halfMoment}.
...
\addlinespace[.28em]
\module{PoissonSummation} & Schwartz Poisson summation, partitions of unity, period-two expansions, and source corrections. \\
\addlinespace[.28em]
...
\addlinespace[.28em]
\pathbreak{IsOriginalFabius} & Original compact-support characterization with its a priori unknown scaling constant; used by the independent Fourier uniqueness theorem. \\
\addlinespace[.28em]
