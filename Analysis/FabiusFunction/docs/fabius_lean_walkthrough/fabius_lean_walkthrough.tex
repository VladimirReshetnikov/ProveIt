...
Totalized inverse \(F^{-1}\) & \lean{fabiusInv}, \lean{fabiusOrderIso} & \file{FabiusInverse.lean} \\
...
\modulefile{FabiusInverse.lean} & Totalized inverse, order isomorphism on the unit interval, and continuity/monotonicity. \\
