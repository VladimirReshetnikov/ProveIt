...
\modulefile{FabiusInverse.lean} & Totalized inverse, order isomorphism on the unit interval, exact positive reciprocal derivative, interior \(C^\infty\) smoothness, and endpoint steepness. \\
