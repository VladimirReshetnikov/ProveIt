...
counts this catalogue exactly once.  It contains 166 mathematical content sources: 61
standalone documents and 105 included or generated fragments.  The separate shared
contract \modulepath{docs/fabius-notation.tex} raises the total before this catalogue to 167
active TeX files.  Including this standalone catalogue gives 168 active TeX files and
62 standalone documents.  ``Standalone'' means that the uncommented source
...
\modulepath{drafts/incoming/} & 6 & 0 & 6\\
...
\midrule
Mathematical content subtotal & 61 & 105 & 166\\
Shared notation contract & 0 & 1 & 1\\
This catalogue & 1 & 0 & 1\\
\midrule
Active TeX total including catalogue & 62 & 106 & 168\\
\bottomrule
\end{longtable}
\endgroup
