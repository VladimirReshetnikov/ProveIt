...
\small Active corpus at the validation snapshot: 165 recursively inventoried
\texttt{.tex} sources}
...
current 165-source active \texttt{.tex} corpus.  Each entry states its type, domain,
...
counts this catalogue exactly once.  It contains 163 mathematical content sources: 65
standalone documents and 98 included or generated fragments.  The separate shared
contract \modulepath{docs/fabius-notation.tex} raises the total before this catalogue to 164
active TeX files.  Including this standalone catalogue gives 165 active TeX files and
66 standalone documents.  ``Standalone'' means that the uncommented source
...
\modulepath{drafts/inverse-and-sampling/} & 6 & 30 & 36\\
...
\midrule
Mathematical content subtotal & 65 & 98 & 163\\
Shared notation contract & 0 & 1 & 1\\
This catalogue & 1 & 0 & 1\\
\midrule
Active TeX total including catalogue & 66 & 99 & 165\\
\bottomrule
\end{longtable}
\endgroup
