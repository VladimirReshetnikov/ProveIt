...
\small Active pre-catalogue corpus: 158 recursively inventoried \texttt{.tex} sources}
...
158 pre-existing active \texttt{.tex} sources.  Each entry states its type, domain,
...
\path{docs/papers/} may display its original notation only in a passage explicitly marked
as a quotation or historical convention; surrounding project prose uses the canonical
symbols.  Included tables and generated fragments inherit the namespace of their
standalone parent document.
\end{boxedremark}
...
topological closure.\\
$\Convolution,\MetricDistance,\TotalVariationDistance$ &
\commandname{Convolution}, \commandname{MetricDistance},
\commandname{TotalVariationDistance} & Algebraic/measure convolution, generic metric,
and the fixed probability TV convention.\\
...
\path{docs/archive/}.  It contains 160 mathematical content sources: 77 standalone
documents and 83 included or generated fragments.  The separate shared contract
\path{docs/fabius-notation.tex} raises the pre-catalogue active TeX total to 161.  Once
this standalone catalogue is included, the corresponding totals are 162 active TeX
files and 78 standalone documents.  ``Standalone'' means that the uncommented source
...
\path{drafts/exponents-and-q-series/} & 17 & 18 & 35\\
\path{drafts/frontier-compilations/} & 5 & 2 & 7\\
\path{drafts/integration-and-transforms/} & 1 & 7 & 8\\
\path{drafts/inverse-and-sampling/} & 9 & 17 & 26\\
\path{drafts/lambert-w/} & 1 & 4 & 5\\
\path{drafts/representations/} & 22 & 26 & 48\\
\path{drafts/rvachev_up_fourier_decay/} & 1 & 0 & 1\\
\path{drafts/spectra-and-arithmetic/} & 9 & 9 & 18\\
\path{drafts/thue-morse/} & 1 & 0 & 1\\
\midrule
Mathematical content subtotal & 77 & 83 & 160\\
Shared notation contract & 0 & 1 & 1\\
This catalogue & 1 & 0 & 1\\
\midrule
Active TeX total including catalogue & 78 & 84 & 162\\
\bottomrule
\end{longtable}
\endgroup
...
\begin{itemize}
\item \path{docs/fabius-notation.tex} defines exactly 88 shared commands.
\item Every one of those 88 command names occurs in the canonical quick reference and
