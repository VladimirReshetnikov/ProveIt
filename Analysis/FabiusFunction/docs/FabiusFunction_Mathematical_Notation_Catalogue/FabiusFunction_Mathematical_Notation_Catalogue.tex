...
\texttt{LOCAL-NON-FOURIER-HAT:} declaration.  There are 31 marked declarations
and 31 distinct command names; each is declared in exactly one active document scope.
...
counts this catalogue exactly once.  It contains 160 mathematical content sources: 55
...
56 standalone documents.  ``Standalone'' means that the uncommented source
...
\midrule
Mathematical content subtotal & 55 & 105 & 160\\
Shared notation contract & 0 & 1 & 1\\
This catalogue & 1 & 0 & 1\\
\midrule
Active TeX total including catalogue & 56 & 106 & 162\\
\bottomrule
\end{longtable}
\endgroup
