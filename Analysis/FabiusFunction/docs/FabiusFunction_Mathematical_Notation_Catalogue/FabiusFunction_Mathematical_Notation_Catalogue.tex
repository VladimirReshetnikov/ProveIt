...
$\FourierSeriesCoefficient{h_T}{k}
...
$\FourierSeriesCoefficient{h}{k}$ & \commandname{FourierSeriesCoefficient} &
Integer-indexed coefficient of a periodic function; not a continuous line transform.\\
...
\begin{itemize}
\item \path{docs/fabius-notation.tex} defines exactly 90 shared commands.
\item Every one of those 90 command names occurs in the canonical quick reference and
...
\item Both line-Fourier conventions, Fourier-series coefficients, both sinc
      normalizations, both Fabius inverses, the
