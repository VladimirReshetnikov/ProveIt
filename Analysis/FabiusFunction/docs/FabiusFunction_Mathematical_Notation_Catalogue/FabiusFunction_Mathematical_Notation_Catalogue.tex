...
periodic coefficient uses \commandname{FourierSeriesCoefficient}.  A hat on a polynomial,
...
register close that semantic gap; rendered-PDF inspection later closes the composition
and layout gap.
