...
\subsection{Formal interior calculus and an ordinary-analysis curvature corollary}
...
\cref{cor:inverse-curvature} remains an ordinary-analysis corollary rather than a separate
declaration.
\end{remark}
