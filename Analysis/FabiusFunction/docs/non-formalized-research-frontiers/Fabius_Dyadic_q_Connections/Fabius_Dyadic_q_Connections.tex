...
The following table lists the principal formal ingredients.  Every filename is
relative to the Fabius development's Lean source directory in the
\texttt{ProveIt} repository.

\begin{center}
\renewcommand{\arraystretch}{1.16}
\begin{tabularx}{0.96\textwidth}{>{\ttfamily\raggedright\arraybackslash}p{0.48\textwidth}X}
\toprule
