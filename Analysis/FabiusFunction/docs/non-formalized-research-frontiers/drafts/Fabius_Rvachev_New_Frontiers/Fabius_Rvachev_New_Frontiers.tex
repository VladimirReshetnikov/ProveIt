...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Fabius--Rvachev frontiers}
\fancyhead[R]{\small\nouppercase{\leftmark}}
\fancyfoot[C]{\thepage}
...
\small commit \nolinkurl{00c2f223339f4a9d3ab306c56d42da9f4d3e0bf1}}
...
\]
which proves \cref{eq:Berry-Esseen}; the CLT follows.
\end{proof}
...
The finite algebraic coefficient stage of Theorem \ref{thm:endpoint-transfer}
...
\cref{thm:endpoint-transfer}.  It does not prove the analytic identity with
...
deduce the endpoint remainder in \eqref{eq:endpoint-transfer}.  The status of
