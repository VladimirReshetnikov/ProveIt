...
The later modules \texttt{ExponentialPartition.lean} and
\texttt{ExponentialBell.lean} now formalize, over every commutative
...
\texttt{SaddleExpansion.expCoeff} engine.  This supplies reusable
...
Taylor and tail estimates, or a separately named complete Bell
polynomial.  Consequently none of the status labels in this report
changes.
\end{boxedremark}
