...
retained term.  Compact support, a standardization-uniform Cram\'er condition,
and control of the scaled $X_2$ remainder are the expected ingredients
(fifteenth wave).  This discrete-index expansion is the companion of the
continuous-parameter Edgeworth program for $a\downarrow1$ in
\cref{p6:sec:parameter-limits}.
\end{conjecture}
