...
\cref{p1:thm:lobe-sign}, read from right to left.  What is not formalized is the exact
order $\omega_L(a)$ of its zero at $z=1$, and the free-even-layer step that sums the
offset-independent core over the $2^{L-\omega_L(a)}$ even-layer offsets.
\end{theorem}
