...
\cref{lem:q-weights} is formal as well (see the crosswalk paragraphs there).  These labels
concern representation only, not correctness: no result of this report is formalized end
...
\item The geometric Lagrange weights, Gaussian-binomial closed form, exact
      ...
      norm are now formalized; transferring this finite kernel to the report's analytic
      Richardson remainder remains open.
\end{enumerate}
