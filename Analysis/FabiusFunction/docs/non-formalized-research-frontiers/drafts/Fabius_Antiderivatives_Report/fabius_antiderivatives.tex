...
a mathematical proof here.  ``Repository input'' means that an already
established result is imported from the audited corpus.  ``Conjecture'' means
that the statement is supported by the preceding analysis but is not proved.
None of the new theorems in this report has yet been translated into Lean.
\end{statusbox}
