...
retained because, although \path{RandomSeriesLaw.lean} now proves the equality-in-law
splitting, the cumulant-generating instance \eqref{p2:eq:cumulant-operator} has no formal
counterpart, and nothing yet expresses all four faces as instances of one statement.
