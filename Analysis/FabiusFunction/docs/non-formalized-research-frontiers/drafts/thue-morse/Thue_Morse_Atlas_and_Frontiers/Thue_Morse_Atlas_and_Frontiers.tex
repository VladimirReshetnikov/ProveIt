...
specialization, and the obligation is discharged.  (The operator-exponential display
\eqref{p2:eq:cumulant-operator} itself --- the deconvolution calculus --- is a stronger
analytic statement and remains open, as does a single statement instantiating to
