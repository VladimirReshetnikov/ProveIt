...
\newtheorem{literaturenote}[theorem]{Literature note}
...
\cref{app:concordance}.  The verification packages of all four are preserved
verbatim under \path{assets/}; the absorbed member directories are deleted
