...
The first tranches of the formalization now exist as nineteen compiled Lean
modules in \repo{}, complementing the corpus modules
...
\begin{center}
\small
\begin{tabularx}{0.94\textwidth}{@{}>{\raggedright\arraybackslash}p{0.34\textwidth}>{\raggedright\arraybackslash}X@{}}
\toprule
Module & Contents \\
\midrule
...
\path{ThueMorseMultinomial.lean} & Frobenius factorization and \(O_r(n)=r^{\wt(n)}\).  \emph{Open.} \\
\path{ThueMorseBooleanMobius.lean} & Submask incidence algebra and inverse parity matrix.  \emph{Open} (the enumerator layer is delivered). \\
...
Of the planned layers, only the multinomial, Boolean--M\"obius,
complex-Fourier, Dirichlet--Mellin, and factor-complexity rows remain
open; everything finite or formal has been delivered, in most cases in
