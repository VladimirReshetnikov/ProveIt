...
factorization of \(1/\Gamma\) and its derivative at zero are
\lean{Fabius.Gamma\_inv\_eq\_self\_mul} and
\lean{Fabius.hasDerivAt\_Gamma\_inv\_zero}; the derivative of the
...
The first tranches of the formalization now exist as forty-eight
