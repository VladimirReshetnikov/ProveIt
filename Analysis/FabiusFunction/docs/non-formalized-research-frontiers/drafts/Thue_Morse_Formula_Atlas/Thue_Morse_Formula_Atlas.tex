...
The current inventory in \cref{sec:formalized-modules} consists of seventy-three compiled
...
the arbitrary-support moment statement and master product live one level
...
The first tranches of the formalization now exist as seventy-three
