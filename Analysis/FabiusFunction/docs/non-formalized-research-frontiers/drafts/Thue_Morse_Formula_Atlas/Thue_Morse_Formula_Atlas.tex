...
(\path{ThueMorseGenerating.lean}); the analytic convergence statement
and the lacunary quotient expansion remain unformalized.
...
domain \(\mathbb Z[[z]]\) yields the boxed equation.  Only the
equivalence with the three-term recurrence
\eqref{eq:integer-lift-recurrence} remains unformalized.
...
The first tranches of the formalization now exist as thirty-five
