...
The first tranches of the formalization now exist as twenty-one compiled
Lean modules in \repo{}, complementing the corpus modules
...
\path{ThueMorseFourier.lean} & Finite DFT, Walsh transform, product-to-sum identities.  \emph{Walsh delivered}; the complex DFT layer is open. \\
...
Of the planned layers, only the complex-Fourier, Dirichlet--Mellin, and
factor-complexity rows remain open; every finite or formal layer has
been delivered, in most cases in greater generality than proposed.
