...
For every \(m\ge1\), the modulus also has exactly one maximizer in the
positive side lobe \((m,m+1)\), by
\lean{Fabius.existsUnique\_isMaxOn\_lobe} in
...
The first tranches of the formalization now exist as sixty-four
...
\path{SincProductShells.lean} & Exact dyadic shell factorization of \(|\Phi|\) and its Gelfond-rate bound along every nonzero real dyadic ray. \\
...
\path{RvachevProductContinuity.lean} & Real-axis continuity of \(\Phi\) and \(|\Phi|\), and existence and uniqueness of the modulus maximum on each positive side lobe \((m,m+1)\), \(m\ge1\). \\
\bottomrule
\end{longtable}}
...
\nolinkurl{552f76a235e883e5b44212dec5325b0589be1395}, 2026.
