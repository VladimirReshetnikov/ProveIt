...
Since 26 August 2026 the formalization of this atlas is underway in the same
repository: seven new compiled Lean modules cover the Boolean-cube master
identities, the valuation and digit chapters, the enumerators, the general
finite-difference engine, the sparse Prouhet identities, the modulo-three
rarefaction, and aperiodicity.  Statements proved in Lean carry their
declaration names in the text, typeset as \lean{Fabius.thueMorseSign}; see
\cref{sec:formalized-modules} for the module map.  Several are proved in
Lean in *more* generality than stated here, and the text records the stronger
forms.
\end{boxedremark}
...
weights, arbitrary coefficient rings, hypothesis-free autocorrelation ---
the text above records the stronger form.  The module proposals in the
table below remain the plan for the layers not yet reached.
...
\path{ThueMorseRarefied.lean} & Root-of-unity filters, modulo-three closed forms, odd-modulus matrix recursion. \\
\path{ThueMorseWords.lean} & Uniform recurrence, aperiodicity, and the elementary complexity bounds. \\
\bottomrule
\end{tabularx}
\end{center}
