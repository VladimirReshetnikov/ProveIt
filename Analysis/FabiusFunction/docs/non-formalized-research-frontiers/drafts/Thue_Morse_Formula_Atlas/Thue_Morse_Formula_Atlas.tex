...
\path{RvachevProductContinuity.lean} & Real-axis continuity of \(\Phi\) and \(|\Phi|\), the strict global peak at zero, and existence and uniqueness of the modulus maximum on each positive side lobe \((m,m+1)\), \(m\ge1\). \\
