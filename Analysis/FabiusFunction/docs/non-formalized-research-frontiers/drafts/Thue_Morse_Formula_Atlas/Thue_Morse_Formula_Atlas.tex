...
The equivalence of the closed form with the recurrence
\eqref{eq:integer-lift-recurrence} and the algebraic equation
\eqref{eq:integer-lift-algebraic} remains unformalized.
...
The first tranches of the formalization now exist as thirty-two
