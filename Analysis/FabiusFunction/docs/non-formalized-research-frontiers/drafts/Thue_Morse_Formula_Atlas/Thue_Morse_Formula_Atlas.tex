...
Dirichlet--Mellin & \(D(s,a)=\Gamma(s)^{-1}\int_0^\infty t^{s-1}\e^{-at}E(\e^{-t})\dd t\).  \emph{Delivered} for the boundary-flatness input (\path{ThueMorseBoundaryFlatness.lean}); the Mellin integral and continuation remain open. \\
\bottomrule
\end{longtable}
...
subsequence.  The complex-holomorphic statement and the Mellin
...
The first tranches of the formalization now exist as thirty-eight
