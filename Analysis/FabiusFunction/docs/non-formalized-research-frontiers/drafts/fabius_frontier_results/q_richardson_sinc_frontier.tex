...
exactness.  The report-specific all-residual Gaussian \(q\)-formula and the
analytic sinc-product acceleration, error bounds, spline
limits, and inverse-function consequences remain unformalized.
