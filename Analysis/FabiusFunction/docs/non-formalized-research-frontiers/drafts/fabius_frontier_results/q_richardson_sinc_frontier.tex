...
The modules \path{GeometricQBinomialLagrange.lean},
\path{GeometricLagrangeQBinomial.lean}, and
\path{GeometricLagrangeQMoments.lean} now prove the finite rational
\(0<q<1\) weight formulas, all residual moments and their sign, and the exact
finite \(\ell^1\) norm, including dedicated \(q=1/4\) corollaries.  The
...
\item \textbf{Finite q-algebra (formalized).}  The denominator-free product,
Gaussian coefficients, \(W_m\), the weights, all residual moments, their
sign, and the finite exact norm are proved in
\path{FiniteQBinomialCore.lean},
\path{GeometricQBinomialLagrange.lean}, and the report-facing rational
geometric modules cited above.
