...
\cref{tab:dyadic-errors}: at $n=160$ the third W-order reaches
$-1.14\times10^{-9}$ versus $4.92\times10^{-8}$ for the third
$\rho$-order, and already the bare carrier ($-7.6\times10^{-6}$)
outperforms the $\rho$-scale's $h_2$-approximant
($-3.6\times10^{-6}$ at the same $n$) by absorbing the logarithmic
drift.}
\label{tab:W-errors}
\end{center}
