...
conjectures are labeled as such.  Provenance of the seven absorbed
...
dyadic endpoint comb.  This section, absorbed from the tenth-wave
Euler--Maclaurin report, extends the same spectral mechanism in four
...
termination arises from the present mechanism.
\end{theorem}
...
eliminates them from consecutive raw sums alone.  Explicitly,
\begin{equation}
...
This volume absorbs the following seven drafts (all dated 28 August
