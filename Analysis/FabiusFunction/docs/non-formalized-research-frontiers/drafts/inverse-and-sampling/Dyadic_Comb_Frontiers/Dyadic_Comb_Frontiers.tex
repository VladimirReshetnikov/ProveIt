...
(This settles what \cref{thm:D-positive} left open beyond $q=1$; the
former open question at this spot is thereby resolved.)
\end{proof}
...
finite-rank form
$\sum_{r=1}^{d+1}\frac{\fall d{r-1}}{r!}B_r(\theta)\,2^{-mr}$: phase
