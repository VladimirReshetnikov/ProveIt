...
| Directory | Document | Previous path |
| --- | --- | --- |
| `Rvachev_Up_Exact_Polynomial_Representation_Report/` | *Exact Polynomial Plateaux from Rvachev’s Up-Function* | `drafts/incoming/Rvachev_Up_Exact_Polynomial_Representation_Report.zip` (unpacked 2026-08-28, sixth wave) |
