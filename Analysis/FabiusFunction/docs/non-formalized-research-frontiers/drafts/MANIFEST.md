...
| `inverse_fabius_asymptotics_report/` | *Complete Small-Argument Asymptotics of the Inverse Fabius Function* | `drafts/incoming/inverse_fabius_asymptotics_report.zip` (unpacked 2026-08-28, fifth wave) |
| `inverse_fabius_all_orders_package/` | *Closed All-Orders Endpoint Asymptotics for the Inverse Fabius Function* | `drafts/incoming/inverse_fabius_all_orders_package.zip` (unpacked 2026-08-28, fourth wave) |
...
| `Rvachev_Up_Polynomial_Representation_Package/` | *Exact Polynomial Synthesis by Finite Rvachev Up-Function Dictionaries* | `drafts/incoming/Rvachev_Up_Polynomial_Representation_Report.zip` (unpacked 2026-08-28, fourth wave) |
| `rvachev_up_polynomial_representation/` | *Exact Polynomial Windows from Finite Sums of Shifted and Scaled Rvachev up Functions* — an independent write-up of the same topic as `Rvachev_Up_Polynomial_Representation_Package/` | `drafts/incoming/rvachev_up_polynomial_representation.zip` (unpacked 2026-08-28, fourth wave) |
