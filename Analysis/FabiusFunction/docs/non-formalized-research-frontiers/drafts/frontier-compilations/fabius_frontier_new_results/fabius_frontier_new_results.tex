...
the finite condition-number identity \cref{eq:qcondition}; its infinite limit
...
\eqref{eq:h-Bell}; the transformed sinc-tail identities, analytic Richardson
...
strength asserted in \cref{thm:Psi-extraction}.
