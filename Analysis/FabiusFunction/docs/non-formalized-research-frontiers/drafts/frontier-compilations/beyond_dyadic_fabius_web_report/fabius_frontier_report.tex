...
including arbitrary-weight affine head--tail decomposition, scalar naturality, reflection,
and interval concentration.  The specialization \path{GeometricUniformLaw.lean} defines
...
cumulants, or smoothness.  Those report claims remain frontier mathematics.
\end{boxedremark}
...
the density identity in this proposition have not yet been promoted.
...
in item 3 remain open, as does the characteristic-function program in item 4.
