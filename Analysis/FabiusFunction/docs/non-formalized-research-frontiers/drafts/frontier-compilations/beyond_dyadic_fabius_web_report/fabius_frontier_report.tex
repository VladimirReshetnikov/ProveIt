...
\paragraph{Current formalization boundary.}
The measure identity \eqref{eq:distributional-refinement} is formalized exactly as
...
\begin{equation}
 ...
 \qquad(\lambda\to+\infty,\ \lambda\equiv u\!\pmod1).    \label{eq:phase-accelerated}
\end{equation}
