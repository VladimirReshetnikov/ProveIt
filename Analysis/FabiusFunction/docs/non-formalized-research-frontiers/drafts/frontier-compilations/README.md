...
Reports I--IX were absorbed content-preservingly (labels, citation keys,
...
Report X received the same treatment plus post-snapshot Lean-status updates.
The former report directories were deleted. Provenance with SHA-256 hashes is
recorded in the volume itself, and git history is the archive.
