...
none of the new results was represented as already formalized in Lean.  Two finite algebraic
layers are explicit post-snapshot exceptions.  Source checkpoint
...
identities used in \cref{lem:q-weights}; checkpoint
\path{c45276994d9411a45bef409ad6bc481771613113} adds the finite rational
geometric-Lagrange kernel---closed weights, all residual moments and their sign, and the exact
finite \(\ell^1\) norm, including \(q=1/4\).  These declarations do not formalize this
report's exponent-sequence classification, transformed infinite series, analytic Richardson
remainder, tomography, infinite condition-number limit, or asymptotic applications.
\end{statusbox}
