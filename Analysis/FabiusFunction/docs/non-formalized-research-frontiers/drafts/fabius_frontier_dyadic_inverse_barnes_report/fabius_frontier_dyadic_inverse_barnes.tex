...
\eqref{eq:w-qbinomial} is the equivalent paper convention, not a newly added
...
in the present field setting.  The Lagrange formula \eqref{eq:w-residual} is
...
\cref{thm:exact-recovery} are not consequences
