...
integral.  For $\mathcal F$, equation \eqref{eq:global-diffeq} has no domain
...
\begin{proof}
For $0\le x\le1$, apply \cref{thm:finite-weighted} with $g(t)=t^p$ and
...
Formula \eqref{eq:monomial-closed} is a bounded-$F$ identity on
$(-\infty,1]$.
...
\eqref{eq:Ip-outside} for $x>1$ has not been packaged as a theorem in this
...
\begin{itemize}
\item the complex-power series \eqref{eq:complex-series}, including absolute
