...
module does not define the Cauchy--Stieltjes transform of the up measure or prove
\eqref{p1:eq:R-dde}; the measure-specific resolvent equation, its application to the
complex resolvent \(R\), and the kernel identity \eqref{p1:eq:R-kernel-tree} remain
...
\end{enumerate}
The finite affine-cube induction in item 4 is delivered.  Items 1--3, and hence the
measure-specific resolvent DDE and its instantiation in the displayed formulas above,
remain open.
\end{problem}
