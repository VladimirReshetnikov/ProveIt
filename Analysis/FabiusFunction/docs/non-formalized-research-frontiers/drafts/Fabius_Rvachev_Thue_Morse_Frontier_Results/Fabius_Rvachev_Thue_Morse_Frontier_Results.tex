...
The main new identities have unusually short dependency chains.  The finite geometric
Lagrange/\(q\)-binomial bridge, including all positive residual moments, is now compiled in
\path{GeometricQBinomialLagrange.lean}.  Tail self-similarity is reindexing, and the weak
expansion is Taylor's theorem plus independence and symmetry.  The analytic logarithm,
explicit zeta remainder, weighted Richardson remainder, and convergence claims still require
the surrounding analysis layer.  These are the remaining formalization targets.
