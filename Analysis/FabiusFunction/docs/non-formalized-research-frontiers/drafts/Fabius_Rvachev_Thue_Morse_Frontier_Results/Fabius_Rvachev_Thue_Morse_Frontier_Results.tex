...
$q$-binomial form (compiled in \path{GeometricQBinomialLagrange.lean}), and the $r=0$ layer
of the gamma tower already have Lean counterparts, several of them more general than the
statements printed here.  The analytic logarithm, explicit zeta remainder, weighted
Richardson remainder, and convergence claims still require the surrounding analysis layer;
these are the remaining formalization targets.
