...
% e3a7fcad3d4076a1cfea098defe9b922b1dd9910691b1d575e365597d415e8ed
...
Former source SHA-256 values:
\nolinkurl{e3a7fcad3d4076a1cfea098defe9b922b1dd9910691b1d575e365597d415e8ed} and
...
\begin{boxedremark}
\textbf{Formalization boundary.}
The Lean development supplies exact probability, centered-spline,
Thue--Morse, derivative, and convergence inputs related to this construction.
It does not yet contain declaration-by-declaration counterparts for the
repeated-integration factorization and finite-stage formulas in this part, the
sharp $L^\infty$ and derivative-error constants, the Peano-kernel and
convex-order argument, or the all-orders expansion. Those results remain
ordinary mathematical claims and formalization obligations, even where their
ingredients resemble or specialize current Lean theorems.
\end{boxedremark}
...
% Former source SHA-256 values:
% 8776344b6f214e656345070af0dc69d29239b67ed44cdba4173dac2ead19c80d
...
\nolinkurl{8776344b6f214e656345070af0dc69d29239b67ed44cdba4173dac2ead19c80d} and
...
The following statements are paper-level corollaries or reorganizations of those formalized
results; the list does not assert that they already have exact Lean declarations:
\begin{itemize}
...
\end{itemize}
Their paper proofs require no new analytic property of the Fabius function: each proceeds by
finite algebra, coefficient extraction, or the already formalized uniform spline estimates.
Nevertheless, until an exact declaration is audited for the full statement, each item remains
a frontier formalization obligation rather than a theorem of the Lean library. This distinction
separates conceptual reorganization from theorem names that already occur verbatim in the
repository.
