...
support is \([0,1]\).  A named general-\(q\) CDF and explicit density, their CDF/density
identities, transforms, moments/cumulants, smoothness, and fixed-point uniqueness remain in
the frontier.
...
are now exact formal inputs.  A named \(q\)-CDF and explicit density, their \(q\)-specific
equations, transforms, moments/cumulants, smoothness, and uniqueness of a measure fixed point
are not.
\end{boxedremark}
...
arbitrary-family Toeplitz wording, generic Gaussian coefficient bounds, and the named
general-\(q\) CDF, explicit density, CDF/density equations, transform, moment/cumulant,
smoothness, and uniqueness layers beyond the formalized geometric-\(q\) measure recurrence,
absolute continuity, null-singleton, and exact-support results.  The inverse
...
Absolute continuity, null singletons, and the exact range and support identities are now
formal.  A named general-\(q\) CDF and explicit density, their \(q\)-specific equations,
transforms, moments and cumulants, smoothness, and uniqueness of the affine measure fixed
point remain outside the formal boundary for the general geometric family.
...
At compiled full-facade checkpoint \texttt{22f801337}, the definition
...
\(|q|<1\), exact support \([0,1]\) for \(0\le q<1\), and both half-base bridges; a named
general-\(q\) CDF and explicit density, their equations, transforms, moments/cumulants,
smoothness, and fixed-point uniqueness remain outside the formal boundary.\\
