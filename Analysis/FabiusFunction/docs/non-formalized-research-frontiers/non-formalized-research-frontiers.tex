...
The definition \lean{fractionalVolterra} in \path{FractionalVolterra.lean} is a total
...
positive-order Banach-valued integration by parts across an ordinary derivative with its exact
