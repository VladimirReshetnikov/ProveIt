...
with an ordinary integral against $\Up$.  It has now been formalized in a
Banach-valued $L^1$ form and integrated into the main article; this section
retains the Fubini mechanism and the original scalar consequence.
...
Banach-valued $L^1$ survival-kernel identity and its scalar differentiable
corollary, raw and endpoint moment identifications, zero-tilt normalization, and positivity;
