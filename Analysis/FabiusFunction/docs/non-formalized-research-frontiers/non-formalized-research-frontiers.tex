...
\end{equation}
No order-zero operator law, reversed-endpoint fractional interpretation, fractional-order
semigroup, general power/constant evaluation, Caputo or other fractional
derivative, complex-order theorem, or Fabius-, Rvachev-, or inverse-function specialization
...
continuous-kernel integrability and input additivity; the strict-interval positive-real
shifted beta-kernel value; no order semigroup, power/constant specialization,
fractional derivative, complex order, order-zero law,
reversed-endpoint fractional interpretation, or hierarchy-specific specialization;
