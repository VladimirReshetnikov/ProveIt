...
geometric-\(q\) weights, series, probability law, recurrence, and reflection.  For every
\(|q|<1\) the geometric law has support equal to its exact series range, and for
\(0\le q<1\) that support is \([0,1]\).  Atomlessness, CDF/density identities, transforms,
...
\(0\le q<1\) are now exact formal inputs.  Atomlessness, \(q\)-specific CDF or density
equations, transforms, moments/cumulants, and uniqueness of a measure fixed point are not.
\end{boxedremark}
...
range; under \(0\le q<1\), both that range and the support are exactly \([0,1]\).

The twenty-one declarations are
...
The exact range and support identities are now formal.  Atomlessness, \(q\)-specific CDF and
density identities, transforms, moments and cumulants, and uniqueness of the affine measure
fixed point remain outside the formal boundary for the general geometric family.
...
The twenty-one-declaration named geometric weight, series, and law API: summability and mass,
continuity and measurability, affine splitting, reflection, support equal to the series range
for \(|q|<1\), and exact support \([0,1]\) for \(0\le q<1\);
\cref{integration:sec:weighted-naturality}.\\
...
Generic weighted-law naturality and support & Not recorded in the pinned companion snapshot &
...
the seven-name compatibility surface; a separate ten-name tranche gives support equal to
the series range, exact signed-real min/max intervals, and nonnegative specializations.\\
...
reflection, support equal to the series range for \(|q|<1\), exact support \([0,1]\) for
\(0\le q<1\), and both half-base bridges; atomlessness, CDF/density identities, transforms,
moments/cumulants, and fixed-point uniqueness remain outside the formal boundary.\\
