...
\date{Consolidated repository snapshot: 28 August 2026}
...
\path{ProbabilityLaplaceMoments.lean} &
Almost-sure support, restriction to $[0,1]$, survival function, the
finite-measure Banach-valued $L^1$ full and clipped survival-kernel identities,
their partial/full Rvachev layer-cake specializations, the differentiable
compact-support Fubini identity, raw and endpoint moment identifications,
zero-tilt normalization, and positivity;
