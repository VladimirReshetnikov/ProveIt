...
The binary recurrences used throughout this section are
\begin{align}
...
the right-boundary remark below.  Two further pieces of foundational material are attached at
...
$\varepsilon_n=1-2\tau(n)$.  The standard parity recursion computes it one binary digit at a
time, while it also admits a
...
\path{docs/non-formalized-research-frontiers/Small_Argument_Asymptotics/}.
...
\path{docs/non-formalized-research-frontiers/Small_Argument_Asymptotics/}.  This primary
