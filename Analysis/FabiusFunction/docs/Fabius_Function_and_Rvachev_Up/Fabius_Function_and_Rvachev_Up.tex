...
$\varphi(0)=1$, and have topological support exactly $[-1,1]$.  If $k>0$ and
\begin{equation}
...
positivity identifies its ordinary nonzero set as $(-1,1)$.  For $0\le t\le1$, differentiate
...
forced value $k=2$.  It also proves that every bounded Fabius solution folds to an original
