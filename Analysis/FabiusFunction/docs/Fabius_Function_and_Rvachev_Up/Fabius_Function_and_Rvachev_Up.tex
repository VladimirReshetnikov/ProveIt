...
\path{Dyadic.lean}, \path{DyadicCorrectness.lean},
...
Thue--Morse prefixes &
\path{ThueMorsePrefix.lean}, \path{ThueMorsePrefixGenerating.lean},
\path{ThueMorsePrefixLimit.lean}, \path{ThueMorseApproximation.lean}\\
Endpoint asymptotics &
\path{NegativeLaplace.lean}, \path{NegativeLaplaceProduct.lean},
\path{PeriodicCorrection.lean}, \path{PeriodicFourier.lean},
\path{FabiusLambertPhase.lean}, \path{FabiusSaddlePoint.lean},
\path{FabiusSaddleAsymptotic.lean}, \path{FabiusSecondSaddleCorrection.lean},
