...
that itself grows.  The measured peak-to-peak amplitudes are $8.73\times10^{-5}$,
$1.94\times10^{-3}$, about $6\times10^{-2}$ and about $0.82$, so the ratio of truth to
estimate drifts $1.00$, $1.08$, $1.24$, $1.63$.  Use \eqref{eq:as-amplitude-law} to see how
fast the oscillation grows, never to size a particular coefficient.
\end{warning}
