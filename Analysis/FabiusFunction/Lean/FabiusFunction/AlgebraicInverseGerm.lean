...
/-- The coefficient of the even weight series is `b (m / 2) · Q^(m / 2)`
when `m` is even, and zero otherwise. -/
...
/-- Every odd-indexed coefficient of the even weight series vanishes. -/
...
/-- Substituting the distinguished germ root into the germ polynomial gives zero. -/
...
/-- The constant coefficient of the quadratic dyadic jet is zero. -/
