...
/-- The coefficient of the even weight series is the corresponding
parameter-weighted correction coefficient in even degree and zero otherwise. -/
...
/-- Every odd coefficient of the even correction-weight series vanishes. -/
...
/-- The distinguished implicit germ root has zero parameter-constant term. -/
...
/-- Substituting the distinguished germ root into its germ polynomial gives zero. -/
