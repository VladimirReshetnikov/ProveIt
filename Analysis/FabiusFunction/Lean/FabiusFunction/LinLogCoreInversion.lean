...
/-- For `a, b > 0`, the principal-branch root is positive. -/
...
/-- In the two-branch window, the principal Lambert value is negative. -/
...
/-- For `a > 0 > b`, the principal-branch root is positive in the two-branch window. -/
...
/-- For `a > 0 > b`, the lower-branch root is positive in the two-branch window. -/
