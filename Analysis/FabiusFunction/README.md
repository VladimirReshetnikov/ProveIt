...
> union contains exactly 903 source modules and 11,447 public declarations.
...
> origin inventory has 11,446 declarations because it lacks this tree's unique
...
> The Lambert branch-gap union adds `LambertWBranchGapBernoulli` 0+3:
...
> endpoints, and no boundary, maximal-radius, remainder, or higher-Puiseux
> claim is made.
