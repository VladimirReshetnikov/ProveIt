...
| Complete homogeneous evaluations and every residual moment of finite interpolation | `FabiusFunction.CompleteHomogeneous`, `FabiusFunction.LagrangeResidualMoments` | `completeHomogeneousEval_eq_eval_hsymm`, `completeHomogeneousEval_option_succ`, `eval_completeHomogeneousQuotient`, `degree_lagrangeResidualPolynomial_lt_card`, `sum_weight_mul_pow_card_add`, `sum_lagrangeEvalWeight_mul_pow_card_add` |
| Principal specialization of complete homogeneous polynomials on geometric nodes and Gaussian residual moments | `FabiusFunction.GeometricLagrangeCompleteHomogeneous` | `completeHomogeneousEvalOn_geometric_range`, `sum_geometricLagrangeWeight_mul_pow_succ_add_eq_gaussianBinomial`, `geometricLagrangeQMoment_eq_residual_qBinomial_via_completeHomogeneous` |
...
| Exact lower-Lambert phase locking and reciprocal-node Richardson algebra | `FabiusFunction.LambertPhaseLockedRichardson` | `fabiusLambertPhase_phaseLockedNode`, `Periodic.apply_fabiusLambertPhase_phaseLockedNode`, `shiftedReciprocalLagrangeWeight_eq_choose`, `sum_shiftedReciprocalLagrangeWeight_mul_periodicPhaseLocked`, `sum_shiftedReciprocalLagrangeWeight_residual` |
