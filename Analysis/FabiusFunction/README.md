...
> **Artifact status (2026-09-01).**  The primary exposition and Lean
...
> adds expanded formula-and-proof ledgers and the source-only five-theorem
> fixed-nome complex q-Pochhammer entire-function overlay, so exact post-merge
...
> and q-Pochhammer-entire tranches and are not synchronized with their current
> sources.  Earlier checks
...
> parity rebuilds for the expanded source commentary and q-Pochhammer overlay.
