...
> 952 source modules and 11,884 public declarations.  The documentation audit
...
> `GaussianBinomialFixedColumnRate` 0+8,
...
> 903/11,453 and synchronized five source/PDF pairs.  The parallel upstream-only
> moment-polynomial checkpoint `3b6396deb6056523d944d79602d1bf7ecf18ec10`
> was 904/11,457.  These are historical checkpoints, not descriptions of the
> live facade.
>
> **Historical first-merge publication receipts (10/10 accepted at their
> recorded source snapshots).** Primary:
...
> passes `393/401/401`, with `makeindex` after each pass (`164` accepted,
> `0` rejected, `254` lines, `0` warnings); PDF
...
> All ten passed the prohibited-log, A4/rotation, PDF 1.5, encryption,
> embedded/subset-font, Libertinus, Type-3, and visual gates; the q index was
> clean. For geometric-q specifically, all 404 pages are A4 at rotation zero,
> the PDF is unencrypted PDF 1.5, all 43 font rows are embedded and subset,
> Libertinus has 11 rows, Type-3 has zero rows, and checksum basenames and
> PDF/source references are absent.
>
> **Earlier accepted receipts (history).** The following six tuples validate
> only their recorded pre-merge source snapshots:
>
> - primary exposition: 13,748-line, 686,081-byte source, SHA-256
>   `661ebb4e337f2ce79e8c3d5ca823bcdcce519fe220ff4b02d9dd5aef08d42cf9`;
>   three passes at 185/187/187 pages; 187-page A4 PDF, 1,581,617 bytes,
>   SHA-256 `41e95844c6e5dc04933cc7256d285346c10eb29ff7eadf5a4165c472fa453eab`;
>   final 1,309-line, 52,641-byte log, SHA-256
>   `f177cb91c161f4dfc60017ddfd5efed1586ef28a4c80c68a9ae78cf19cf75da6`;
> - Lean walkthrough: 6,638-line, 460,643-byte source, SHA-256
>   `c44ab7ab38da46f8959a63916437b3d8ded628a3930f81dfa1a87996c7c66b8d`;
>   three passes at 146/151/151 pages; 151-page A4 PDF, 1,188,993 bytes,
>   SHA-256 `907b3d2dbfc66192b63b86ada1015779229636855734815402ae5af9ea9bf015`;
>   final 1,296-line, 52,126-byte log, SHA-256
>   `0962c255aeb75bce3bcee89cbc1db9defe369e8c79ee6b6aa0435befdca410cf`;
> - canonical frontier: 17,983-line, 806,798-byte source, SHA-256
>   `a1cb1c0db2784116ca1f1d6fd1ce7e8b29afc52c64c93e7001bbffb91f775039`;
>   three passes at 252/260/260 pages; 260-page A4 PDF, 1,877,420 bytes,
>   SHA-256 `78c19b361da06836c20c62fa5bd50131eb8fa47d3e89d37a7f089a51568953b3`;
>   final 2,990-line, 101,866-byte log, SHA-256
>   `4854a89ba1a3bb41248b9428cfed572f6ed593125b5a8fb43d5625d8d392dc0f`;
> - Lambert Guide: 4,873-line, 177,465-byte source, SHA-256
>   `90413f46373415edef411e9ea3b2d94006f7342bd2fa3ea931ca975d7f64b97e`;
>   three passes at 67/69/69 pages; 69-page A4 PDF, 958,516 bytes, SHA-256
>   `b159cd41f5b3e53060fa85fcfc4812d504cc1fff8400c03ecb7ef4018f37cd2c`;
>   final 1,574-line, 57,795-byte log, SHA-256
>   `5c81cd6b8dc2cf070c4b1995c98c0d046c54d28f0e682b78b5ad9e16c0a8caa7`;
> - q-Pochhammer/q-binomial monograph: 16,448-line, 816,185-byte master,
>   SHA-256 `a463abef7bb3c70e12a568a46fc192aac88a8ce240f8f781fff2b018a4aa086d`,
>   and 26,114-line, 1,168,039-byte full source graph, aggregate SHA-256
>   `d4c5b84cc07f6abb99279c5bba4fdf7404326426cbe81f4b33b72ba01e62739c`;
>   three passes at 383/391/391 pages, with `makeindex` after each pass
>   (164 accepted, 0 rejected, 0 warnings); 391-page A4 PDF, 2,464,712 bytes,
>   SHA-256 `a52eb90dec7b874cc29dea891a107b9eb2d55e6727eb8bd8943d0aab609c58a6`;
>   final 1,231-line, 44,343-byte log, SHA-256
>   `fb74b0c4cbd75d9022c78c1df5c1d567120bd67728d5b418697ddc5a2aa8f450`;
> - standalone geometric-q root: 27,520-line, 1,266,515-byte source,
>   SHA-256 `8292f10862334cb809139259eeb4906bb14f517d41b9600c9b7ad53bb21525b1`;
>   three passes at 385/402/402 pages; 402-page A4 PDF, 8,332,886 bytes,
>   SHA-256 `d47431e4d3e721fccf12f90226db77f1898e44b477878954acca3a6e90127cf4`;
>   final 2,557-line, 114,331-byte log, SHA-256
...
> page, font, Type-3, text-extraction, and visual gates; the Lambert clipping
> defect and canonical page-176 running head collision were repaired before
> acceptance.  The five exact `581bf`
> source/PDF pairs below are retained explicitly as historical checkpoints.
> The historical 187-page, 1,578,751-byte primary PDF has SHA-256
> `7a93d9c47c22c62dc50cda6a64d030bfad5f44a9ef4cc5568b3b8b16b014bc8f`
> and matched its 13,720-line, 684,413-byte source with SHA-256
> `7efb8d2294a15cf6b150bb0b04b35db74cf68db3f3cdb4bc5d765b7738504019`.
> The historical 150-page, 1,185,846-byte Lean-walkthrough PDF has SHA-256
> `8a5416061addfb480f410e8306340994fe7f5160927a928112087b6b1d5c0cf5`
> and matched its 6,603-line, 457,421-byte source with SHA-256
> `4e6ea24897a31683c53e71c6cb97eb21f37eff3ae4e452add429bd9f47646ea6`.
> The historical 260-page, 1,875,190-byte canonical-frontier PDF has SHA-256
> `fee3b5af21b01b16c41cf8291ba0508d1e6c613bfd098cdef457cde44ea693c2`
> and matched its 17,947-line, 804,625-byte source with SHA-256
> `ac6b28fb8a98d97ed4b7a0fe7a5ba2cdfab852fb6de1ee2ecfda4aed75804371`.
> The historical 70-page, 958,713-byte Lambert Guide PDF has SHA-256
> `24e8bf561283ffc5427297df6f656696a7e2538731e53d03d59e4268b50772fc`
> and matched its 4,864-line, 176,796-byte source with SHA-256
> `3f3552983a73db2dab94f3625d10d054b747ee03fc2758e257af86f6216deab5`.
> The historical 391-page, 2,464,122-byte q-series PDF has SHA-256
> `c0a00720685f40e0684b4858e7ce18ce134701529898fd4574d09b6c090e0e91`
> and matched its 16,433-line, 815,194-byte master with SHA-256
...
> 158-page comb-interpolation artifact likewise remains a historical receipt;
> it is superseded by the accepted 160-page receipt above. The other listed
> publications retain the separate pending status stated in their package notices.
...
> 0+3 and 1+19.  That tranche gives the historical 934/11,709 census.
> Later upstream source work reaches 952/11,881; retaining the three unique
> local `QBinomialTheoremInfinite` compatibility wrappers gives the
> exact-name-deduplicated live union of 952 modules and 11,884 public
> declarations.  The separate
...
> In the combined 282-result forward ledger, the exact closures give 182 Exact
> / 78 Partial / 14 None / 8 interface rows.  In particular, the 1+4 RatFunc
> leaf makes `thm:qF-moment-polynomial` Exact by assembly; the broader
> `thm:geometric-uniform-mgf` remains Partial.
> Exactly ten retained publication PDFs had source closures changed by the first
> merge. Its accepted artifacts are retained as historical receipts: the 199-page primary
> exposition, 171-page Lean walkthrough, 273-page canonical frontier, 401-page
> q-series synthesis, 70-page Lambert Guide, 137-page canonical inverse-theory
> synthesis, 160-page comb-interpolation synthesis, 63-page Up polynomial
> synthesis, 144-page Thue--Morse atlas, and 404-page standalone geometric-q
> volume. Up and comb remain current. All accepted current campaign receipts
> are centralized in the [draft
> manifest](docs/semi-formalized-research-frontiers/drafts/MANIFEST.md#current-post-merge-publication-receipts).
> All nine campaign roots now have current source/PDF parity. The Transseries
> volume is recorded as rendered with disclosed layout warnings and still needs
> a separate layout-repair pass. The
> historical TeX/PDF pairs contain
> the post-merge unions, including the centered
...
| Effective fixed-column Gaussian convergence | `FabiusFunction.GaussianBinomialFixedColumnRate` | Exhaustive zero-definition/eight-theorem surface: `norm_finiteQPochhammerIn_pow_sub_one_le`, `norm_finiteQPochhammerIn_self_mul_gaussianBinomial_sub_one_le`, `norm_gaussianBinomial_sub_inv_finiteQPochhammerIn_le`, `norm_gaussianBinomial_add_sub_inv_finiteQPochhammerIn_le`, `gaussianBinomial_fixedColumn_relativeError_isBigO`, `gaussianBinomial_shifted_fixedColumn_relativeError_isBigO`, `gaussianBinomial_fixedColumn_error_isBigO`, and `gaussianBinomial_shifted_fixedColumn_error_isBigO`.  It reuses the upstream `norm_finiteQPochhammerIn_pow_sub_one_le_exp` and `tendsto_gaussianBinomial_add_atTop` declarations instead of redeclaring them.  In a normed commutative ring with normalized multiplicative norm and `‖q‖ ≤ 1`, the bounds control `‖(q^m;q)_k-1‖` by `(k exp k)‖q‖^m` and give the denominator-free relative estimate `‖(q;q)_k[n,k]_q-1‖ ≤ (k exp k)‖q‖^(n-k+1)` for `k≤n`, so they remain meaningful at roots of unity.  Over an arbitrary normed field with `‖q‖<1`, the other declarations give fixed and shifted nonasymptotic additive bounds and relative and additive `IsBigO` estimates with rates `q^(n-k+1)` and `q^(n+1)`.  They require neither completeness nor `q≠0`; the constant is elementary rather than sharp.  Together with the upstream fixed and shifted limits, this closes all four clauses of the q-monograph's `thm:fixed-column-limit`, with the two relative results encoding its multiplicative `1+O(·)` statements. |
