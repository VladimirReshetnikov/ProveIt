...
> 630 source modules and 8,552 public declarations, with no documentation
> gaps.  Its q-series union retains `QPochhammerEntire` 0+5,
> `QPochhammerDissection` 0+2, `QPochhammerInfinite` 1+27,
...
> prime-power, total rational integer-index zero-row Wigner-square, and
> finite/infinite q-Pochhammer material.  These retained PDFs are historical
