...
> **Artifact status (2026-08-31; source newer than retained PDFs).**  The current
> sources document the 30-declaration closed-form Gaunt tranche:
> `LegendreGauntClosedForm.lean` (two definitions and twenty-five theorems) and
> `FabiusLegendreGauntClosedForm.lean` (three theorems).  No PDF was rebuilt for
> that source-only update.  The retained primary exposition (165 pages), Lean
> walkthrough (125), canonical frontier (236), Integration and Transform
> Frontiers (376), Representation Frontiers (301), and filed New Frontiers
> (41) PDFs all predate the tranche and are not synchronized with their current
> sources.  The primary PDF also predates the later prime-power-valuation
...
> and filed artifacts; that historical rendering check is not a claim of
> current source/PDF parity.  Rebuilds of all six named PDFs remain pending.
