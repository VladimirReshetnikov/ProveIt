...
> 944 source modules and 11,806 public declarations.  The documentation audit
...
> checkpoint.  The current `TransseriesDifferentialBlock` strengthening adds
> three theorems in place, while the new `TransseriesFlat` leaf contributes one
> definition and eleven theorems; together they add one module and fifteen
> declarations, giving the live 944/11,806 census.  The separate
