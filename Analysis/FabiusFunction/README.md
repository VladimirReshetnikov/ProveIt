...
> the facade union contains exactly 657 source modules and 8,756 public
...
> classical-limit, q-Taylor, q-partial-fraction, and integer-index APIs.  It
> additionally includes Heine transformation, q-Gauss summation, complex-order
> q-Pochhammer, infinite-product bounds, general basic hypergeometric series,
> q-multinomial polynomiality, generic Gaussian palindromicity, Jackson
> integration, both q-exponentials, theta quasi-periodicity, Jacobi's cubic
> identity, and parameter/order derivatives of the infinite q-Pochhammer
> symbol.  Pochhammer ownership remains `RvachevPochhammerFactorization` 1+10,
> `QPochhammerEntire` 0+5, and `QPochhammerInfinite` 1+29; `QMultinomial`
> remains 1+9.  The 649/8,698 checkpoint is therefore enlarged by exactly
> eight modules and 58 declarations.  The retained
