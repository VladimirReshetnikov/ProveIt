...
> union contains exactly 901 source modules and 11,419 public declarations.
> It finds no missing module headers and no public declarations without doc
> comments; the checked baseline records that zero-gap state.  Its q-series
> union retains `RvachevPochhammerFactorization` 1+10, including the unique
> unconditional `complexQPochhammerInf_eq_qPochhammerInfIn` public bridge;
