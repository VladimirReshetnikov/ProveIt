...
> 924 source modules and 11,614 public declarations.  The documentation audit
...
> leaf, the centered-MGF Laurent-leading theorem, finite-prefix Appell
> recovery, the closed up-tail and direct tail-moment theorems, and finite
> Rvachev--Legendre biorthogonality, are included in
...
> 923/11,610 checkpoint.  The two-theorem `ProbabilityLaplaceMoments` delta
> and `RvachevLegendreBiorthogonality` 1+1 give the live 924/11,614 census.
