...
| Pushforward laws of arbitrary norm-summable uniform-coordinate series | `FabiusFunction.WeightedUniformDistribution` | `weightedUniformDistribution`, `weightedUniformDistribution_split`, `weightedUniformDistribution_smul_weights`, `weightedUniformDistribution_reflection`, `weightedUniformDistribution_Icc`, `uniformProduct_map_head_tail_function` |
