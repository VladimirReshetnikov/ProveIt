...
> **Documentation artifact checkpoint (2026-08-31).**  The final merged sources
> were rebuilt in three strict serial pdfLaTeX passes for each changed
> publication root.  The primary exposition, canonical frontier, and filed New
> Frontiers PDFs are synchronized at 164, 236, and 41 A4 pages, respectively;
> every font is embedded and subset, and no Type 3 font remains.
