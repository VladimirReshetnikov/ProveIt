...
| Taylor--Volterra decomposition and polynomial commutators | `FabiusFunction.VolterraTaylor`, `FabiusFunction.VolterraPolynomial` | `eq_taylor_sum_add_volterraIntegral_of_iteratedDeriv`, `volterraIntegral_eq_of_iteratedDeriv`, `volterraIntegral_polynomial_smul_of_kernel_intervalIntegrable`, `volterraIntegral_polynomial_smul`, `volterraIntegral_pow_smul` |
| Exact signed and bounded Fabius primitive ladders | `FabiusFunction.FabiusPrimitives` | `extendedFabiusPrimitive_succ_hasDerivAt`, `iteratedDeriv_extendedFabiusPrimitive_of_le`, `volterraIntegral_extendedFabius_eq_extendedFabiusPrimitive`, `volterraIntegral_fabiusReal_eq_rescaled`; the signed formula is global, while the bounded formula assumes `x ≤ 1` |
| Polynomially weighted Fabius primitives | `FabiusFunction.FabiusPolynomialPrimitives` | `volterraIntegral_polynomial_mul_extendedFabius`, `volterraIntegral_pow_mul_extendedFabius`, `volterraIntegral_polynomial_mul_fabiusReal`, `volterraIntegral_pow_mul_fabiusReal`, `integral_cube_mul_fabiusReal_eq` |
