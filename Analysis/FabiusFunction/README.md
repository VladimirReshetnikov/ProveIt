...
| Two real Lambert inverses of scaled power--exponential saddles | `FabiusFunction.PowerExponentialLambert`, `FabiusFunction.PowerExponentialLambertFabius` | `powerExponentialSaddle`, `powerExponentialPeak`, `powerExponentialLambertArgument`, `principalPowerExponentialPhase`, `lowerPowerExponentialPhase`, `powerExponentialLambertArgument_mem_Icc`, `powerExponentialLambertArgument_mem_Ico`, `powerExponentialLambertArgument_mem_Ioo`, `principalPowerExponentialPhase_solves`, `lowerPowerExponentialPhase_solves`, `principalPowerExponentialPhase_zero`, `principalPowerExponentialPhase_peak`, `lowerPowerExponentialPhase_peak`, `lowerPowerExponentialPhase_rate_one`, `generalizedLambertCoordinate_solves_saddle_of_mem`, `lowerPowerExponentialPhase_one_one_log_two`; the solve laws assume a nonzero natural power and positive amplitude/rate, include the common peak endpoint, and impose no differentiability, asymptotic, or probabilistic hypotheses |
