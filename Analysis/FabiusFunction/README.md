...
> origin inventory has 11,457 declarations because it lacks this tree's unique
...
> `GaussianBinomialBounds` 0+6.  The geometric-interpolation union also includes
> `GeometricRichardsonGenerating` 3+7.
...
> forward q-monograph ledger is 165 Exact, 92 Partial, 17 None, and 8
...
> Filed New Frontiers, the notation catalogue, and the comb-interpolation PDF
> retain historical 41-, 88-, and 158-page receipts.  Checksum ledgers remain
...
| q-exponentials, Jackson integration, and theta quasi-periodicity | `FabiusFunction.QExponential`, `FabiusFunction.JacksonIntegral`, `FabiusFunction.ThetaQuasiPeriodicity` | Exhaustive module counts are 3+8, 1+7, and 1+6: five definitions and twenty-one theorems.  They give the two q-exponentials and their q-derivative laws; Jackson's fundamental theorem and integration by parts; and the bilateral-theta product, quasi-periodicity, and exact zero criterion.  The analytic statements retain their explicit strict-contraction, nonzero-variable, convergence, and nonvanishing hypotheses. |
| q-Pochhammer derivatives and Jacobi's cubic identity | `FabiusFunction.QPochhammerLogDerivative`, `FabiusFunction.QPochhammerOrderDerivative`, `FabiusFunction.JacobiCubic` | Exhaustive module counts are 0+10, 0+3, and 0+2: fifteen theorems and no definitions.  They give derivative and Lambert-series formulas for the infinite q-Pochhammer product on the unit disc; the complex-order derivative under a nonzero nome and `‖a*q^α‖ < 1`; and Jacobi's cubic identity for `‖q‖ < 1`. |
