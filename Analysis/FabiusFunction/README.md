...
> 932 source modules and 11,688 public declarations.  The documentation audit
...
> collapse, dyadic Fourier-boundary, Newman self-similarity, infinite central
...
> `TriangularPowerProduct` 0+2, `DyadicBoundaryIdentity` 0+2, and
> `MeanValueBracket` 0+6 leaves, the 1+12
> `ThueMorseNewmanSelfSimilarity` leaf, and a net twenty-nine further public
> declarations across existing modules.  The zero-definition/eight-theorem
> `FinitePrefixThueMorseCollapse` leaf completes the resulting live
> 932/11,688 census.  The
> separate incoming-branch inner/exterior checkpoints
