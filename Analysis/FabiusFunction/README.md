...
> 643 source modules and 8,661 public declarations, with no documentation
> gaps.  Its q-series union retains `QPochhammerEntire` 0+5,
...
> `GaussianBinomialContinuity` 0+3, `JacobiTripleProduct` 2+25,
> `QBinomialTheoremInfinite` 1+22, `QPascalSummation` 0+4,
> `QuantumBinomial` 0+2, and `RogersSzegoPolynomial` 1+9.  The retained
...
> finite/infinite q-Pochhammer material, as well as effective tolerant
> inversion and the computability of the total inverse.  These retained PDFs are historical
