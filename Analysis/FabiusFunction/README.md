...
> 629 source modules and 8,546 public declarations, with no documentation
> gaps.  Its q-series union retains the five-theorem fixed-nome
> `QPochhammerEntire` API, the `QPochhammerDissection` 0+2 and
> `QPochhammerInfinite` 1+27 surfaces, and the origin/main theorem inventories
...
> Frontiers, filed New Frontiers, notation catalogue, comb-interpolation, and
> q-series synthesis PDFs contain respectively 167, 126, 237, 301, 41, 88,
> 158, and 335 pages.  Their current TeX sources contain post-render unions,
> so those PDFs are historical validation receipts rather than source/PDF
> parity claims.  The Integration-and-Transform master retains a historical
> 377-page PDF.  Package-local notices record the remaining uninterrupted three-pass
> Libertinus rebuild debt.
