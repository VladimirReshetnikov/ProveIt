...
$$
\sum_{t=1}^{q} \sum_{h \in T}\left\{\left|C_{t}(h)\right|:\left|C_{t}(h)\right| \geqslant \sigma|J| / q\right\} \geqslant(1-\sigma)|S| .
$$
...
Corollary 16.11. If $f: \mathbb{Z}_{N} \rightarrow D$ fails to be $\alpha$-uniform of degree $k+1$, set
