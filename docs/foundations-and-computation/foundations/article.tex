...
name. The preserved files in this report's \path{sources/}, \path{code/}, and
\path{data/} directories remain the historical originals.
...
package was unpacked. The README ships verbatim and therefore still refers to
it. Nothing was dropped in transit, and the README does not overstate its
archive's contents. M2's README also gives clone/checkout/build/run commands for
...
in this repository's \texttt{sources/} directory as
...
is the only audit that hashed its own outputs.
...
the collection's scope. The verbatim README was left unaltered rather than
edited to match.
...
are identified in the report's README; the archived sources remain unchanged.
