...
The autonomous pass now covers the normalized-derivation foundations, the full local curve-realization classification, uniform finite-scale localization and derivation independence (Sections 29–31). Real branch counts and worked equations from Section 32 onward, later autonomous arguments and the remaining imports still require review.
