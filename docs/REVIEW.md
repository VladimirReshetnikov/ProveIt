...
begun with Sections 35–36; Sections 37–42 remain pending.
...
The autonomous pass now covers the normalized-derivation foundations, curve-realization classification, finite-scale localization, derivation independence and worked equations (Sections 29–32), plus the holomorphic-differential and hyperelliptic obstructions (Section 33.1). The formal-group and abelian proofs of Sections 33.2–33.4 are now also reviewed, including the speed threshold for every normalized derivation. Section 34's scope, input contracts and formalization comparisons have now also been reviewed, completing the Part VI main-text pass. The critical-potential review now covers Sections 35–36, including its imported tower formulas and fundamental-pair argument. Sections 37–42 and the remaining imports and source reconciliation still require review.
...
critical-potential Sections 37–42, remaining imports and source reconciliation are
still separate.
