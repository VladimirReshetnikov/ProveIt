...
The Diophantine report written in `bbdd536` integrates sources 01, 02 and 05
and has a compiled PDF; its 67 standard statements and one cited theorem
are indexed in the formalization ledger. The quotient report still has its
base text. Further manuscripts placed in `cf350b1` extend these reports and
[entire functions](surcomplex/entire-functions-at-arbitrary-rank/); integration
and source reconciliation remain pending. All new mathematics remains
pending in Lean, and source writing does not imply proof review.
...
| [Omnific Diophantine geometry](surreal/omnific-diophantine-geometry/) | Arithmetic and Diophantine equations over the omnific integers; constant-term transfer, rigidity and definability; sources 01, 02 and 05 integrated, further additions pending |
