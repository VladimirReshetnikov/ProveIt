...
are also constructed. Finite-variable evaluation, differentiation, recentered
...
workspace evaluation. Univariate formal substitution is proved; the remaining
finite-variable and analytic lifting APIs are still to be built.
