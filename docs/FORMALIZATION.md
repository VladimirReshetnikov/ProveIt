...
| Parts of `polynomial:thm:fta`, `polynomial:eq:factorization`, `polynomial:eq:logderivative` | `Surreal.FinitePolynomial.exists_root`, `factorization`, `roots_card`, `logarithmic_derivative` in [Polynomial.lean](../Surreal/Algebra/Polynomial.lean) | Root existence, factorization, total multiplicity and logarithmic derivative over any algebraically closed field. The derivative clauses are mapped separately below. Division, gcd/Bezout, principal ideals, squarefreeness and workspace clauses remain pending. **Prerequisites proved**; build and axiom audit pass. |
