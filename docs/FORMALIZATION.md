...
valuation, leading coefficient and positivity. Real closedness and the
infinite Hahn normal-form bridge remain separate obligations.
...
5. **Universe-indexed surreal construction and bridge (Layer D, independent
   ...
   verified upstream small-support APIs and the next construction: simplest
   common points of compatible small valuation balls. Approximation alone
   does not give uniqueness or arithmetic compatibility.
