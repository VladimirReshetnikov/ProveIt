...
for the binary inverse. The next foundational steps are to package the
scaled monic depressed polynomial and its ordinary-real reduction, then
construct the support-controlled coprime factor lift and strongly summable
evaluation inside the sign field. No infinite lift or odd-degree-root
existence follows from the finite correction isomorphism alone.
