...
The expanded `thm:exact` requires preservation of every source-summable
family and the stated uniqueness among strongly additive maps; these remain
**pending**. The existence criterion, nonzero-input injectivity and formal-order
valuation are proved above. The current evaluation and composition laws do
not yet cover that whole statement. The new simple
