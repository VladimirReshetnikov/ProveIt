...
recovered there by formal evaluation rather than by a norm. A second proof
in that report (\texttt{tate:node:thm:main}) uses no real-valued coarsening
at all: it inverts the parametrization by integral formal charts over any
coefficient field of characteristic zero. It cites
...
summability domains, integral node charts, surcomplex elliptic curves,
torsion ramification, and multiscale theta series},
