...
This report is the union of six manuscripts. Two were written
...
the prime ideals above a product with one simple node per shell. The
arbitrary-rank
...
several-variable replacement, and the analytic prime fibres with their
splitting under cofinal extension are proposed original contributions, not a
...
limitation recorded by any of the six source manuscripts is preserved
there.
...
Six manuscripts are merged here, and four of them arrived with letters
...
element of $\Gamma$. Every statement taken from the third, fourth, fifth or
sixth manuscript has been rewritten in the convention below; the tables are
...
letters are translated by the last table of \cref{ent:subsec:notation}. In
...
This report is a merge of six manuscripts, each prepared against a pinned
...
an independent build. None of the six manuscripts was independently
...
finite sanity checks, with no peer review or Lean verification claimed.
...
See \cref{ent:app:checks} for the full statement. In summary: the six
delivered suites verify $831$, $664$, $1958$, $1876$, $1072$ and $10889$
finite exact assertions respectively, and they prove \emph{no} infinite
theorem. The first
...
construction, certify entireness from finite data or certify novelty.
...
Six independent exact-arithmetic suites accompany this report, one from
each source manuscript, preserved unmodified in \texttt{code/} and
\texttt{data/} under the file names given below. All six use only the
...
All six suites print their own scope disclaimers, and all six are correct
to do so.
...
The first two of this report's six source manuscripts are both dated
