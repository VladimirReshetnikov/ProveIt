...
This report is the union of seven manuscripts. Two were written
...
splitting under cofinal extension, and the rectification dichotomy with its
reduction obstruction and fat-point ideals are proposed original
contributions, not a
...
The closing subsections of \cref{ent:sec:multivariable}, the seventh
source's, answer part of two further clauses of \cref{ent:q:several}, for
...
seventh source's also in \cref{ent:rc:subsec:limits}; every limitation
recorded by any of the seven source manuscripts is preserved there.
...
Seven manuscripts are merged here, and five of them arrived with letters
...
sixth or seventh manuscript has been rewritten in the convention below; the tables are
...
This report is a merge of seven manuscripts, each prepared against a pinned
...
the other sections is transferred to it. Its closing subsections
...
uncountability of $\kk$ once, and use no algebraic closedness.
...
theory. The seventh source's closing subsections of that section add,
...
positive-dimensional divisor theory and no GCD theory. The arbitrary-rank
...
an independent build. None of the seven manuscripts was independently
...
symbolic checks without an aggregate count, and they prove \emph{no} infinite
theorem. The first
...
\emph{Re-scoped by the seventh source:} the closing subsections of
...
Seven independent exact-arithmetic suites accompany this report, one from
...
arithmetic and no floating point; the seventh uses exact rational arithmetic
in SymPy. The first four represent group elements as
...
All seven suites print or record their own scope disclaimers, and all seven
...
The first two of this report's seven source manuscripts are both dated
...
to choose: the material was placed as the closing subsections of
