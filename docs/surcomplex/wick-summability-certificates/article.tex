...
accessible. \Cref{wick:sec:provenance} gives the exact novelty and verification
boundaries. Finite computations are checks, not substitutes for the proofs.
This single-source report keeps the manuscript's repository statements at
that pin; corrections for the present tree and the relation to the physics
report are in \Cref{wick:sub:reposcope,wick:sub:physics,wick:sub:collection}.
\end{minipage}
\end{titlepage}
...
The quartic model \eqref{wick:eq:quartic} and the mixed obstruction
\eqref{wick:eq:mixedmodel} satisfy this sign-coherent hypothesis. Their domains
...
table and limitation above is that manuscript's. Its repository audit is
...
No mathematical statement, proof, example or stated limitation was altered,
