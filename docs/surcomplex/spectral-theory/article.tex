...
it --- all of which
can be carried out in the divisible hull $\Gamma\otimes_\Z\Q$.
\Cref{spec:thm:ramification} computes the exact extension for principal roots
of positive semidefinite matrices; it does not compute a Schur splitting field
for an arbitrary matrix. The pseudospectrum below is a set of scalars
...
splitting tree; and finally the normal-form embeddings. This is a dependency
