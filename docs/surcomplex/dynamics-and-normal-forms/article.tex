...
The seven source manuscripts preserved in \texttt{sources/} were all
...
many Taylor monomials and finitely many decompositions involving
$\supp f$, and every resulting coefficient is a finite sum of products of
derivatives of functions in $\strip$, hence lies in $\strip$. For the
