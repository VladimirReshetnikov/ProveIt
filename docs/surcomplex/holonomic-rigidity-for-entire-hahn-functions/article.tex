...
The main differential and dilation classifications and the new torsion
argument remain unformalized. The variable derivative is not the
...
The build and axiom audit cover only imported declarations recorded in the
ledger. The Python checks are finite checks of formulas and examples; they
...
formal exponential domain have Lean coverage; the main classifications
remain unformalized.\\
\bottomrule
\end{longtable}
...
Section~\ref{hol:sec:certificates} and the formalization ledger.
