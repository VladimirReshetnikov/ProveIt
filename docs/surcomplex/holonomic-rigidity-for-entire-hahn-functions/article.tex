...
The full classifications and the nonlinear and coefficient-field theorem
packages remain pending. The variable derivative is not the
...
and the coefficient-field theorem package in
...
for nondegenerate exponential polynomials. The build and axiom audit cover
...
prove no infinite theorem. The full classifications and the nonlinear and coefficient-field theorem
packages remain without Lean verification or independent refereeing.
