...
order unit, and no general mixed-jet independence theorem is claimed when
...
nonlinear rigidity results cover order one, the nondegenerate higher-order
...
Theorem~\ref{hol:cf:thm:rankone}. The nonlinear part keeps the non-claims of
Section~\ref{hol:nl:sub:nonclaims}, while the
