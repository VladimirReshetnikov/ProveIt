...
No classification of isomorphism classes is offered; only triviality is
decided. \Cref{nab:prop:torsor} describes all solutions once a splitting
exists, not the nonsplit objects.
...
September 21, 2026, both delivered with their own code and recorded output, and
both preserved unchanged in \texttt{sources/}, \texttt{code/} and
\texttt{data/} of this directory:
...
\texttt{sources/08-polar-support-matrix-cousin.tex} with its README. It
...
\nolinkurl{sources/09-support-monodromy-realization.tex} with its README and
its
