...
Every label in `article.tex` carries the prefix `gz:` (222 labels). The
formalization ledger and neighboring report READMEs use these labels.
The code and data files are
