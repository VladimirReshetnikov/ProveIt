...
existing generic Lean results already cover the ordered displacement and
value-fixing exponential rigidity implications
...
These generic results already cover the corresponding finite arguments
here; their mappings use the rigidity report's labels. No dedicated
...
are supplied. Existing generic Lean proofs cover the ordered displacement
and value-fixing exponential rigidity implications, as recorded in
