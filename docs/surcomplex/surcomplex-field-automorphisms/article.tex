...
\hypersetup{colorlinks=true,linkcolor=link,citecolor=link,urlcolor=link,
 ...
 pdfsubject={Real forms, Hahn symmetries, valuation, topology, exponential rigidity, and finite symmetry descent}}
...
\centering
\vspace*{0.1cm}
{\large\scshape Two-source research report\par}
\vspace{0.5cm}
...
\vspace{0.1cm}
{\small Manuscript~07 of batch~20 (pin \texttt{dcf8666}) and manuscript~02 of
batch~32 (pin \texttt{343dc2c})\par}
\vspace{0.4cm}
...
separately in Section~\ref{saut:fs:sec:nonclaims}.
...
without destroying the support ring.
...
supports and of the original automorphisms.
...
(Appendix~\ref{saut:app:source02}); this subsection and
