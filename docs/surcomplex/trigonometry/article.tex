...
A last section treats the rotation group $\SO(2,\No)$ and its algebraic, fine, standard-part and
semialgebraic geometries.
\end{abstract}
\end{minipage}
\vfill
\begin{minipage}{0.94\textwidth}\small
\textbf{Status and provenance.} This is one merged report assembled from four independently
...
\emph{The four component manuscripts.} The report itself is built from four manuscripts, numbered
locally 16--19; the numbers prefix their code and data files. Sources 16, 17 and 18 --- \emph{Finite
...
shares with sources 16--18, each printed once with both credited.
...
\cref{trigonometry:rot:sec:overlap}.
...
\item \emph{(\cref{trigonometry:rot:sec:main}, source 19.)} The following non-claims are source 19's,
 ...
 \item Source 19 claims no novel construction of global surreal sine, no resolution of an
  Ehrlich--Kaplan robustness question, no classification of all abstract automorphisms, no Haar or
