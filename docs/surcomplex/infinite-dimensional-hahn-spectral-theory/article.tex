...
the compact half of the third. Trace-class theory and a classical
Hilbert-space spectral-measure theory are not developed; Part II supplies
an algebraic projection calculus with vectorwise Hahn additivity.
...
Part II supplies a vectorwise Hahn-additive projection calculus, not a
general topologically countably additive spectral-measure theorem; the
