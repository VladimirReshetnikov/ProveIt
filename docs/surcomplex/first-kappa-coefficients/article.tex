...
(3) The involutions $\tau_\kappa$ are pure-field involutions, not claimed to preserve the valuation, the Gaussian omnific integers or Hahn sums (non-claim N18). The batch-32 addition to the automorphism report classifies instead the strong valued involutions preserving $\Oz[i]$; its fixed fields are full Hahn fields over real closed coefficient fields. The two families are complementary, and neither result implies the other.
\end{remark}
