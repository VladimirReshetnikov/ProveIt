...
\hypersetup{%
  ...
  pdfsubject={Catalogue of 111 independent mathematical research packages}}
...
\begin{center}
  ...
  {\large One hundred and eleven independent mathematical research packages,\\
...
This document catalogues the one hundred and eleven research packages stored
...
\dir{generating-functions-and-asymptotics}
                                  ...
                                  & \dir{oeis-sequence-asymptotics}     & 7\\
                                  & (top level)                         & 4\\
\midrule
\multicolumn{2}{l}{\textbf{Total}} & \textbf{103}\\
\bottomrule
\end{tabular}
\end{center}
...
{surreal-numbers/surcomplex-analysis}
