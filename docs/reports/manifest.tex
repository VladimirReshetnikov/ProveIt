...
\hypersetup{%
  ...
  pdfsubject={Catalogue of 87 independent mathematical research packages}}
...
\begin{center}
  ...
  {\large Eighty-seven independent mathematical research packages,\\
...
This document catalogues the eighty-seven research packages stored under
\dir{docs/reports}.  They arrived as one hundred and seven ZIP archives, in six
deliveries, which have been unpacked and grouped into the subject hierarchy
described in Section~\ref{sec:tree}.  The archives themselves are no longer
kept in the repository.

One hundred and seven archives yield eighty-seven reports because twenty of
them duplicated another: sixteen pairs, three three-way clusters and one
four-way cluster.  Each pair has been merged into one report that proves the
...
\midrule
\dir{automata-and-formal-languages} & ---                               & 5\\
\midrule
...
\midrule
\dir{log-concavity-and-unimodality}     & ---                           & 10\\
\midrule
\dir{graph-theory}                      & ---                           & 3\\
\midrule
\dir{enumerative-combinatorics}         & ---                           & 15\\
\midrule
\dir{generating-functions-and-asymptotics}
                                  & \dir{binary-product-coefficient-counts} & 3\\
                                  & (top level)                         & 3\\
\midrule
\multicolumn{2}{l}{\textbf{Total}} & \textbf{87}\\
\bottomrule
\end{tabular}
\end{center}
