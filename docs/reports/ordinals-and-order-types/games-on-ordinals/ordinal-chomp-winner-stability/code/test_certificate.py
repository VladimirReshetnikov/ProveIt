#!/usr/bin/env python3
"""Regression tests.  Run from any directory with Python 3.9 or later."""
import copy
...
from make_certificate import generate, mex
from verify_certificate import check_certificate
...
class CertificateTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.certificate = json.loads((ROOT/"data"/"certificate.json").read_text())

    def test_regeneration(self):
        self.assertEqual(generate(), self.certificate)

    def test_independent_verification(self):
        self.assertTrue(check_certificate(ROOT/"data"/"certificate.json")["verified"])
