...
\hypersetup{pdftitle={Large cardinals at the inconsistency frontier: synthesis of the continuation reports},pdfauthor={Prepared for Vladimir Reshetnikov},pdfsubject={Deduplicated results of twenty-seven research continuations on cover-exacting, exacting and ultraexacting cardinals},pdfkeywords={large cardinals, cover exacting, ultraexacting, HCD, strongly compact, Ground Axiom, I0, I3}}
\urlstyle{same}
...
\vspace{10pt}
{\fontsize{14}{18}\selectfont Deduplicated results of the twenty-seven continuation reports on\\ cover-exacting, exacting, and ultraexacting cardinals\par}
\vspace{14pt}
...
So randomized selection is excluded exactly at countable additivity: between the $\{0,1\}$-valued and the countably additive there is a definable finitely additive kernel, and every plateau value in $[0,1]$ occurs for suitable mixtures \R{21}. Whether a countably infinite definable family of ultrafilter-valued kernels can exist is open.
