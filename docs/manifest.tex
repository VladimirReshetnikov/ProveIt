...
\hypersetup{%
  ...
  pdfsubject={Catalogue of fifteen research packages on surreal and surcomplex numbers}}
...
\begin{center}
 ...
 {\large Fifteen independent mathematical research packages,\\
...
This document catalogues the fifteen research packages stored under
...
closure $\SC$ and the theory of holomorphic functions over it.  The last two,
