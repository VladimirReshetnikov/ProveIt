...
Conversely use \eqref{markov:eq:simple-inverse} for the weighted partition projections.
...
\eqref{markov:eq:inverse-signs} then makes every off-diagonal entry strictly negative.
\end{proof}
