...
The arguments are mathematical proofs, not Lean-checked proofs. Like every report
in this collection, it is an AI-assisted research draft; it has not been
refereed. It is built from a single manuscript;
...
are the distinct nonzero eigenvalue valuations. It does not bound the path-event
...
(Section~\ref{markov:sec:comparison}). The proofs are not Lean-checked and have
not been refereed. The three further questions of
...
scales with the nonzero eigenvalue valuations. The direct proof given here is
...
\end{enumerate}
The mathematics of the manuscript is unchanged. The source archive, its PDF and
...
\item The surreal transfer above takes the rational span of finitely many
normal-form exponents, which is a divisible subgroup of $\No$.
\end{enumerate}
