...
depends on this one. The comparisons below were added during editorial
assembly at \texttt{ed88b8f}; theorem numbers of other reports are those
of their PDFs committed there.
...
\end{enumerate}
These changes left the mathematics unchanged.
...
compared during editorial assembly at commit \texttt{ed88b8f}.
\repo.
...
was compared during editorial assembly at commit \texttt{ed88b8f}.
\repo.
\end{thebibliography}
\end{document}
