...
Every theorem, proof, example and disclaimer of the manuscript is kept. The
manuscript continues the measures report but answers no question it names, so
...
\eqref{fsp:eq:cs}. The pointwise inequality
$a\ind_{\{X\ge a\}}\le X$ proves \eqref{fsp:eq:markov}.
