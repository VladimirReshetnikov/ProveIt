...
the real-fixing case of that classification. The bounded-support report is
unchanged since the pin. The attribution to L'Innocente--Mantova was checked
...
one-witness case. That report is unchanged since the pin.
\begin{enumerate}[leftmargin=*,itemsep=3pt]
...
constant coefficient restricted to $D_k$.
