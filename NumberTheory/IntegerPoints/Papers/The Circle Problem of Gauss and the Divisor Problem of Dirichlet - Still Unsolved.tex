...
% ed.: the printed article has n=0 in the Bessel series below, although x/n is present;
...
% ed.: the standard phase in the Y_nu asymptotic is x-pi*nu/2-pi/4;
...
% ed.: as in (2.5), the printed lower limit n=0 is incompatible with the factor x/n; corrected to n=1.
$$
...
% ed.: in the printed last line of (6.2), a primed d-sum with floor(x/d)
