...
integral in (3.2.6) as $T_1+\frac1{2\pi}T_2$, where $T_1$ arises from the
first term in braces and $T_2$ from the second.
...
integer $k$. Therefore, we may normalize to the case $H_1<0<H_2$.
...
$yN^{-s}\geq1$. For if $yN^{-s}<1/2$, then Theorem 2.1 yields
\[
