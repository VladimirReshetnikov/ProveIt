...
\section{Surcomplex automorphisms and logarithmic modulus}\label{sec:surcomplex}
...
results of \cref{sec:surcomplex} additionally assume that $F$ is real closed,
as stated there; the other value-action theorems need no such assumption.
