...
The two-exponent case, for finite Hermitian matrix measures on any measurable space, is \texttt{hnd:thm:measure} of \repo{surcomplex/hidden-negative-hermitian-directions}; the case of more exponents remains open there (\texttt{hnd:q:morescales}).
