import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term112Data
...
theorem table0_term112_certificate :
    SparseTerm.substitute ⟨-99, ⟨0, 5, 0, 1, 2⟩⟩ elementaryPolynomials = table0Term112Normal := by
  decide
