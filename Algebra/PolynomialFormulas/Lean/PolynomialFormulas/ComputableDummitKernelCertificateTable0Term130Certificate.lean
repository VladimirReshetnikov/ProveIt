import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term130Data
...
theorem table0_term130_certificate :
    SparseTerm.substitute ⟨-2000, ⟨0, 1, 0, 3, 2⟩⟩ elementaryPolynomials = table0Term130Normal := by
  decide
