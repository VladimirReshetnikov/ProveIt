import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term91Data
...
theorem table0_term91_certificate :
    SparseTerm.substitute ⟨525, ⟨1, 2, 3, 0, 2⟩⟩ elementaryPolynomials = table0Term91Normal := by
  decide
