import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term77Data
...
theorem table0_term77_certificate :
    SparseTerm.substitute ⟨375, ⟨2, 0, 4, 0, 2⟩⟩ elementaryPolynomials = table0Term77Normal := by
  decide
