import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term90State0Data
...
theorem table0_term90_state0_certificate :
    SparsePolynomial.const (1) = table0Term90State0Normal := by
  decide
