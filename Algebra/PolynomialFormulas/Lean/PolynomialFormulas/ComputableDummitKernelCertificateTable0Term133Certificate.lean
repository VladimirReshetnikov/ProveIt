import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term133Data
...
theorem table0_term133_certificate :
    SparseTerm.substitute ⟨17, ⟨0, 0, 4, 3, 0⟩⟩ elementaryPolynomials = table0Term133Normal := by
  decide
