...
/- Closed executable coefficient equality for source rows `94, 95`. -/
set_option maxRecDepth 200000 in
set_option maxHeartbeats 40000000 in
theorem degreeSevenProductRow_eq_productCoefficient_rows_94_96 :
    ∀ i : Fin 159, 94 ≤ i.1 ∧ i.1 < 96 → ∀ j : Fin 132,
