...
/- Closed executable coefficient equality for source rows `84, 85`. -/
set_option maxRecDepth 200000 in
set_option maxHeartbeats 40000000 in
theorem degreeSevenProductRow_eq_productCoefficient_rows_84_86 :
    ∀ i : Fin 159, 84 ≤ i.1 ∧ i.1 < 86 → ∀ j : Fin 132,
