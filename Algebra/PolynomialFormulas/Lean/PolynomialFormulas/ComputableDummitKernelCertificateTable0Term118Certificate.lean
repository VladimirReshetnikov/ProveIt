import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term118Data
...
theorem table0_term118_certificate :
    SparseTerm.substitute ⟨1200, ⟨0, 3, 0, 2, 2⟩⟩ elementaryPolynomials = table0Term118Normal := by
  decide
