import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term68Data
...
theorem table0_term68_certificate :
    SparseTerm.substitute ⟨19, ⟨2, 2, 2, 3, 0⟩⟩ elementaryPolynomials = table0Term68Normal := by
  decide
