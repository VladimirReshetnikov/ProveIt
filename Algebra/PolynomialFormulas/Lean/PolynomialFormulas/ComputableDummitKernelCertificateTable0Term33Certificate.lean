import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term33Data
...
theorem table0_term33_certificate :
    SparseTerm.substitute ⟨-200, ⟨4, 1, 1, 0, 3⟩⟩ elementaryPolynomials = table0Term33Normal := by
  decide
