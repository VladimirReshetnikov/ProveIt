...
/- Closed executable coefficient equality for source rows `112, 113`. -/
set_option maxRecDepth 200000 in
set_option maxHeartbeats 40000000 in
theorem degreeSevenProductRow_eq_productCoefficient_rows_112_114 :
    ∀ i : Fin 159, 112 ≤ i.1 ∧ i.1 < 114 → ∀ j : Fin 132,
