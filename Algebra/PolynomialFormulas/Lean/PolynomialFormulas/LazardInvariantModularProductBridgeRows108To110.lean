...
/- Closed executable coefficient equality for source rows `108, 109`. -/
set_option maxRecDepth 200000 in
set_option maxHeartbeats 40000000 in
theorem degreeSevenProductRow_eq_productCoefficient_rows_108_110 :
    ∀ i : Fin 159, 108 ≤ i.1 ∧ i.1 < 110 → ∀ j : Fin 132,
