import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term83Data
...
theorem table0_term83_certificate :
    SparseTerm.substitute ⟨-78, ⟨1, 5, 0, 2, 1⟩⟩ elementaryPolynomials = table0Term83Normal := by
  decide
