...
/- Closed executable coefficient equality for source rows `116, 117`. -/
set_option maxRecDepth 200000 in
set_option maxHeartbeats 40000000 in
theorem degreeSevenProductRow_eq_productCoefficient_rows_116_118 :
    ∀ i : Fin 159, 116 ≤ i.1 ∧ i.1 < 118 → ∀ j : Fin 132,
