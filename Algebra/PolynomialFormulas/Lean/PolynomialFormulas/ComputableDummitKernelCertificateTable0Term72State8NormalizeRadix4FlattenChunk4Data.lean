...
def table0Term72State8NormalizeRadix4Bucket4Normal : SparsePolynomial := [
  ⟨5, ⟨1, 1, 6, 8, 4⟩⟩,
  ⟨10, ⟨1, 1, 7, 7, 4⟩⟩,
  ⟨5, ⟨1, 1, 8, 6, 4⟩⟩,
  ⟨45, ⟨1, 2, 5, 8, 4⟩⟩,
...
def table0Term72State8NormalizeRadix4FlattenChunk4BucketsNormal : List SparsePolynomial :=
  [table0Term72State8NormalizeRadix4Bucket4Normal]

def table0Term72State8NormalizeRadix4FlattenChunk4Normal : SparsePolynomial :=
  table0Term72State8NormalizeRadix4Bucket4Normal
