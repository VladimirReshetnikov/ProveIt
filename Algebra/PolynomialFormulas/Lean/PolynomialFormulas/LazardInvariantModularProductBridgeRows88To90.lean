...
/- Closed executable coefficient equality for source rows `88, 89`. -/
set_option maxRecDepth 200000 in
set_option maxHeartbeats 40000000 in
theorem degreeSevenProductRow_eq_productCoefficient_rows_88_90 :
    ∀ i : Fin 159, 88 ≤ i.1 ∧ i.1 < 90 → ∀ j : Fin 132,
