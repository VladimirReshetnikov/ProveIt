import PolynomialFormulas.ComputableDummitKernelCertificateTable0Term72State0Data
...
theorem table0_term72_state0_certificate :
    SparsePolynomial.const (5) = table0Term72State0Normal := by
  decide
