...
(** Degree-1 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient1.
...
Section Coefficient1.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_1_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_1_field :
...
Theorem lazard_detcritical_coefficient_1 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 1 =
    coef (D.lazard_detcritical_target_polynomial c) 1.
Proof.
...
lazard_detcritical_expand_coefficients.
  rewrite /D.lazard_detcritical_A00 /D.lazard_detcritical_A01 /D.lazard_detcritical_A10
    /D.lazard_detcritical_A11 /D.lazard_detcritical_A20 /D.lazard_detcritical_A30
    /D.lazard_detcritical_B00 /D.lazard_detcritical_B01 /D.lazard_detcritical_B10
    /D.lazard_detcritical_B11 /D.lazard_detcritical_B20 /D.lazard_detcritical_B21
    /DM.lazard_det_certificate_N0 /DM.lazard_det_certificate_N1.
finish_lazard_detcritical_coefficient_field.
Qed.

End Coefficient1.

Print Assumptions lazard_detcritical_coefficient_1.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient1.
