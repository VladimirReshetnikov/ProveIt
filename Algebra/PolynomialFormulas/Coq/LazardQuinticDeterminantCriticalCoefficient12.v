...
(** Degree-12 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient12.
...
Section Coefficient12.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_12_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_12_field :
...
Theorem lazard_detcritical_coefficient_12 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 12 =
    coef (D.lazard_detcritical_target_polynomial c) 12.
Proof.
...
lazard_detcritical_expand_coefficients.
  rewrite /D.lazard_detcritical_A30 /D.lazard_detcritical_B04
...
Print Assumptions lazard_detcritical_coefficient_12.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient12.
