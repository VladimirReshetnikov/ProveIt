...
(** Degree-0 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient0.
...
Section Coefficient0.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_0_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_0_field :
...
Theorem lazard_detcritical_coefficient_0 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 0 =
    coef (D.lazard_detcritical_target_polynomial c) 0.
Proof.
...
lazard_detcritical_expand_coefficients.
  rewrite /D.lazard_detcritical_A00 /D.lazard_detcritical_A10 /D.lazard_detcritical_A20
    /D.lazard_detcritical_A30 /D.lazard_detcritical_B00 /D.lazard_detcritical_B10
    /D.lazard_detcritical_B20 /DM.lazard_det_certificate_N0.
finish_lazard_detcritical_coefficient_field.
Qed.

End Coefficient0.

Print Assumptions lazard_detcritical_coefficient_0.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient0.
