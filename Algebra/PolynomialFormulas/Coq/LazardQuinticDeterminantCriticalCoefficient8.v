...
(** Degree-8 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient8.
...
Section Coefficient8.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_8_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_8_field :
...
Theorem lazard_detcritical_coefficient_8 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 8 =
    coef (D.lazard_detcritical_target_polynomial c) 8.
Proof.
...
lazard_detcritical_expand_coefficients.
  rewrite /D.lazard_detcritical_A00 /D.lazard_detcritical_A01 /D.lazard_detcritical_A02
    ...
    /DM.lazard_det_certificate_N2 /DM.lazard_det_certificate_N4
...
Print Assumptions lazard_detcritical_coefficient_8.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient8.
