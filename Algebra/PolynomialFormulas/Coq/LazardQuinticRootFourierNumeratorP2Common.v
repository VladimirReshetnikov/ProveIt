...
(** Cyclic-algebra presentation of the cleared P2 numerator. *)
Module PolynomialFormulasLazardQuinticRootFourierNumeratorP2Common.
...
Section RootFourierNumeratorP2Common.
Variable F : fieldType.

Add Ring lazard_root_fourier_numerator_P2_common_ring :
...
Ltac finish_lazard_root_fourier_numerator_P2_common_ring :=
  repeat first
...
Definition lazard_cyclic_p2_numerator_difference (roots : 5.-tuple F) :
    LazardCyclicFive F :=
  lazard_cyclic_sub (lazard_cyclic_p2_numerator_left roots)
    (lazard_cyclic_p2_numerator_right roots).

Lemma lazard_cyclic_p2_numerator_difference_eval omega roots
    (omega_primitive : 5.-primitive_root omega) :
  lazard_cyclic_eval omega
      (lazard_cyclic_p2_numerator_difference roots) =
...
Proof.
rewrite /lazard_cyclic_p2_numerator_difference
  /lazard_cyclic_p2_numerator_left /lazard_cyclic_p2_numerator_right.
repeat first
  ...
  | rewrite lazard_cyclic_fourier_P2_eval
...
finish_lazard_root_fourier_numerator_P2_common_ring.
Qed.

End RootFourierNumeratorP2Common.
End PolynomialFormulasLazardQuinticRootFourierNumeratorP2Common.
