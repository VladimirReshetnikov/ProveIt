...
Module PolynomialFormulasLazardQuinticRootInvariantRelationsProductI5.
...
Add Ring lazard_root_invariant_relations_product_i5_ring :
...
Theorem lazard_root_invariant_product_i5
    (roots : 5.-tuple F) (hsum : RP.lazard_root_esymm1 roots = 0) :
  RP.lazard_root_i4 (RP.lazard_root_invariants roots) *
      RP.lazard_root_i5 (RP.lazard_root_invariants roots) =
    PC.lazard_i4_mul_i5_rhs (RP.lazard_depressed_of_roots roots)
      (RP.lazard_root_invariants roots).
Proof.
have hx4 := RP.lazard_root_sum_zero_last hsum.
rewrite /PC.lazard_i4_mul_i5_rhs /RP.lazard_depressed_of_roots
...
finish_product_i5_ring.
Qed.

End ProductI5.

End PolynomialFormulasLazardQuinticRootInvariantRelationsProductI5.
