...
(** Degree-10 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient10.
...
Section Coefficient10.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_10_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_10_field :
...
Theorem lazard_detcritical_coefficient_10 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 10 =
    coef (D.lazard_detcritical_target_polynomial c) 10.
Proof.
...
Print Assumptions lazard_detcritical_coefficient_10.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient10.
