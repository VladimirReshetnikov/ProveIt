...
(** Degree-5 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient5.
...
Section Coefficient5.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_5_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_5_field :
...
Theorem lazard_detcritical_coefficient_5 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 5 =
    coef (D.lazard_detcritical_target_polynomial c) 5.
Proof.
...
Print Assumptions lazard_detcritical_coefficient_5.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient5.
