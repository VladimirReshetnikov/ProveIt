...
(** Degree-3 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient3.
...
Section Coefficient3.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_3_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_3_field :
...
Theorem lazard_detcritical_coefficient_3 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 3 =
    coef (D.lazard_detcritical_target_polynomial c) 3.
Proof.
...
lazard_detcritical_expand_coefficients.
  rewrite /D.lazard_detcritical_A00 /D.lazard_detcritical_A01 /D.lazard_detcritical_A02
    ...
    /D.lazard_detcritical_B02 /D.lazard_detcritical_B03 /D.lazard_detcritical_B10
    /D.lazard_detcritical_B11 /D.lazard_detcritical_B12 /D.lazard_detcritical_B20
    /D.lazard_detcritical_B21 /D.lazard_detcritical_B22 /DM.lazard_det_certificate_N0
    /DM.lazard_det_certificate_N1 /DM.lazard_det_certificate_N2
    /DM.lazard_det_certificate_N3.
finish_lazard_detcritical_coefficient_field.
Qed.

End Coefficient3.

Print Assumptions lazard_detcritical_coefficient_3.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient3.
