...
(** Degree-4 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient4.
...
Section Coefficient4.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_4_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_4_field :
...
Theorem lazard_detcritical_coefficient_4 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 4 =
    coef (D.lazard_detcritical_target_polynomial c) 4.
Proof.
...
lazard_detcritical_expand_coefficients.
  rewrite /D.lazard_detcritical_A00 /D.lazard_detcritical_A01 /D.lazard_detcritical_A02
    ...
    /DM.lazard_det_certificate_N2 /DM.lazard_det_certificate_N3
    /DM.lazard_det_certificate_N4.
finish_lazard_detcritical_coefficient_field.
Qed.

End Coefficient4.

Print Assumptions lazard_detcritical_coefficient_4.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient4.
