...
(** Degree-2 shard of the polynomial-in-s determinant certificate. *)
Module PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient2.
...
Section Coefficient2.

Variable F : fieldType.

Add Ring lazard_detcritical_coefficient_2_ring :
  (@NR.lazard_numerator_ring_theory F).
Add Field lazard_detcritical_coefficient_2_field :
...
Theorem lazard_detcritical_coefficient_2 c
    (two_neq0 : (2%:R : F) != 0)
    (five_neq0 : (5%:R : F) != 0) :
  coef (D.lazard_detcritical_V_polynomial c) 2 =
    coef (D.lazard_detcritical_target_polynomial c) 2.
Proof.
...
lazard_detcritical_expand_coefficients.
  rewrite /D.lazard_detcritical_A00 /D.lazard_detcritical_A01 /D.lazard_detcritical_A02
    ...
    /D.lazard_detcritical_B02 /D.lazard_detcritical_B10 /D.lazard_detcritical_B11
    /D.lazard_detcritical_B12 /D.lazard_detcritical_B20 /D.lazard_detcritical_B21
    /D.lazard_detcritical_B22 /DM.lazard_det_certificate_N0
...
Print Assumptions lazard_detcritical_coefficient_2.

End PolynomialFormulasLazardQuinticDeterminantCriticalCoefficient2.
