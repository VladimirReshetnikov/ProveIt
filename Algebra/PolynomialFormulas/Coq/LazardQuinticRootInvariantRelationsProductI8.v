...
Module PolynomialFormulasLazardQuinticRootInvariantRelationsProductI8.
...
Add Ring lazard_root_invariant_relations_product_i8_ring :
...
Theorem lazard_root_invariant_product_i8
    (roots : 5.-tuple F) (hsum : RP.lazard_root_esymm1 roots = 0) :
  2%:R * (RP.lazard_root_i4 (RP.lazard_root_invariants roots) *
      RP.lazard_root_i8 (RP.lazard_root_invariants roots)) =
    PC.lazard_twice_i4_mul_i8_rhs (RP.lazard_depressed_of_roots roots)
      (RP.lazard_root_invariants roots).
Proof.
have hx4 := RP.lazard_root_sum_zero_last hsum.
rewrite /PC.lazard_twice_i4_mul_i8_rhs /RP.lazard_depressed_of_roots
...
finish_product_i8_ring.
Qed.

End ProductI8.

End PolynomialFormulasLazardQuinticRootInvariantRelationsProductI8.
