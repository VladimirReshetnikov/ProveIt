(** One independently checked recursive descent for Or-E's main child. *)
...
Theorem raw_orElimination_disjunction_child_interface_of_parent_data : forall
...
Proof.
  ...
  destruct (raw_recursive_constructor_child_interface_at_endpoint_context
    ...
    hdisjunctionEndpoint hassignmentCoverage)
...
Corollary raw_orElimination_disjunction_child_sat_of_parent_data : forall
...
Proof.
  ...
  apply (proj2
    (raw_orElimination_disjunction_child_interface_renamed_sat_iff
      M variables parameters predicates)).
  exact (raw_orElimination_disjunction_child_interface_of_parent_data
