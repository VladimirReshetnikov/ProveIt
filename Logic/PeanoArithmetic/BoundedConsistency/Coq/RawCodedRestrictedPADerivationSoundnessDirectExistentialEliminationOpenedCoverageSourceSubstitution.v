...
Lemma rawDirect_existentialEliminationOpenedCoverageSourceBody_agreement :
  forall (M : RawPAModel)
...
Theorem rawDirect_existentialEliminationOpenedCoverageSource_substitution :
...
Proof.
  ...
  rewrite rawDirect_existentialEliminationOpenedCoverageSourceBody_agreement
    in hopen.
  rewrite
    coqRestrictedPADirectExistentialEliminationOpenedCoverageSource_open
    in hopen.
  exact hopen.
Qed.
