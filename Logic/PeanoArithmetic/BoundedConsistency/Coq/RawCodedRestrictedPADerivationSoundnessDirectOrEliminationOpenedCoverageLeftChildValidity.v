(** One independently checked recursive descent for Or-E's left branch. *)
...
Theorem raw_orElimination_left_child_interface_of_parent_data : forall
  ...
  RawCoqRestrictedPAOrEliminationChildInterface
    CoqOrEliminationLeftBranchChild M variables parameters.
Proof.
  ...
  destruct (raw_recursive_constructor_child_interface_at_endpoint_context
    ...
    [variables 3; variables 2; variables 1]
    (variables 2) (rawListNode M (variables 7) (variables 8))
    ...
    hleftEndpoint hassignmentCoverage)
...
Corollary raw_orElimination_left_child_sat_of_parent_data : forall
...
Proof.
  ...
  apply (proj2 (raw_orElimination_left_child_interface_renamed_sat_iff
    M variables parameters predicates)).
  exact (raw_orElimination_left_child_interface_of_parent_data
