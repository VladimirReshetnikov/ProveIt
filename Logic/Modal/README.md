...
`HilbertNormalS4Systems.v`, together with `HilbertNormalFiveSystems.v`,
...
K4McK inclusions.  Eleven further declarations give exact K5 and S5 raw
systems.
...
remaining 223 declarations in the named catalogue are the principal parity
...
raw-axiom adapter block.  One hundred forty-two declarations from its
