...
| `PropositionalEntailmentClassical.v` | `Propositional/Entailment/Cl/Basic.lean` | DNE-based classical algebra with exact double-negation equivalence, inverse contraposition, derived ex falso and intuitionistic capabilities, classical negated-conjunction De Morgan equivalence, implication/disjunction equivalence, excluded middle, elimination of contraposition, Dummett and Peirce packages, and the finite mapped-negation De Morgan theorem. The proof-relevant list formulation removes the source's formula equality and finite-set assumptions, while implication refutation and disjunctive syllogism are factored into their strictly weaker minimal and intuitionistic layers |
