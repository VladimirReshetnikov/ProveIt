...
| `GenericCalculus.v` | `Logic/Calculus.lean` | Declarations 1--20 of 43: universe-polymorphic Type-valued one-sided LK/Cut and principal-entailment dictionaries, structural combinators, extended cut, strengthened cut-free finite folds, principal modus ponens, the complete classical Hilbert interface, and derivability as provability of finite disjunction |
...
finite disjunction.  All twenty declarations are closed under the global
context.
