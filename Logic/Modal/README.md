...
| `GodelTranslation.v` | `Modal/ModalCompanion/Standard/Basic.lean` | Atom-polymorphic Gödel translation, renaming naturality, substitution-free S4 stability, every translated Minimal axiom plus EFQ, a factored generic Hilbert-proof transport and Int corollary, and persistence on arbitrary transitive modal frames |
