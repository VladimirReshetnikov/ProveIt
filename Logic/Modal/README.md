...
| `StandardModalCompanions.v` | `Modal/ModalCompanion/Standard/Cl.lean` | Complete classical companion family: translated LEM, Cl/S5 and Cl/S5Grz equivalences via exact one-world Boolean readback, transport across the unconditional S5Grz/Triv collapse, and the boxdot Ver presentation |
