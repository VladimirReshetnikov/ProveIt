...
| `GenericModalLogicSymbol.v` | `Modal/LogicSymbol.lean` | Generic modal iteration, bounded folds, duality/De Morgan/injectivity interfaces, and predicate-set image/preimage conveniences; list-backed finite collections are in progress |
