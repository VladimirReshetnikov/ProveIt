...
| `GenericModalLogicSymbol.v` | `Modal/LogicSymbol.lean` | Generic modal iteration, bounded folds, duality/De Morgan/injectivity interfaces, predicate-set image/preimage, and factored list image conveniences; constructive preimage/bridge layers are in progress |
