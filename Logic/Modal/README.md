...
| `GenericCalculus.v` | `Logic/Calculus.lean` | Declarations 1--38 of 43: universe-polymorphic Type-valued one-sided LK/Cut, principal- and contextual-entailment dictionaries, structural combinators, strengthened finite folds, the complete classical Hilbert interface, structure-preserving pullback, contextual structural adapters, strong cut, explosion, and inconsistency |
...
equation negating bottom to top.  All thirty-eight declarations are closed
