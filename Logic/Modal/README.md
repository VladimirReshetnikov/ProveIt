...
| `PropositionalEntailmentAxioms.v` | `Propositional/Entailment/Axiom{DNE,EFQ,ElimContra,LEM,Peirce}.lean` | Complete five-module surface: standalone raw-proof capabilities and inhabited theorem views, DNE and EFQ elimination, deductive explosion from pointwise EFQ, and one formula-uniform transport that subsumes both finite and predicate context instances |
