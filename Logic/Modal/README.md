...
| `StandardModalCompanions.v` | `Modal/ModalCompanion/Standard/{Cl,...}.lean` | Named standard companions, beginning with the complete classical/S5 equivalence: translated LEM, Cl-to-S5 proof transport, one-world Boolean readback, and the reverse S5-to-Cl theorem |
