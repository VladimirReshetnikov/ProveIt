...
| `PropositionalKreiselPutnam.v` | `Propositional/Kripke/{AxiomKreiselPutnam,Hilbert/KreiselPutnam,Hilbert/KC}.lean` | Exact KP frame condition and axiom soundness; convergence-to-KP reduction; KP soundness and consistency; strict Int/KP/KC hierarchy via explicit five- and three-world countermodels. Canonical KP completeness remains outside the current surface |
| `PropositionalKripke.v` | `Propositional/Kripke/{Basic,AxiomWLEM,AxiomDummett,Hilbert/*}.lean` | Preorder-generalized propositional Kripke frames, hereditary valuations and forcing; heterogeneous substitution; factored schema-Hilbert soundness, consistency and semantic comparison; exact WLEM/convergence and Dummett/connectedness characterizations; Int, KC, and LC soundness |
...
| `PropositionalFMT.v` | `Propositional/FMT/Basic.lean`, `Propositional/FMT/Axiom/Ser.lean` | Complete rooted formula-indexed semantics: forcing and exact negative clauses, model/frame/class validity and countermodels, positive axiom validity, root-driven global rules, and elementary NT-seriality results. The completeness-dependent Hintikka-model seriality instance remains outside this initial semantic layer |
| `PropositionalHilbertVF.v` | `Propositional/Hilbert/VF/{Basic,Disjunctive}.lean`, `Propositional/FMT/Hilbert/{Basic,VF,VF_Ser}.lean` | Atom-polymorphic substitution-closed Hilbert VF systems and Type-valued proofs with factored proof transport; a generic Aczel-slash induction giving VF and VF_Ser the disjunction property; generic FMT model/frame-class soundness, consistency, and semantic comparison; VF and VF_Ser soundness and consistency; and small formula-indexed countermodels proving VF below VF_Ser and refuting `top` equivalent to double-negated `top`. The named systems' Hintikka completeness and VF/WF comparison remain in later layers |
| `PropositionalHilbertVFCorsi.v` | `Propositional/Entailment/Corsi/{Basic,F,VF,WF}.lean` | Constructive Corsi proof algebra specialized to the faithful atom-polymorphic Hilbert calculi: commutation, cancellation, replacement, the collect-or-and law, and the F-derived Restall/Rule-E bridge; duplicate-tolerant list conjunction and disjunction folds provide introduction, elimination, subset transport, and finite disjunction extraction without decidable equality. Type-valued positional witnesses keep raw derivations computational while ordinary `List.In` remains the proposition-level API |
| `PropositionalFMTCompleteness.v` | `Propositional/FMT/Completeness.lean` | In-progress atom-polymorphic reconstruction of the Hintikka completeness layer: consistent positive/negative list pairs, a raw collapse proof, classical consistency-preserving side selection, subformula enumeration and Lindenbaum saturation, persistent initial membership, disjointness, theorem closure, and exact bottom/top/conjunction/disjunction membership laws. Duplicate-tolerant lists replace finite subsets without formula equality; the formula-indexed canonical model, implication truth lemma, and final completeness theorem remain |
| `PropositionalHilbertWF.v` | `Propositional/Hilbert/{F_WF,WF/Basic,WF_VF}.lean` | Atom-polymorphic Hilbert WF proofs obtained by sharing VF's identical substitution-closed schema representation and adding faithful replacement of equivalents; schema weakening, substitution, provable-schema transport, theorem-logic packaging, and heterogeneous VF-to-WF and WF-to-F transports are factored over raw Type-valued proofs. A reusable Hilbert-F Restall derivation supplies Rule E, and the named WF logic is generalized from nat atoms to arbitrary atom types |
