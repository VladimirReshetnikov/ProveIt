...
| `PropositionalEntailmentMinimal.v` | `Propositional/Entailment/Minimal/Basic.lean` | Generic Type-valued minimal-entailment capability and a broad constructive derived algebra: implication identity/weakening/composition/exchange/contraction and variance; conjunction/disjunction introduction, elimination, mapping, congruence, symmetry, and associativity; biconditional algebra and theoremhood reflection; negation-as-bottom; double-negation introduction and functoriality; contraposition; triple-negation collapse; contradiction; the constructive De Morgan laws; truth weakening; currying; ordinary, singleton-normalized, mapped, and appended finite folds; structural finite contexts with an exact normalized-conjunction representation; and proof-relevant predicate contexts with weakening, modus ponens, bidirectional deduction, empty-context reflection, and exact finite-support extraction. Type-valued membership removes `DecidableEq` and choice from context construction; `Prop`-set/finite-set conveniences and the remaining connective catalogue remain |
