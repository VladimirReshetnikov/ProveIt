...
| `PropositionalFormula.v` | `Propositional/Formula/Basic.lean` | Primitive Minimal/Intuitionistic syntax with complexity, decidable equality, letterlessness, list-backed subformula closure, and heterogeneous substitution; coding conveniences remain |
