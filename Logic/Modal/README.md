...
| `GodelTranslation.v` | `Modal/ModalCompanion/Standard/Basic.lean` | Atom-polymorphic Gödel translation; generalized least S4-based and greatest Grz-seeded companion constructions with universal properties; substitution-free S4 stability; every translated Minimal axiom plus EFQ; a factored generic Hilbert-proof transport and Int corollary; persistence and the exact intuitionistic-forcing/modal-truth equivalence on preorder frames |
