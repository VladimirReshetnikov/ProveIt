...
| `PropositionalEntailmentMinimal.v` | `Propositional/Entailment/Minimal/Basic.lean` | Generic Type-valued minimal-entailment capability and a broad constructive derived algebra: implication identity/weakening/composition/exchange/contraction and variance; conjunction/disjunction introduction, elimination, mapping, congruence, and symmetry; biconditional algebra; negation-as-bottom; double-negation introduction and functoriality; contraposition; triple-negation collapse; contradiction; the constructive De Morgan laws; truth weakening; currying; and ordinary, singleton-normalized, mapped, and appended finite conjunction/disjunction folds. Type-valued positional membership removes `DecidableEq` from deduction and finite-fold rules; predicate contexts and the remaining connective catalogue remain |
