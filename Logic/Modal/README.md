...
| `PropositionalEntailmentMinimal.v` | `Propositional/Entailment/Minimal/Basic.lean` | Generic Type-valued minimal-entailment capability and the core derived algebra: raw/provable modus ponens, implication identity/weakening/composition/exchange/contraction, conjunction and disjunction rules, negation equivalence, biconditional laws, connective symmetry, truth weakening, and currying. Positional finite contexts remove the source core's `DecidableEq` assumptions; list folds, predicate contexts, and the later negation/connective catalogue remain |
