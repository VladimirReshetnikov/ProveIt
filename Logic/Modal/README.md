...
| `StandardModalCompanions.v` | `Modal/ModalCompanion/Standard/{Cl,Int,KC,LC}.lean` | Complete classical companion family; the full Int/S4, KC/S4.2, and LC/S4.3 modal-companion equivalences via generalized forcing and canonical completeness; reusable S4/S4.2/S4.3 entailment packages; and the forward Int-to-Grz, KC-to-Grz.2, and LC-to-Grz.3 translations, including direct convergent-frame WLEM and connected-frame Dummett proofs |
