...
| `PropositionalKripkeCanonical.v` | `Propositional/Kripke/Completeness.lean`, `Propositional/Kripke/Hilbert/Int/Basic.lean` | Enumerated maximal extensions avoiding a target formula, derivably closed prime theories, the canonical preorder/model and truth lemma, completeness for every frame class containing the canonical frame, countermodel extraction, and Int soundness/completeness; a compact one-sided construction replaces the source's two-sided saturated tableau |
...
| `StandardModalCompanions.v` | `Modal/ModalCompanion/Standard/{Cl,Int,KC,LC}.lean` | Complete classical companion family; the full Int/S4 modal-companion equivalence via generalized forcing and canonical Int completeness; reusable S4/S4.2/S4.3 entailment packages; and the forward Int-to-Grz, KC-to-S4.2/Grz.2, and LC-to-S4.3/Grz.3 translations, including direct convergent-frame WLEM and connected-frame Dummett proofs |
