...
| `PropositionalEntailmentAxioms.v` | `Propositional/Entailment/Axiom{DNE,EFQ,ElimContra,LEM,Peirce}.lean`, `Propositional/Entailment/Int/DNE_of_LEM.lean` | Complete six-module surface: standalone raw-proof capabilities and inhabited theorem views, DNE and EFQ elimination, deductive explosion from pointwise EFQ, formula-uniform context transport, factored implicational combinators, and a direct DNE-from-LEM-and-EFQ derivation with weaker hypotheses and no equality decision |
