...
`HilbertNormalS4PointMcKSystems.v` and `HilbertNormalFiveSystems.v`,
...
inclusions.  Eleven further declarations give exact K5 and S5 raw systems.
...
remaining 196 declarations in the named catalogue are the principal parity
...
raw-axiom adapter block.  One hundred sixty-nine declarations from its
