...
| `PropositionalEntailmentAxioms.v` | `Propositional/Entailment/Axiom{DNE,EFQ,ElimContra,LEM,Peirce}.lean`, `Propositional/Entailment/{KC,LC,KreiselPutnam,Scott}.lean`, `Propositional/Entailment/Int/DNE_of_LEM.lean` | Shared standalone raw-proof capabilities and inhabited theorem views; DNE, EFQ, and Kreisel–Putnam elimination; deductive explosion; formula-uniform context transport; factored implicational combinators; and direct DNE from LEM+EFQ with weaker hypotheses. KC, Kreisel–Putnam, and Scott are complete; LC awaits its derived Dummett-to-WLEM theorem |
