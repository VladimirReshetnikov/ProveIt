...
| `PropositionalHilbertWF.v` | `Propositional/Hilbert/{WF/Basic,WF_VF}.lean` | Atom-polymorphic Hilbert WF proofs obtained by sharing VF's identical substitution-closed schema representation and adding faithful replacement of equivalents; schema weakening, substitution, provable-schema transport, theorem-logic packaging, and heterogeneous VF-to-WF transport are factored over raw Type-valued proofs. The named WF logic is generalized from nat atoms to arbitrary atom types |
