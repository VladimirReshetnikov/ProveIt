...
| `GodelTranslation.v` | `Modal/ModalCompanion/Standard/Basic.lean` | Atom-polymorphic Gödel translation, renaming naturality, substitution-free S4 stability, translated modus ponens and explosion, and persistence on arbitrary transitive modal frames |
