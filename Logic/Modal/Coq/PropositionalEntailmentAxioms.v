(** Standalone propositional axiom capabilities.
    ...
    Peirce}.lean] family.  Each source typeclass becomes an explicit raw-proof
    capability, with its inhabited-provability view factored once.  The final
    transport definitions generalize both finite and predicate context
    instances: any formula-uniform proof embedding preserves every capability.
*)
